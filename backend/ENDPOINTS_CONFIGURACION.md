...
- `GET /ai/prompt`, `PUT /ai/prompt`
- `GET /ai/prompt/variables`, `POST /ai/prompt/variables`, `PUT/DELETE /ai/prompt/variables/{id}`
...
Estas rutas se pueden implementar más adelante o añadir como stubs si se necesitan para que la UI no falle.
...
- **AI:** config, chat, probar y listado de documentos están activos; el resto de rutas AI (documentos CRUD, prompt, calificaciones, definiciones, diccionario, tablas-campos) no están implementadas en backend.
