...
def crear_template_conciliacion():
    ...
    instrucciones = [
        ["INSTRUCCIONES PARA CONCILIACION BANCARIA"],
        [""],
        ["1. FORMATO DE ARCHIVO:"],
        ["   - Archivo Excel (.xlsx)"],
        ["   - Primera fila: encabezados de columnas"],
        ["   - Datos desde la segunda fila"],
        ["   - Maximo 100 registros por archivo"],
        [""],
        ["2. COLUMNAS REQUERIDAS:"],
        ["   - fecha: Fecha real del pago (formato YYYY-MM-DD)"],
        ["   - numero_documento: Numero de documento del pago"],
        [""],
        ["3. PROCESO DE CONCILIACION:"],
        ["   - El sistema compara el numero de documento con la base de datos"],
        ...
        ["   - Numero de documento debe coincidir EXACTAMENTE"],
        ["   - No se permiten caracteres especiales adicionales"],
        [""],
        ["5. EJEMPLOS DE DATOS VALIDOS:"],
        ["   - fecha: '2024-01-15'"],
        ...
        ["   - Verificar que los numeros de documento sean exactos"],
        ["   - Un archivo por vez"],
        [""],
        ["7. RESULTADO:"],
        ["   - Los pagos conciliados apareceran en el resumen"],
        ["   - Los pendientes requeriran revision manual"],
        [""],
        ["8. DESCONCILIACION:"],
        ["   - Se puede desconciliar un pago ya conciliado"],
        ["   - Requiere formulario con justificacion"],
        ["   - Se registra en auditoria"],
        [""],
        ["FECHA DE GENERACION: " + datetime.now().strftime("%Y-%m-%d %H:%M:%S")],
        ["GENERADO POR: Sistema de Conciliacion Bancaria"]
    ]
    ...
    # Validacion para fecha (formato YYYY-MM-DD)
...
if __name__ == "__main__":
    print("Generando template de conciliacion bancaria...")
