...
- Columnas correctas segun el modelo Cliente
...
def crear_plantilla_clientes():
    ...
    columnas = [
        ...
        # Datos de configuracion (opcionales)
    ...
    with pd.ExcelWriter(nombre_archivo, engine='openpyxl') as writer:
        ...
        # Hoja 3: Plantilla vacia para llenar
        df_vacio = pd.DataFrame(columns=columnas)
        df_vacio.to_excel(writer, sheet_name='Plantilla_Vacia', index=False)
        
        # Hoja 4: Referencias de configuracion
        referencias = [
            ["REFERENCIAS DE CONFIGURACION"],
            [""],
            ["MODELOS DE VEHICULOS DISPONIBLES:"],
    ...
    print(f"   - Instrucciones: Guia de uso")
    print(f"   - Plantilla_Vacia: Para llenar con datos")
    print(f"   - Referencias: Valores de configuracion")
