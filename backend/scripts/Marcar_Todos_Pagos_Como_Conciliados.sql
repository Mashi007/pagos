...
-- 
-- ⚠️ IMPORTANTE: Este script requiere que la columna 'conciliado' exista en la tabla 'pagos'.
-- Si no existe, ejecuta primero: Agregar_Columna_Conciliado_Si_No_Existe.sql
-- ============================================
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION '❌ ERROR: La columna conciliado NO EXISTE en la tabla pagos. Ejecuta primero: Agregar_Columna_Conciliado_Si_No_Existe.sql';
    END IF;
END $$;
