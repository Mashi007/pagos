...
-- Insertar asesores
INSERT INTO asesores (nombre, apellido, email, telefono, especialidad, comision_porcentaje, activo, notas, created_at, updated_at)
VALUES 
...
SELECT 'Asesores insertados:' as resultado, COUNT(*) as total FROM asesores WHERE activo = true;
