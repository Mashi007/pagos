...
class EndpointTester:
    ...
    def login_admin(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print("OK - Login exitoso como ADMIN")
                return True
            else:
            ...
            print(f"ERROR - Error de conexion en login: {e}")
            return False
    ...
    def test_endpoint(self, method: str, endpoint: str, data: dict = None, expected_status: int = 200) -> Dict:
        ...
        try:
            if method.upper() == "GET":
                ...
                return {"success": False, "error": f"Metodo {method} no soportado"}
    ...
    def test_all_endpoints(self):
        ...
        if not self.login_admin():
            print("ERROR - No se pudo hacer login. Abortando pruebas.")
            return
        ...
        for method, endpoint, data, expected_status in endpoints_to_test:
            ...
            if result["success"]:
                ...
                print(f"  ERROR - {result['status_code']} - {result.get('error', 'Error desconocido')}")
                failed_tests += 1
    ...
    def generate_test_report(self, successful: int, failed: int):
        ...
        print(f"  Tasa de exito: {(successful/(successful+failed)*100):.1f}%")
...
def main():
    ...
    try:
        ...
        if response.status_code == 200:
            print("OK - Servidor detectado en http://localhost:8000")
        else:
            print("WARNING - Servidor responde pero puede no estar completamente funcional")
    except:
