...
def upgrade():
    ...
    op.create_index(op.f('ix_auditorias_usuario_email'), 'auditorias', ['usuario_email'], unique=False)
    ...
    op.create_index(op.f('ix_auditorias_registro_id'), 'auditorias', ['registro_id'], unique=False)
