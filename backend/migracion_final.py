#!/usr/bin/env python3
"""
Script para ejecutar migración con configuración real de Render
"""
import psycopg2
...
def ejecutar_migracion():
    ...
    # CONFIGURACIÓN REAL PARA RENDER - AJUSTAR SEGÚN TU BD
    DB_CONFIG = {
...
if __name__ == "__main__":
    ...
    print("Ejemplo de configuracion:")
    print("host: 'dpg-xxxxx.oregon-postgres.render.com'")
    print("database: 'rapicredit_db'")
    print("user: 'rapicredit_user'")
