    ...
    <div className="w-full max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg border border-gray-200">
      ...
      <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
        ...
        <p className="text-sm text-blue-800">
          Cédula Cliente | Monto Financiamiento | Modalidad Pago | Nº Cuotas | Producto | Analista | Concesionario
        </p>
        <p className="text-xs text-blue-700 mt-2">
          • Cédula: cliente debe existir en BD | • Monto: mayor a 0
          <br />
          • Modalidad: MENSUAL|QUINCENAL|SEMANAL | • Nº Cuotas: 1-12
          <br />
          • Analista: requerido | • Concesionario: opcional
        </p>
      </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-1 text-sm text-green-800">
                <p>✓ Préstamos creados: <span className="font-bold">{result.registros_creados}</span></p>
