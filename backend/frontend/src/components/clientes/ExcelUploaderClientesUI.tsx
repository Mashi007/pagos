    ...
    <div className="w-full max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg border border-gray-200">
      ...
      <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
        ...
        <p className="text-sm text-blue-800">
          CÃÂ©dula | Nombres | DirecciÃÂ³n | Fecha Nacimiento | OcupaciÃÂ³n | Correo | TelÃÂ©fono
        </p>
        <p className="text-xs text-blue-700 mt-2">
          Ã¢ÂÂ¢ CÃÂ©dula: V|E|J|Z + 6-11 dÃÂ­gitos | Ã¢ÂÂ¢ Email: formato vÃÂ¡lido y ÃÂºnico | Ã¢ÂÂ¢ TelÃÂ©fono: requerido
        </p>
      </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-1 text-sm text-green-800">
                <p>Ã¢ÂÂ Clientes creados: <span className="font-bold">{result.registros_creados}</span></p>
