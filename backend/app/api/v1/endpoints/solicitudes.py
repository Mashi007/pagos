...
# solicitud_existente:\n raise HTTPException( status_code=400, detail="Ya existe una solicitud pendiente para este pago
...
# usuario_id=admin.id, tipo="SOLICITUD_APROBACION", categoria="SISTEMA", prioridad=solicitud.prioridad, titulo="Nueva
