...
class ComparativeAnalysisSystem:
    ...
    def _analyze_token_differences(self) -> Dict[str, Any]:
        ...
        return {
            'token_length_analysis': {
                ...
                'length_difference': statistics.mean(successful_lengths) - statistics.mean(failed_lengths) if successful_lengths and failed_lengths else 0
            },
            'expiration_analysis': {
                ...
                'expiry_difference': statistics.mean(successful_exp_times) - statistics.mean(failed_exp_times) if successful_exp_times and failed_exp_times else 0
            },
            'token_type_analysis': {
    ...
    def _analyze_user_differences(self) -> Dict[str, Any]:
        ...
        return {
            'user_status_analysis': {
                ...
                'active_rate_difference': (successful_active_count / len(successful_users) * 100) - (failed_active_count / len(failed_users) * 100) if successful_users and failed_users else 0
            },
            'admin_status_analysis': {
                ...
                'admin_rate_difference': (successful_admin_count / len(successful_users) * 100) - (failed_admin_count / len(failed_users) * 100) if successful_users and failed_users else 0
            },
    ...
    def _analyze_timing_differences(self) -> Dict[str, Any]:
        ...
        return {
            'response_time_analysis': {
                'successful_avg_response_time': statistics.mean(successful_response_times) if successful_response_times else 0,
                'failed_avg_response_time': statistics.mean(failed_response_times) if failed_response_times else 0,
                'response_time_difference': statistics.mean(successful_response_times) - statistics.mean(failed_response_times) if successful_response_times and failed_response_times else 0
            },
    ...
    def _calculate_pattern_significance(self, successful_patterns: Dict[str, int], failed_patterns: Dict[str, int]) -> Dict[str, float]:
    ...
    try:
        with comparative_system.lock:
            summary = {
                ...
                'recent_analyses': list(comparative_system.comparison_results.values())[-5:] if comparative_system.comparison_results else []
            }
