...
def obtener_preferencias_cliente(
    ...
    try:
        ...
        return {
            ...
            "tipos_notificacion": [
                {
                    "codigo": "RECORDATORIO_3_DIAS",
                    "descripcion": "3 días antes del vencimiento",
                    "hora": "09:00 AM",
                },
                {
                    "codigo": "RECORDATORIO_1_DIA",
                    "descripcion": "1 día antes del vencimiento",
                    "hora": "09:00 AM",
                },
                {
                    "codigo": "DIA_VENCIMIENTO",
                    "descripcion": "Día de vencimiento",
                    "hora": "08:00 AM",
                },
                {
                    "codigo": "MORA_1_DIA",
                    "descripcion": "1 día de atraso",
                    "hora": "10:00 AM",
                },
                {
                    "codigo": "MORA_3_DIAS",
                    "descripcion": "3 días de atraso",
                    "hora": "10:00 AM",
                },
                {
                    "codigo": "MORA_5_DIAS",
                    "descripcion": "5 días de atraso",
                    "hora": "10:00 AM",
                },
                {
                    "codigo": "CONFIRMACION_PAGO",
                    "descripcion": "Confirmación de pago",
                    "hora": "Inmediato",
                },
            ],
        }
...
def listar_templates_whatsapp(current_user: User = Depends(get_current_user)):
    """
...
async def probar_envio_notificacion(
    ...
    try:
        ...
        cuota = (
            ...
            .order_by(Cuota.numero_cuota.desc())
            .first()
        )
