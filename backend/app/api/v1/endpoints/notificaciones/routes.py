...
menor a 60 días solo con exactamente 1 cuota atrasada (atraso 6-59); con 0 o 2+ no aplica).
                ...
                persist_ultimo_envio_batch(
                    ...
                    resultado={
                        ...
                        "detalles": {
                            ...
                            "total_en_lista": total,
                            "desde_checkpoint": int(p.get("desde_checkpoint") or 0),
                            "cupo_diario": int(p.get("cupo_diario") or 0) or None,
                            "enviados_hoy": int(p.get("enviados_hoy") or 0),
                            "motivo_pausa": (p.get("motivo_pausa") or None),
                        },
                    },
                    origen="api_enviar_caso_manual",
                    inicio_utc=inicio_utc,
...
def get_clientes_retrasados(
    ...
    2. Menor a 60 dias (atraso 6-59 calendario y exactamente UNA cuota atrasada).
       Si el prestamo tiene 2 o mas cuotas atrasadas, no entra en este listado.
...
def ejecutar_actualizacion_notificaciones(db: Session) -> dict:
    ...
    actualizada al comparar o aplicar ABONOS desde la UI; este botón no fuerza ese recálculo. Este endpoint devuelve 200 para que el cliente invalide React Query
