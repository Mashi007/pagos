    ...
    try:
        ...
        for resultado in resultados:
            ...
            plantilla = (
                ...
                .filter(
                    NotificacionPlantilla.tipo == tipo_notificacion,
...
def iniciar_scheduler():
    ...
    try:
        ...
        logger.info("📧 El job calculará notificaciones previas y enviará correos automáticamente usando plantillas y configuración de email")
