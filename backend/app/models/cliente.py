...
class Cliente(Base):
    ...
    # ============================================
    asesor_id = Column(Integer, ForeignKey("analistas.id"), nullable=True, index=True)  # Analista de configuración
    ...
    asesor_config_rel = relationship("Analista", foreign_keys=[asesor_id])
