...
class CuotaPago(Base):
    ...
    - orden_aplicacion: Secuencia de aplicacion dentro de los pagos para esta cuota
    ...
    orden_aplicacion = Column(Integer, nullable=False, default=0)  # Secuencia de aplicacion
