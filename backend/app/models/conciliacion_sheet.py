...
class ConciliacionSheetMeta(Base):
    ...
    last_data_sheet_row_number = Column(Integer, nullable=True)
    google_tail_row_number = Column(Integer, nullable=True)
    google_tail_row_probed_at = Column(DateTime(timezone=True), nullable=True)
