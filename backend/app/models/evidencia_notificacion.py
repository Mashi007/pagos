...
class EvidenciaNotificacion(Base):
    ...
    etiqueta_gmail = Column(String(40), nullable=False, index=True)
    email_cliente = Column(String(255), nullable=False)
    email_cliente_norm = Column(String(255), nullable=False, index=True)
    ...
    pdf_contenido = Column(LargeBinary, nullable=False)
