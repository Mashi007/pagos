"""
Modelo de Predicción de Impago de Cuotas ML
Almacena metadatos de modelos de machine learning entrenados para predecir impago de cuotas
"""
...
class ModeloImpagoCuotas(Base):
    """
    Modelo de machine learning para predicción de impago de cuotas mensuales
    Predice si un cliente pagará o no sus cuotas futuras basado en su historial de pagos
    """

    __tablename__ = "modelos_impago_cuotas"
    ...
    algoritmo = Column(String(100), nullable=False)  # random_forest, xgboost, logistic_regression, etc.
    ...
    def __repr__(self):
        return f"<ModeloImpagoCuotas {self.nombre} v{self.version} - {self.algoritmo}>"
