...
class PrestamoEvaluacion(Base):
    ...
    historial_crediticio_descripcion = Column(String(50), nullable=True)  # Excelente, Bueno, Regular, Malo
    ...
    tipo_empleo_descripcion = Column(String(50), nullable=True)  # Formal, Independiente, Contratado
    
    # ============================================
    # CRITERIO 6: ENGANCHE Y GARANTÍAS (10%)
    # ============================================
    enganche_garantias_puntos = Column(Numeric(5, 2), nullable=False, default=0)
    enganche_garantias_calculo = Column(Numeric(10, 4), nullable=False, default=0)  # LTV
    
    # ============================================
    # PUNTUACIÓN TOTAL Y CLASIFICACIÓN
    # ============================================
    puntuacion_total = Column(Numeric(5, 2), nullable=False, default=0)  # Suma de los 6 criterios (máx 100)
    ...
    # ============================================
    tasa_interes_aplicada = Column(Numeric(5, 2), nullable=True)  # Tasa según nivel de riesgo
    plazo_maximo = Column(Integer, nullable=True)  # Plazo máximo según riesgo
    enganche_minimo = Column(Numeric(5, 2), nullable=True)  # Enganche mínimo según riesgo
    requisitos_adicionales = Column(String(200), nullable=True)  # Requisitos adicionales
