...
class CobranzaAcuerdo(Base):
    ...
    cantidad = Column(Numeric(14, 2), nullable=True)
    moneda = Column(String(10), nullable=False, server_default=text("'USD'"))
    # Legacy (sincronizado al guardar para compatibilidad)
