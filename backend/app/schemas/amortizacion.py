...
# int = Field(..., gt=0, description="Número de la cuota") fecha_vencimiento: date = Field
...
# Field( ..., ge=0, description="Saldo final de capital" ) @field_validator
...
# Optional[date] = None capital_pagado: Optional[Decimal] = Field(None, ge=0) interes_pagado: Optional[Decimal] = Field
