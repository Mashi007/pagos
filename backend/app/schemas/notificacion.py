# backend/app/schemas/notificacion.py"""Schemas de Pydantic para Notificación"""from datetime import datetimefrom typing
# import Any, Dict, Optionalfrom pydantic import BaseModel, ConfigDict, EmailStr, Field#
# ============================================================================# Schemas Base#
# ============================================================================class NotificacionBase(BaseModel): """Schema
# base para Notificación""" # Destinatarios user_id: Optional[int] = None cliente_id: Optional[int] = None
...
# etc." ) # Contenido asunto: Optional[str] = Field(None, max_length=255) mensaje: str # Datos adicionales (renombrado de
# metadata) extra_data: Optional[Dict[str, Any]] = None # Configuración prioridad: str = Field( default="NORMAL",
# description="BAJA, NORMAL, ALTA, URGENTE" ) programada_para: Optional[datetime] = None max_intentos: int = Field(default=3,
...
# Optional[datetime] = None prioridad: Optional[str] = None#
# ============================================================================# Schemas de Respuesta#
# ============================================================================class NotificacionInDB(NotificacionBase):
# """Schema de notificación en base de datos""" id: int estado: str intentos: int # Fechas de envío enviada_en:
# Optional[datetime] = None leida_en: Optional[datetime] = None # Respuestas del servicio respuesta_servicio: Optional[str] =
# None error_mensaje: Optional[str] = None # Auditoría creado_en: datetime actualizado_en: Optional[datetime] = None
...
# Field(..., description="EMAIL, SMS, WHATSAPP") mensaje: str programada_para: Optional[datetime] = None extra_data:
# Optional[Dict[str, Any]] = Field( None, description="Datos adicionales como monto, fecha_vencimiento, etc.", )#
# ============================================================================# Schemas de Listado y Filtrado#
# ============================================================================class NotificacionFilter(BaseModel): """Filtros
...
# Optional[datetime] = None fecha_hasta: Optional[datetime] = Noneclass NotificacionList(BaseModel): """Schema para lista de
