...
Regla: el ciclo siempre revisa correos SIN LEER (estado actual en Gmail), aunque ya se
hayan escaneado fechas pasadas; si un correo se re-marca como no leído (p. ej. corrección),
