...
class EstadoCuota:
    ...
    DOCUMENTACION = {
        ...
        VENCIDO: 'Sin cubrir al 100%; desde 1 dia de retraso hasta antes del umbral de mora (4 meses + 6 dias).',
        MORA: 'Sin cubrir al 100%; desde 4 meses calendario del vencimiento mas 6 dias.',
