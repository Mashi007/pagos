...
def reset_y_reaplicar_fifo_prestamo(db: Session, prestamo_id: int) -> dict[str, Any]:
...
reconstruir_cascada_fifo_prestamo = reset_y_reaplicar_fifo_prestamo
'''

def main() -> None:
    root = Path(__file__).resolve().parents[1]
    dest = root / "backend" / "app" / "services" / "pagos_cuotas_reaplicacion.py"
