#!/usr/bin/env python3
"""
Script para corregir específicamente métodos __init__ que tienen 8 espacios pero deberían tener 4
"""

import os

def fix_init_methods():
    """Corregir métodos __init__ que tienen indentación incorrecta"""
...
if __name__ == "__main__":
    print("Corrigiendo metodos __init__ con indentacion incorrecta...")
    fixed = fix_init_methods()
