...
----------------------------------------------------------------------------------------------------
  ...
  EJEMPLO:
    ...
    - Agregar campo 'es_cuota_especial' al schema amortizacion
...
----------------------------------------------------------------------------------------------------
  ...
  EJEMPLO:
    - Verificar campo 'nuevo_saldo_pendiente' en modelo amortizacion
    - Verificar campo 'mensaje' en modelo amortizacion
