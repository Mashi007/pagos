...
Fecha: 2026-01-11 11:40:44

RESUMEN EJECUTIVO
----------------------------------------------------------------------------------------------------
Modelos ORM analizados: 29
Schemas analizados: 17
Modelos en frontend: 0
Discrepancias encontradas: 240

DISCREPANCIAS POR SEVERIDAD
----------------------------------------------------------------------------------------------------
ALTA (Críticas): 115
MEDIA (Importantes): 125
BAJA (Advertencias): 0

DETALLE DE DISCREPANCIAS
====================================================================================================

[ALTA] 115 discrepancias
----------------------------------------------------------------------------------------------------
  Tipo: SCHEMA_SIN_ORM
  ...
  Tabla/Modelo: notificacion
  Campo: por_prioridad
  Descripción: Campo por_prioridad existe en schema pero no en modelo ORM

  Tipo: SCHEMA_SIN_ORM
  Tabla/Modelo: notificacion
  Campo: fecha_hasta
  Descripción: Campo fecha_hasta existe en schema pero no en modelo ORM

  Tipo: SCHEMA_SIN_ORM
  Tabla/Modelo: notificacion
  Campo: pendientes
  Descripción: Campo pendientes existe en schema pero no en modelo ORM
  ...
  Tabla/Modelo: notificacion
  Campo: enviadas
  Descripción: Campo enviadas existe en schema pero no en modelo ORM

  Tipo: SCHEMA_SIN_ORM
  Tabla/Modelo: notificacion
  Campo: por_categoria
  Descripción: Campo por_categoria existe en schema pero no en modelo ORM
  ...
  Tabla/Modelo: notificacion
  Campo: fallidas
  Descripción: Campo fallidas existe en schema pero no en modelo ORM
  ...
  Tabla/Modelo: notificacion
  Campo: por_tipo
  Descripción: Campo por_tipo existe en schema pero no en modelo ORM

  Tipo: SCHEMA_SIN_ORM
  Tabla/Modelo: notificacion
  Campo: leidas
  Descripción: Campo leidas existe en schema pero no en modelo ORM

  Tipo: SCHEMA_SIN_ORM
  Tabla/Modelo: notificacion
  Campo: fecha_desde
  Descripción: Campo fecha_desde existe en schema pero no en modelo ORM
...
----------------------------------------------------------------------------------------------------
  ...
  EJEMPLO:
    - Verificar campo 'total_mora_calculada' en modelo amortizacion
    - Verificar campo 'monto_pago' en modelo amortizacion
    - Verificar campo 'cuotas_vencidas' en modelo amortizacion
