-- Historial de correos por cliente (correos actuales y pasados).
-- Al cambiar email / email_secundario, el valor anterior se archiva aqui.
-- Idempotente.
...
COMMENT ON TABLE cliente_emails_historial IS
    'Correos anteriores (y conocidos) de clientes; busqueda CRM por correo pasado o por cedula.';
