-- =============================================================================
-- Verificación FIFO: pagos aplicados a cuotas por orden de numero_cuota
-- =============================================================================
...
--
-- Este script devuelve las filas donde se viola FIFO (cuota posterior con pago
-- mientras una cuota anterior no está completada).
-- =============================================================================

-- 1) Resumen: préstamos con al menos una violación FIFO
SELECT
  'Prestamos con violacion FIFO' AS tipo,
...
-- 3) Verificación global: 0 = cumple FIFO, >0 = violaciones
SELECT
  CASE
    WHEN EXISTS (
      SELECT 1
