 ...
 * ImplementaciÃ³n simple sin dependencias externas para evitar problemas de build
 */
...
class Logger {
  ...
  private shouldLog(level: LogLevel): boolean {
    ...
    if (this.isProduction) {
      // En producciÃ³n, solo logear warn y error
  ...
  private output(entry: LogEntry): void {
    ...
    if (this.isDevelopment) {
      ...
      // En producciÃ³n, usar console estÃ¡ndar para compatibilidad
  ...
  // MÃ©todo para logging de acciones de usuario
  ...
  // MÃ©todo para logging de errores de API
