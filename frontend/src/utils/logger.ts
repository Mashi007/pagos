 ...
 * ImplementaciÃÂ³n simple sin dependencias externas para evitar problemas de build
 */
...
class Logger {
  ...
  private shouldLog(level: LogLevel): boolean {
    ...
    if (this.isProduction) {
      // En producciÃÂ³n, solo logear warn y error
  ...
  private output(entry: LogEntry): void {
    ...
    if (this.isDevelopment) {
      ...
      // En producciÃÂ³n, usar console estÃÂ¡ndar para compatibilidad
  ...
  // MÃÂ©todo para logging de acciones de usuario
  ...
  // MÃÂ©todo para logging de errores de API
  ...
  // MÃÂ©todo para logging de performance
...
// Exportar tambiÃÂ©n la clase para testing
export { Logger }

// FunciÃÂ³n helper para migrar console.log existentes
