 ...
 * Convierte redacciÃÂ³n (cuerpo + firma) en HTML con formato profesional predefinido.
 */
 ...
 * Si no hay separador, devuelve todo el contenido en cuerpo y firma vacÃÂ­a.
 */
