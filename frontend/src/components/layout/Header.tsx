...
export function Header({ onMenuClick, isSidebarOpen }: HeaderProps) {
  ...
  const userRole = (user?.rol || 'operativo') === 'administrador' ? 'Administrador' : 'Operativo'  // Cambio clave: rol ÃÂ¢Ã¢ÂÂ Ã¢ÂÂ is_admin

  // Mock de notificaciones - en producciÃÂ³n vendrÃÂ­an del backend
  const notifications = [
    {
      id: 1,
      title: 'Pago recibido',
      message: 'Cliente Juan PÃÂ©rez realizÃÂ³ pago de $500',
      time: '5 min',
      read: false,
    },
    {
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden lg:block">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-lg p-2 border border-gray-200 ring-2 ring-gray-50">
