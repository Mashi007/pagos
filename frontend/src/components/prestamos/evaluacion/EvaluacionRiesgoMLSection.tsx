    ...
    <Card className="border-purple-200 bg-purple-50/50">
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-purple-700">
          ...
          PredicciÃÂ³n de Machine Learning
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {prediccion_ml.recommendation && (
          <div className="bg-white p-3 rounded border border-purple-200">
            <div className="text-sm font-medium text-gray-700 mb-1">RecomendaciÃÂ³n ML:</div>
        ...
        {prediccion_ml.modelo_usado && (
          <div className="bg-white p-3 rounded border border-purple-200">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div>
                <span className="text-gray-600">VersiÃÂ³n:</span>{' '}
        ...
        <div className="bg-blue-50 p-3 rounded border border-blue-200">
          <div className="text-xs font-semibold text-blue-900 mb-2">Ã¢ÂÂ¹Ã¯Â¸Â ComparaciÃÂ³n de MÃÂ©todos:</div>
          ...
          {clasificacion_riesgo === 'A' && prediccion_ml.riesgo_level === 'Bajo' && (
            <div className="mt-2 text-xs text-green-700 bg-green-100 p-2 rounded">
              [OK] Ambos mÃÂ©todos coinciden: Cliente de bajo riesgo
            </div>
          )}
          {clasificacion_riesgo === 'E' && prediccion_ml.riesgo_level === 'Alto' && (
            <div className="mt-2 text-xs text-red-700 bg-red-100 p-2 rounded">
              Ã¢ÂÂ Ã¯Â¸Â Ambos mÃÂ©todos coinciden: Cliente de alto riesgo
            </div>
          )}
          {((clasificacion_riesgo === 'A' || clasificacion_riesgo === 'B') &&
            ...
            <div className="mt-2 text-xs text-amber-700 bg-amber-100 p-2 rounded">
              Ã¢ÂÂ Ã¯Â¸Â Discrepancia detectada: El ML sugiere mayor riesgo que el sistema de puntos
            </div>
          )}
          {((clasificacion_riesgo === 'D' || clasificacion_riesgo === 'E') &&
            prediccion_ml.riesgo_level === 'Bajo') && (
            <div className="mt-2 text-xs text-amber-700 bg-amber-100 p-2 rounded">
              Ã¢ÂÂ Ã¯Â¸Â Discrepancia detectada: El ML sugiere menor riesgo que el sistema de puntos
            </div>
          )}
        </div>
      </CardContent>
