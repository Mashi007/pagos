...
export function EvaluacionRiesgoCriteriosSection({
        ...
        <CardContent className="pt-4 space-y-3">
          ...
          {resumenPrestamos && !resumenPrestamos.tiene_prestamos && (
            <div className="p-3 rounded bg-green-50 border border-green-200 text-green-800">
              No tiene prÃÂ©stamos vigentes. Puede continuar con el anÃÂ¡lisis.
            </div>
          )}
          {resumenPrestamos && resumenPrestamos.tiene_prestamos && (
            <div className="space-y-3">
              <div className="p-3 rounded bg-yellow-50 border border-yellow-200 text-yellow-900">
                PrÃÂ©stamos vigentes: {resumenPrestamos.total_prestamos}. Saldo pendiente total: $
              ...
              {bloqueadoPorMora ? (
                <div className="p-3 rounded bg-red-50 border border-red-200 text-red-800">
                  Hay cuotas en mora. No se puede continuar hasta regularizar la situaciÃÂ³n.
                </div>
              ) : (
                <div className="p-3 rounded bg-blue-50 border border-blue-200 text-blue-800">
                  No hay cuotas en mora. Puede continuar con el anÃÂ¡lisis.
                </div>
              )}
            </div>
          )}
        ...
        <CardContent className="pt-4 space-y-4">
              ...
              <Popover>
                ...
                <PopoverContent className="w-80">
                  ...
                  <ul className="text-xs space-y-1">
                    <li>- &lt; 25% Ã¢ÂÂ 14 puntos (Excelente)</li>
                    <li>- 25-35% Ã¢ÂÂ 11 puntos (Bueno)</li>
                    <li>- 35-50% Ã¢ÂÂ 6 puntos (Regular)</li>
                    <li>- &gt; 50% Ã¢ÂÂ 2 puntos (Malo)</li>
                  </ul>
                  <p className="text-sm font-semibold mb-2 mt-4">Ratio de Cobertura:</p>
                  <ul className="text-xs space-y-1">
                    <li>- &gt; 2.5x Ã¢ÂÂ 15 puntos (Excelente)</li>
                    <li>- 2.0-2.5x Ã¢ÂÂ 12 puntos (Bueno)</li>
                    <li>- 1.5-2.0x Ã¢ÂÂ 6 puntos (Regular)</li>
                    <li>- &lt; 1.5x Ã¢ÂÂ 0 puntos (RECHAZO)</li>
                  </ul>
                </PopoverContent>
              </Popover>
            </div>
          ...
          <div className="bg-blue-50 p-3 rounded border border-blue-200">
            <p className="text-xs text-blue-700">
              <strong>Nota:</strong> La cuota del prÃÂ©stamo se toma automÃÂ¡ticamente de la base de datos: $
        ...
        <CardContent className="pt-4 space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Escala: &gt; 24 meses Ã¢ÂÂ 9 pts, 12-24 Ã¢ÂÂ 7 pts, 6-12 Ã¢ÂÂ 4 pts, &lt; 6 Ã¢ÂÂ 0 pts
            </p>
          </div>
          <div>
            ...
            <Select value={formData.tipo_empleo} onValueChange={(v) => update('tipo_empleo', v)} required>
              ...
              <SelectContent>
                ...
                <SelectItem value="informal_estable">Informal Estable (&gt;1 aÃÂ±o) (6 pts)</SelectItem>
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Sector EconÃÂ³mico *</label>
            <Select value={formData.sector_economico} onValueChange={(v) => update('sector_economico', v)} required>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="gobierno_publico">Gobierno/PÃÂºblico (6 pts)</SelectItem>
                ...
                <SelectItem value="construccion_manufactura">ConstrucciÃÂ³n/Manufactura (3 pts)</SelectItem>
        ...
        <CardContent className="pt-4 space-y-4">
            ...
            <div key={n} className="border rounded-lg p-4 bg-purple-50">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <Input
                    type="text"
                    placeholder="Nombre, relaciÃÂ³n, etc."
                    value={
                ...
                <div>
                  <label className="block text-sm font-medium mb-1">CalificaciÃÂ³n *</label>
                  <Select
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="0">0 - No contestÃÂ³</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
          ...
          <div className="bg-purple-50 p-3 rounded border border-purple-200">
            <p className="text-xs text-purple-700">
              <strong>Escala:</strong> CalificaciÃÂ³n 3 Ã¢ÂÂ Recomendable (3 pts) | CalificaciÃÂ³n 2 Ã¢ÂÂ Dudosa (2 pts) |
              CalificaciÃÂ³n 1 Ã¢ÂÂ No recomendable (1 pt) | No contestÃÂ³ (0 pts)
              <br />
              <strong>Total mÃÂ¡ximo:</strong> 9 puntos (3 referencias x 3 pts c/u)
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-green-200">
        <CardHeader className="bg-green-50">
          <CardTitle className="flex items-center gap-2 text-green-700">
            ...
            CRITERIO 4: ARRAIGO GEOGRÃÂFICO (7 puntos)
          </CardTitle>
        </CardHeader>
        <CardContent className="pt-4 space-y-4">
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              &lt; 30 min Ã¢ÂÂ 3 pts, 30-60 min Ã¢ÂÂ 2 pts, &gt; 60 min Ã¢ÂÂ 0 pts
            </p>
          </div>
      ...
      <Card className="border-indigo-200">
        <CardHeader className="bg-indigo-50">
          <CardTitle className="flex items-center gap-2 text-indigo-700">
            ...
            CRITERIO 5: PERFIL SOCIODEMOGRÃÂFICO (17 puntos)
          </CardTitle>
        </CardHeader>
        <CardContent className="pt-4 space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1">SituaciÃÂ³n de Vivienda Detallada *</label>
            <Select
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="alquiler_mas_3">Alquiler &gt;3 aÃÂ±os (4 pts)</SelectItem>
                <SelectItem value="alquiler_1_3">Alquiler 1-3 aÃÂ±os (3 pts)</SelectItem>
                <SelectItem value="alquiler_menos_1">Alquiler &lt;1 aÃÂ±o (1 pt)</SelectItem>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">&gt; 5 personas Ã¢ÂÂ -0.5 pts</p>
            </div>
          </div>
          <div>
            ...
            <Select value={formData.estado_civil} onValueChange={(v) => update('estado_civil', v)} required>
              ...
              <SelectContent>
                <SelectItem value="casado_mas_3">Casado/a &gt;3 aÃÂ±os (3.5 pts)</SelectItem>
                <SelectItem value="casado_menos_3">Casado/a &lt;3 aÃÂ±os (3.0 pts)</SelectItem>
          ...
          <div className="space-y-2">
            {[
              ...
              { id: 'relacion_conflictiva', key: 'relacion_conflictiva' as const, label: 'RelaciÃÂ³n conflictiva (-1.0 pt)' },
            ].map(({ id, key, label }) => (
          ...
          <div>
            <label className="block text-sm font-medium mb-1">SituaciÃÂ³n de Hijos *</label>
  ...
  if (showSection === 'criterio6') {
    ...
    const aÃÂ±os = Math.floor(edad)
    const meses = Math.round((edad - aÃÂ±os) * 12)
    const mesesFinal = meses < 0 ? 0 : meses
    const edadDisplay = mesesFinal > 0 ? `${aÃÂ±os} aÃÂ±os y ${mesesFinal} meses` : `${aÃÂ±os} aÃÂ±os`
    ...
    return (
      <Card className="border-pink-200">
        ...
        <CardContent className="pt-4 space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1">Edad del Cliente (aÃÂ±os y meses) *</label>
            <Input
              type="text"
              value={edadDisplay}
              disabled
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              La edad se calcula automÃÂ¡ticamente desde la fecha de nacimiento del cliente en la base de datos (no
              editable)
            </p>
            <div className="bg-pink-50 p-3 rounded border border-pink-200 mt-3">
              <p className="text-xs text-pink-700">
                <strong>Escala (10 puntos mÃÂ¡x):</strong>
                <br />
                25-50 aÃÂ±os Ã¢ÂÂ 10.0 pts (ÃÂptimo) |
                <br />
                22-24 / 51-55 aÃÂ±os Ã¢ÂÂ 8.0 pts (Muy bueno/Bueno) |
                <br />
                18-21 / 56-60 aÃÂ±os Ã¢ÂÂ 6.0 pts (Regular) |
                <br />
                61-65 aÃÂ±os Ã¢ÂÂ 3.0 pts (Bajo) |
                <br />
                &lt; 18 aÃÂ±os Ã¢ÂÂ RECHAZO AUTOMÃÂTICO |
                <br />
                &gt; 65 aÃÂ±os Ã¢ÂÂ 2.0 pts (Muy bajo)
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="border-red-200">
        ...
        <CardContent className="pt-4 space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            <h4 className="font-semibold text-blue-900 mb-2">ÃÂ¿QuÃÂ© es la Capacidad de Maniobra?</h4>
            <p className="text-sm text-blue-800 mb-3">
              Es el saldo que le queda al cliente despuÃÂ©s de pagar todos sus gastos, deudas y la cuota del prÃÂ©stamo
              propuesto.
            </p>
            <div className="bg-white p-3 rounded border border-blue-100">
              <p className="text-xs font-mono text-gray-700">
                <strong>FÃÂ³rmula:</strong>
                <br />
          ...
          <div className="bg-green-50 p-4 rounded-lg border border-green-200">
            <h4 className="font-semibold text-green-900 mb-3">PREVISUALIZACIÃÂN - CÃÂLCULO EN TIEMPO REAL</h4>
            <div className="bg-white p-3 rounded border border-green-100 mb-3">
              <div className="grid grid-cols-2 gap-2 text-sm mb-2">
                <div className="text-gray-600">Ã¢ÂÂ¢ Ingresos Mensuales:</div>
                ...
                <div className="text-gray-600">- Cuota PrÃÂ©stamo:</div>
                <div className="font-semibold">-${cuotaNueva.toFixed(2)}</div>
                <div className="border-t pt-2 font-bold text-green-700">Ã¢ÂÂ¢ Saldo Residual:</div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-3">
              ...
              <div className="bg-white p-3 rounded border">
                <div className="text-xs text-gray-600">CategorÃÂ­a</div>
            ...
            <div className="bg-white p-3 rounded border text-center">
              <div className="text-xs text-gray-600 mb-1">PUNTOS QUE OBTENDRÃÂA:</div>
            ...
            {saldoResidual < 0 && (
              <div className="bg-red-100 p-2 rounded border border-red-300 mt-3">
                <p className="text-xs text-red-800 font-semibold">
                  Ã¢ÂÂ Ã¯Â¸Â ALERTA: El cliente tendrÃÂ­a un dÃÂ©ficit de ${Math.abs(saldoResidual).toFixed(2)} USD mensual
                </p>
              </div>
            )}
          </div>
          <div className="bg-amber-50 p-3 rounded border border-amber-200">
            <p className="text-xs text-amber-800 font-semibold mb-2">[!] ESTE CRITERIO SE CALCULA AUTOMÃÂTICAMENTE</p>
            <p className="text-xs text-amber-700">
              La previsualizaciÃÂ³n arriba usa los datos que ingresaste. Cuando hagas click en &quot;Evaluar Riesgo&quot;,
              el sistema calcularÃÂ¡ la capacidad de maniobra usando estos valores.
            </p>
          </div>
          <div className="bg-red-50 p-3 rounded border border-red-200">
            <p className="text-xs text-red-700">
              <strong>Escala de PuntuaciÃÂ³n (3 bandas):</strong>
              <br />
              [OK] &gt;=15% del ingreso Ã¢ÂÂ 5 pts (Holgado) - Margen suficiente para imprevistos
              <br />
              [!] 5%-14.9% del ingreso Ã¢ÂÂ 3 pts (Ajustado) - Margen mÃÂ­nimo
              <br />
              [X] &lt;5% o dÃÂ©ficit Ã¢ÂÂ 0 pts (Insuficiente) - Sin margen, alto riesgo
            </p>
          </div>
        </CardContent>
      </Card>
