...
export function EvaluacionRiesgoCriteriosSection({
          ...
          {resumenPrestamos && resumenPrestamos.tiene_prestamos && (
            <div className="space-y-3">
              <div className="p-3 rounded bg-yellow-50 border border-yellow-200 text-yellow-900">
                PrÃ©stamos vigentes: {resumenPrestamos.total_prestamos}. Saldo pendiente total: $
        ...
        <CardContent className="pt-4 space-y-4">
              ...
              <Popover>
                ...
                <PopoverContent className="w-80">
                  ...
                  <ul className="text-xs space-y-1">
                    <li>- &lt; 25% â 14 puntos (Excelente)</li>
                    <li>- 25-35% â 11 puntos (Bueno)</li>
                    <li>- 35-50% â 6 puntos (Regular)</li>
                    <li>- &gt; 50% â 2 puntos (Malo)</li>
                  </ul>
                  <p className="text-sm font-semibold mb-2 mt-4">Ratio de Cobertura:</p>
                  <ul className="text-xs space-y-1">
                    <li>- &gt; 2.5x â 15 puntos (Excelente)</li>
                    <li>- 2.0-2.5x â 12 puntos (Bueno)</li>
                    <li>- 1.5-2.0x â 6 puntos (Regular)</li>
                    <li>- &lt; 1.5x â 0 puntos (RECHAZO)</li>
                  </ul>
                </PopoverContent>
              </Popover>
            </div>
          ...
          <div className="bg-blue-50 p-3 rounded border border-blue-200">
            <p className="text-xs text-blue-700">
              <strong>Nota:</strong> La cuota del prÃ©stamo se toma automÃ¡ticamente de la base de datos: $
    ...
    return (
      <Card className="border-yellow-200">
        ...
        <CardContent className="pt-4 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Sector EconÃ³mico *</label>
        ...
        <CardContent className="pt-4 space-y-4">
          ...
          <div className="bg-purple-50 p-3 rounded border border-purple-200">
            <p className="text-xs text-purple-700">
              <strong>Escala:</strong> CalificaciÃ³n 3 â Recomendable (3 pts) | CalificaciÃ³n 2 â Dudosa (2 pts) |
              CalificaciÃ³n 1 â No recomendable (1 pt) | No contestÃ³ (0 pts)
              <br />
              <strong>Total mÃ¡ximo:</strong> 9 puntos (3 referencias x 3 pts c/u)
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-green-200">
        ...
        <CardContent className="pt-4 space-y-4">
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              &lt; 30 min â 3 pts, 30-60 min â 2 pts, &gt; 60 min â 0 pts
            </p>
          </div>
  ...
  if (showSection === 'criterio5') {
    return (
      <Card className="border-indigo-200">
        ...
        <CardContent className="pt-4 space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1">SituaciÃ³n de Vivienda Detallada *</label>
            <Select
          ...
          <div className="space-y-2">
            {[
              ...
              { id: 'relacion_conflictiva', key: 'relacion_conflictiva' as const, label: 'RelaciÃ³n conflictiva (-1.0 pt)' },
            ].map(({ id, key, label }) => (
          ...
          <div>
            <label className="block text-sm font-medium mb-1">SituaciÃ³n de Hijos *</label>
  ...
  if (showSection === 'criterio6') {
    ...
    const edadDisplay = mesesFinal > 0 ? `${aÃ±os} aÃ±os y ${mesesFinal} meses` : `${aÃ±os} aÃ±os`
    ...
    return (
      <Card className="border-pink-200">
        ...
        <CardContent className="pt-4 space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1">Edad del Cliente (aÃ±os y meses) *</label>
            <Input
              type="text"
              value={edadDisplay}
              disabled
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              La edad se calcula automÃ¡ticamente desde la fecha de nacimiento del cliente en la base de datos (no
              editable)
            </p>
            <div className="bg-pink-50 p-3 rounded border border-pink-200 mt-3">
              <p className="text-xs text-pink-700">
                <strong>Escala (10 puntos mÃ¡x):</strong>
                <br />
                25-50 aÃ±os â 10.0 pts (Ãptimo) |
                <br />
                22-24 / 51-55 aÃ±os â 8.0 pts (Muy bueno/Bueno) |
                <br />
                18-21 / 56-60 aÃ±os â 6.0 pts (Regular) |
                <br />
                61-65 aÃ±os â 3.0 pts (Bajo) |
                <br />
                &lt; 18 aÃ±os â RECHAZO AUTOMÃTICO |
                <br />
      ...
      <Card className="border-red-200">
        ...
        <CardContent className="pt-4 space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            <h4 className="font-semibold text-blue-900 mb-2">Â¿QuÃ© es la Capacidad de Maniobra?</h4>
            <p className="text-sm text-blue-800 mb-3">
              Es el saldo que le queda al cliente despuÃ©s de pagar todos sus gastos, deudas y la cuota del prÃ©stamo
              propuesto.
            </p>
          ...
          <div className="bg-green-50 p-4 rounded-lg border border-green-200">
            <h4 className="font-semibold text-green-900 mb-3">PREVISUALIZACIÃN - CÃLCULO EN TIEMPO REAL</h4>
            <div className="bg-white p-3 rounded border border-green-100 mb-3">
              <div className="grid grid-cols-2 gap-2 text-sm mb-2">
                <div className="text-gray-600">â¢ Ingresos Mensuales:</div>
                ...
                <div className="border-t pt-2 font-bold text-green-700">â¢ Saldo Residual:</div>
            ...
            {saldoResidual < 0 && (
              <div className="bg-red-100 p-2 rounded border border-red-300 mt-3">
                <p className="text-xs text-red-800 font-semibold">
                  â ï¸ ALERTA: El cliente tendrÃ­a un dÃ©ficit de ${Math.abs(saldoResidual).toFixed(2)} USD mensual
                </p>
              </div>
            )}
          </div>
          <div className="bg-amber-50 p-3 rounded border border-amber-200">
            <p className="text-xs text-amber-800 font-semibold mb-2">[!] ESTE CRITERIO SE CALCULA AUTOMÃTICAMENTE</p>
            <p className="text-xs text-amber-700">
              La previsualizaciÃ³n arriba usa los datos que ingresaste. Cuando hagas click en &quot;Evaluar Riesgo&quot;,
              el sistema calcularÃ¡ la capacidad de maniobra usando estos valores.
            </p>
          </div>
          <div className="bg-red-50 p-3 rounded border border-red-200">
            <p className="text-xs text-red-700">
              <strong>Escala de PuntuaciÃ³n (3 bandas):</strong>
              <br />
              [OK] &gt;=15% del ingreso â 5 pts (Holgado) - Margen suficiente para imprevistos
              <br />
              [!] 5%-14.9% del ingreso â 3 pts (Ajustado) - Margen mÃ­nimo
              <br />
              [X] &lt;5% o dÃ©ficit â 0 pts (Insuficiente) - Sin margen, alto riesgo
            </p>
          </div>
        </CardContent>
      </Card>
