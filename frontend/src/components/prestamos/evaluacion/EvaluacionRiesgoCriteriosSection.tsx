...
export function EvaluacionRiesgoCriteriosSection({
  ...
  const update = <K extends keyof EvaluacionFormData>(
    k: K,
    v: EvaluacionFormData[K]
          ...
          {resumenPrestamos && resumenPrestamos.tiene_prestamos && (
            <div className="space-y-3">
              <div className="rounded border border-yellow-200 bg-yellow-50 p-3 text-yellow-900">
                Préstamos vigentes: {resumenPrestamos.total_prestamos}. Saldo
                pendiente total: $
                    ...
                    {(resumenPrestamos.prestamos || []).map((p: any) => (
                      <tr key={p.id} className="border-b">
                        ...
                        <td className="py-2 pr-4">
                          ${Number(p.total_financiamiento).toFixed(2)}
                        </td>
              ...
              {bloqueadoPorMora ? (
                <div className="rounded border border-red-200 bg-red-50 p-3 text-red-800">
                  Hay cuotas en mora. No se puede continuar hasta regularizar la
                  situación.
                </div>
              ) : (
        ...
        <CardContent className="space-y-4 pt-4">
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  update('ingresos_mensuales', parseFloat(e.target.value) || 0)
                }
                required
              />
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="mt-1 h-6 p-0 text-xs text-blue-600"
                  >
            ...
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  update('otras_deudas', parseFloat(e.target.value) || 0)
                }
                required
              />

              <p className="mt-1 text-xs text-gray-500">
                Sin incluir la cuota actual
              </p>
            </div>
          </div>
          ...
          <div className="rounded border border-blue-200 bg-blue-50 p-3">
            <p className="text-xs text-blue-700">
              <strong>Nota:</strong> La cuota del préstamo se toma
        ...
        <CardContent className="space-y-4 pt-4">
          <div>
            ...
            <Input
              ...
              onChange={e =>
                update('meses_trabajo', parseInt(e.target.value) || 0)
              }
              required
            />

            <p className="mt-1 text-xs text-gray-500">
              Escala: &gt; 24 meses → 9 pts, 12-24 → 7 pts, 6-12 → 4 pts, &lt; 6
              → 0 pts
            </p>
          </div>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={v => update('tipo_empleo', v)}
              required
            >
              <SelectTrigger>
                <SelectValue />
              ...
              <SelectContent>
                <SelectItem value="empleado_formal">
                  Empleado Formal (8 pts)
                </SelectItem>

                <SelectItem value="informal_estable">
                  Informal Estable (&gt;1 año) (6 pts)
                </SelectItem>

                <SelectItem value="independiente_formal">
                  Independiente Formal (RIF/NIT) (5 pts)
                </SelectItem>

                <SelectItem value="independiente_informal">
                  Independiente Informal (3 pts)
                </SelectItem>

                <SelectItem value="sin_empleo">
                  Sin Empleo Fijo (0 pts)
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={v => update('sector_economico', v)}
              required
            >
              <SelectTrigger>
                <SelectValue />
              ...
              <SelectContent>
                <SelectItem value="gobierno_publico">
                  Gobierno/Público (6 pts)
                </SelectItem>

                <SelectItem value="servicios_esenciales">
                  Servicios Esenciales (5 pts)
                </SelectItem>

                <SelectItem value="comercio_establecido">
                  Comercio Establecido (4 pts)
                </SelectItem>

                <SelectItem value="construccion_manufactura">
                  Construcción/Manufactura (3 pts)
                </SelectItem>

                <SelectItem value="turismo_entretenimiento">
                  Turismo/Entretenimiento (2 pts)
                </SelectItem>

                <SelectItem value="servicios_temporales">
                  Servicios Temporales (1 pt)
                </SelectItem>

                <SelectItem value="agricultura_estacional">
                  Agricultura Estacional (0 pts)
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
  ...
  if (showSection === 'criterio3') {
    return (
      <Card className="border-purple-200">
        ...
        <CardContent className="space-y-4 pt-4">
          {[1, 2, 3].map(n => (
            <div key={n} className="rounded-lg border bg-purple-50 p-4">
              <h4 className="mb-3 text-sm font-medium">Referencia {n}</h4>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <Input
                    ...
                    onChange={e =>
                      update(
                        `referencia${n}_observaciones` as keyof EvaluacionFormData,
                        e.target.value
                      )
                    }
                  />
                ...
                <div>
                  ...
                  <Select
                    value={
                      (formData as any)[
                        `referencia${n}_calificacion`
                      ]?.toString() ?? '0'
                    }
                    onValueChange={v =>
                      update(
                        `referencia${n}_calificacion` as keyof EvaluacionFormData,
                        parseInt(v)
                      )
                    }
                  >
          ...
          <div className="rounded border border-purple-200 bg-purple-50 p-3">
            <p className="text-xs text-purple-700">
              <strong>Escala:</strong> Calificación 3 → Recomendable (3 pts) |
              Calificación 2 → Dudosa (2 pts) | Calificación 1 → No recomendable
              (1 pt) | No contestó (0 pts)
              <br />
              <strong>Total máximo:</strong> 9 puntos (3 referencias x 3 pts
              c/u)
            </p>
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-4 pt-4">
          <div>
            ...
            <Input
              ...
              onChange={e =>
                update('minutos_trabajo', parseInt(e.target.value) || 0)
              }
              required
            />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="familia_pais" className="cursor-pointer text-sm">
        ...
        <CardContent className="space-y-4 pt-4">
          <div>
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="casa_propia_pagada">
                  Casa Propia Pagada (6 pts)
                </SelectItem>

                <SelectItem value="casa_propia_hipoteca">
                  Casa Propia con Hipoteca (5 pts)
                </SelectItem>

                <SelectItem value="casa_familiar">
                  Casa Familiar/Heredada (5 pts)
                </SelectItem>

                <SelectItem value="alquiler_mas_3">
                  Alquiler &gt;3 años (4 pts)
                </SelectItem>

                <SelectItem value="alquiler_1_3">
                  Alquiler 1-3 años (3 pts)
                </SelectItem>

                <SelectItem value="alquiler_menos_1">
                  Alquiler &lt;1 año (1 pt)
                </SelectItem>

                <SelectItem value="prestado">De Prestado (0.5 pts)</SelectItem>

                <SelectItem value="sin_vivienda">
                  Sin Vivienda (0 pts)
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="zona_urbana" className="cursor-pointer text-sm">
            ...
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="zona_rural" className="cursor-pointer text-sm">
            ...
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  update('personas_casa', parseInt(e.target.value) || 1)
                }
              />
          ...
          <div>
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="casado_mas_3">
                  Casado/a &gt;3 años (3.5 pts)
                </SelectItem>

                <SelectItem value="casado_menos_3">
                  Casado/a &lt;3 años (3.0 pts)
                </SelectItem>

                <SelectItem value="divorciado_con_hijos">
                  Divorciado/a con hijos (2.5 pts)
                </SelectItem>

                <SelectItem value="soltero_con_pareja">
                  Soltero/a con pareja (2.0 pts)
                </SelectItem>

                <SelectItem value="soltero_sin_pareja">
                  Soltero/a sin pareja (1.5 pts)
                </SelectItem>

                <SelectItem value="divorciado_sin_hijos">
                  Divorciado/a sin hijos (1.0 pt)
                </SelectItem>

                <SelectItem value="separado_reciente">
                  Separado/a reciente (0 pts)
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            {[
              {
                id: 'pareja_trabaja',
                key: 'pareja_trabaja' as const,
                label: 'Pareja trabaja (+1.0 pt)',
              },

              {
                id: 'pareja_aval',
                key: 'pareja_aval' as const,
                label: 'Pareja es aval (+1.5 pts)',
              },

              {
                id: 'pareja_desempleada',
                key: 'pareja_desempleada' as const,
                label: 'Pareja desempleada (-0.5 pts)',
              },

              {
                id: 'relacion_conflictiva',
                key: 'relacion_conflictiva' as const,
                label: 'Relación conflictiva (-1.0 pt)',
              },
            ].map(({ id, key, label }) => (
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={v => update('situacion_hijos', v)}
              required
            >
              <SelectTrigger>
                <SelectValue />
              ...
              <SelectContent>
                <SelectItem value="1_2_menores">
                  1-2 hijos menores (0-12) (5.0 pts)
                </SelectItem>

                <SelectItem value="1_2_mayores">
                  1-2 hijos mayores (13+) (4.0 pts)
                </SelectItem>

                <SelectItem value="3_4_mixtos">
                  3-4 hijos mixtos (3.0 pts)
                </SelectItem>

                <SelectItem value="sin_hijos_planea">
                  Sin hijos, planea (2.5 pts)
                </SelectItem>

                <SelectItem value="5_mas">5+ hijos (1.5 pts)</SelectItem>

                <SelectItem value="sin_hijos_no_planea">
                  Sin hijos, no planea (2.0 pts)
                </SelectItem>

                <SelectItem value="hijos_independientes">
                  Hijos independientes (1.0 pt)
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            {[
              {
                id: 'todos_estudian',
                key: 'todos_estudian' as const,
                label: 'Todos estudian (+0.5 pts)',
              },

              {
                id: 'viven_con_cliente',
                key: 'viven_con_cliente' as const,
                label: 'Viven con cliente (+0.5 pts)',
              },

              {
                id: 'necesidades_especiales',
                key: 'necesidades_especiales' as const,
                label: 'Necesidades especiales (-1.0 pt)',
              },

              {
                id: 'viven_con_ex',
                key: 'viven_con_ex' as const,
                label: 'Viven con ex (-0.5 pts)',
              },

              {
                id: 'embarazo_actual',
                key: 'embarazo_actual' as const,
                label: 'Embarazo actual (-0.5 pts)',
              },
            ].map(({ id, key, label }) => (
              <div key={id} className="flex items-center space-x-2">
                <input
  ...
  if (showSection === 'criterio6') {
    ...
    const edadDisplay =
      mesesFinal > 0 ? `${años} años y ${mesesFinal} meses` : `${años} años`
        ...
        <CardContent className="space-y-4 pt-4">
          <div>
            ...
            <Input
              ...
              disabled
              readOnly
              className="cursor-not-allowed bg-gray-100 font-semibold text-gray-700"
            />

            <p className="mt-1 text-xs text-gray-500">
              La edad se calcula automáticamente desde la fecha de nacimiento
              del cliente en la base de datos (no editable)
            </p>

            <div className="mt-3 rounded border border-pink-200 bg-pink-50 p-3">
      ...
      <Card className="border-red-200">
        ...
        <CardContent className="space-y-4 pt-4">
          ...
          <div className="rounded-lg border border-green-200 bg-green-50 p-4">
            ...
            <div className="mb-3 rounded border border-green-100 bg-white p-3">
            ...
            {saldoResidual < 0 && (
              <div className="mt-3 rounded border border-red-300 bg-red-100 p-2">
                <p className="text-xs font-semibold text-red-800">
                  ⚠️ ALERTA: El cliente tendría un déficit de $
                  {Math.abs(saldoResidual).toFixed(2)} USD mensual
                </p>
              </div>
            )}
          </div>
          ...
          <div className="rounded border border-amber-200 bg-amber-50 p-3">
            <p className="mb-2 text-xs font-semibold text-amber-800">
              [!] ESTE CRITERIO SE CALCULA AUTOMÁTICAMENTE
            </p>

            <p className="text-xs text-amber-700">
              La previsualización arriba usa los datos que ingresaste. Cuando
              hagas click en &quot;Evaluar Riesgo&quot;, el sistema calculará la
              capacidad de maniobra usando estos valores.
            </p>
          </div>
          ...
          <div className="rounded border border-red-200 bg-red-50 p-3">
            <p className="text-xs text-red-700">
              ...
              <br />
              [OK] &gt;=15% del ingreso → 5 pts (Holgado) - Margen suficiente
              para imprevistos
              <br />
              [!] 5%-14.9% del ingreso → 3 pts (Ajustado) - Margen mínimo
              <br />
              [X] &lt;5% o déficit → 0 pts (Insuficiente) - Sin margen, alto
              riesgo
            </p>
          </div>
        </CardContent>
