...
export function ModalValidacionPrestamoExistente({
  ...
  const handleConfirm = () => {
    if (!justificacion.trim()) {
      setError('Debe ingresar una justificaciÃÂ³n para continuar')
      return
    }

    if (justificacion.trim().length < 10) {
      setError('La justificaciÃÂ³n debe tener al menos 10 caracteres')
      return
    }
  ...
  const getEstadoBadge = (estado: string) => {
    const estados: Record<string, { label: string; className: string }> = {
      ...
      EN_REVISION: { label: 'En RevisiÃÂ³n', className: 'bg-yellow-500' },
      ...
      >
        ...
        >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900">
                  Cliente ya tiene crÃÂ©dito(s) existente(s)
                </h2>
                <p className="text-sm text-gray-600 mt-1">
                  Se requiere justificaciÃÂ³n para crear un nuevo prÃÂ©stamo
                </p>
              </div>
            </div>
            <Button
          ...
          <div className="p-6 space-y-6">
            ...
            <Card className="border-yellow-200 bg-yellow-50">
              ...
              <CardContent>
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <p className="text-sm text-gray-600">Total PrÃÂ©stamos</p>
            ...
            {/* Detalles de PrÃÂ©stamos */}
            <div>
              <h3 className="text-lg font-semibold mb-4">Detalles de PrÃÂ©stamos Existentes</h3>
                      ...
                      <div className="grid grid-cols-4 gap-4">
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <p className="text-xs text-gray-600">VehÃÂ­culo</p>
                          </div>
            ...
            <Card className="border-blue-200">
              ...
              <CardContent className="space-y-4">
                <Textarea
                  placeholder="Ingrese una justificaciÃÂ³n detallada de por quÃÂ© se estÃÂ¡ creando un nuevo prÃÂ©stamo cuando el cliente ya tiene crÃÂ©dito(s) existente(s). (MÃÂ­nimo 10 caracteres)"
                  value={justificacion}
                  onChange={(e) => {
                ...
                <p className="text-xs text-gray-500">
                  Esta justificaciÃÂ³n serÃÂ¡ guardada junto con el prÃÂ©stamo y quedarÃÂ¡ registrada como parte de la auditorÃÂ­a.
                </p>
              </CardContent>
            </Card>
