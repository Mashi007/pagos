...
export function TablaAmortizacionPrestamo({ prestamo }: TablaAmortizacionPrestamoProps) {
  ...
  // Cargar cuotas del prÃ©stamo (tabla de amortizaciÃ³n desde BD: pagos aplicados a cuotas)
  ...
  const determinarEstadoReal = (cuota: Cuota): string => {
    ...
    // Respaldo si el API no envÃ­a estado Ãºtil (versiones antiguas)
  ...
  const getEstadoBadge = (estado: string) => {
    ...
    const badges = {
      ...
      VENCIDO: 'bg-orange-100 text-orange-800',  // [MORA] Nueva: vencida pero <= 90 dÃ­as
      MORA: 'bg-red-100 text-red-800',           // [MORA] Nueva: >= 91 dÃ­as
  ...
  const getEstadoLabel = (estado: string) => {
    ...
    const labels: Record<string, string> = {
      ...
      VENCIDO: 'Vencido (â¤90 d)',      // [MORA] Nueva
        ...
        <CardContent className="pt-6">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm text-yellow-800">
              La tabla de amortizaciÃ³n solo se puede ver para prÃ©stamos APROBADOS.
      ...
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button
            ...
            onClick={() => refetch()}
            disabled={isFetching}
            title="Actualizar tabla con los Ãºltimos pagos aplicados"
          >
          ...
          <Table>
            ...
            <TableBody>
              {cuotasVisibles.map((cuota: Cuota) => {
                ...
                // Priorizar pago_monto_conciliado del backend (valores conciliados por prÃ©stamo), luego total_pagado, luego monto_cuota si estÃ¡ pagado
                ...
                return (
                  <TableRow key={cuota.id}>
                    ...
                    <TableCell>
                      ...
                      {/* Ã°Å¸âÂ DEBUG: Mostrar informaciÃ³n de depuraciÃ³n */}
