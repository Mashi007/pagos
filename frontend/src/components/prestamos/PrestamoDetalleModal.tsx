...
export function PrestamoDetalleModal({ prestamo: prestamoInitial, onClose }: PrestamoDetalleModalProps) {
  ...
  // Cargar predicciÃ³n de impago si el prÃ©stamo estÃ¡ aprobado
  useEffect(() => {
                ...
                <Card>
                  ...
                  <CardContent className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-medium">{prestamoData.cedula ? 'â'}</p>
                    </div>
                    <div>
                      <label className="text-sm text-gray-600">Nombres</label>
                      <p className="font-medium">{prestamoData.nombres ? 'â'}</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-gray-500 mt-0.5">Base para vencimientos de la tabla de amortizaciÃ³n</p>
                    </div>
                  </CardContent>
                </Card>
                      ...
                      {cargandoPrediccion ? (
                        ...
                        <div className="text-center py-4">
                          <p className="text-sm text-gray-500">
                            No hay modelo activo para predecir impago. Entrena un modelo en ConfiguraciÃ³n Ã¢â â AI Ã¢â â ML Impago.
                          </p>
                        </div>
                      )}
                    </CardContent>
