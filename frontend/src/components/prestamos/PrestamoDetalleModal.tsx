          ...
          <div className="sticky top-0 z-10 flex items-center justify-between border-b bg-white p-4">
            <div>
              <h2 className="text-2xl font-bold">
                Detalles del Préstamo #{prestamoData.id}
              </h2>

              <p className="text-sm text-gray-600">
                Cliente: {prestamoData.nombres}
              </p>
            </div>
              ...
              <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="font-medium">
                        {prestamoData.modalidad_pago === 'MENSUAL'
                          ? 'Mensual'
                          : prestamoData.modalidad_pago === 'QUINCENAL'
                            ? 'Quincenal'
                            : prestamoData.modalidad_pago === 'SEMANAL'
                              ? 'Semanal'
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xl font-semibold">
                        ...
                        {(typeof prestamoData.cuota_periodo === 'number'
                          ...
                          : Number(prestamoData.cuota_periodo) ||
                            (prestamoData.total_financiamiento &&
                            prestamoData.numero_cuotas
                              ? Number(prestamoData.total_financiamiento) /
                                prestamoData.numero_cuotas
                              : 0)
                        ).toFixed(2)}
                      </p>
                      ...
                      <p className="font-medium">
                        {(
                          (typeof prestamoData.tasa_interes === 'number'
                            ...
                            : Number(prestamoData.tasa_interes) || 0) * 100
                        ).toFixed(2)}
                        %
                      </p>
                    </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-blue-600">
                            {evaluacionRiesgo.puntuacion_total?.toFixed(2) ||
                              '0.00'}{' '}
                            / 100
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <Badge
                            className={
                              evaluacionRiesgo.clasificacion_riesgo === 'A'
                                ? 'border-green-300 bg-green-100 text-green-800'
                                : evaluacionRiesgo.clasificacion_riesgo === 'B'
                                  ? 'border-blue-300 bg-blue-100 text-blue-800'
                                  : evaluacionRiesgo.clasificacion_riesgo ===
                                      'C'
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {evaluacionRiesgo.decision_final || 'N/A'}
                          </p>
                        </div>

                        {evaluacionRiesgo.sugerencias
                        ...
                        <div className="mt-4 border-t pt-4">
                          ...
                          <div className="grid grid-cols-2 gap-2 text-sm">
                            ...
                            <div>
                              ...
                              {evaluacionRiesgo.detalle_criterios
                                .antiguedad_trabajo?.puntos || 0}{' '}
                              pts
                            </div>

                            <div>
                              Criterio 3 - Referencias:{' '}
                              {evaluacionRiesgo.detalle_criterios.referencias
                                ?.puntos || 0}{' '}
                              pts
                            </div>
                            ...
                            <div>
                              ...
                              {evaluacionRiesgo.detalle_criterios.vivienda
                                ?.puntos || 0}{' '}
                              pts
                            </div>
                            ...
                            <div>
                              Criterio 6 - Edad:{' '}
                              {evaluacionRiesgo.detalle_criterios.edad
                                ?.puntos || 0}{' '}
                              pts
                            </div>
                ...
                {prestamoData.estado === 'APROBADO' && (
                  <Card
                    className={
                      prediccionImpago
                        ? getRiesgoColor(prediccionImpago.nivel_riesgo)
                        : ''
                    }
                  >
                    <CardHeader>
                        ...
                        <div className="space-y-4">
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <div className="font-semibold text-red-600">
                                {(
                                  prediccionImpago.probabilidad_impago * 100
                                ).toFixed(1)}
                                %
                              </div>
                            </div>
                            ...
                            <div>
                              ...
                              <div className="font-semibold text-green-600">
                                {(
                                  prediccionImpago.probabilidad_pago * 100
                                ).toFixed(1)}
                                %
                              </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2">
                              ...
                              <div>
                                ...
                                <div className="text-sm">
                                  {prediccionImpago.recomendacion}
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          {prediccionImpago.modelo_usado && (
                            <div className="pt-2 text-xs text-gray-500">
                              Modelo: {prediccionImpago.modelo_usado.nombre} v
                              {prediccionImpago.modelo_usado.version} (
                              ...
                              {prediccionImpago.modelo_usado.accuracy && (
                                <>
                                  ...
                                  - Accuracy:{' '}
                                  {(
                                    prediccionImpago.modelo_usado.accuracy * 100
                                  ).toFixed(1)}
                                  %
                                </>
                              )}
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    <div>
                      ...
                      <p className="font-medium">
                        {prestamoData.usuario_proponente}
                      </p>
