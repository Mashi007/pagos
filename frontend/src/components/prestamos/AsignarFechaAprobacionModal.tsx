...
export function AsignarFechaAprobacionModal({ prestamo, onClose, onSuccess }: AsignarFechaAprobacionModalProps) {
  ...
  const handleAsignarFecha = async () => {
    ...
    const mensajeConfirmacion =
      ...
      `Esta acciÃ³n:\n` +
      `â¢ MantendrÃ¡ el estado en APROBADO (con fecha de aprobaciÃ³n)\n` +
    ...
    try {
      ...
      toast.success(
        `Fecha de aprobaciÃ³n asignada. Estado: APROBADO. ` +
          ...
          <CardContent className="p-6">
            <div className="space-y-6">
              <div className="bg-green-50 p-4 rounded border border-green-200">
                <h5 className="font-semibold text-green-900 mb-4">Ã°Å¸ââ¦ Fecha de AprobaciÃ³n y Desembolso:</h5>
                <div className="bg-blue-50 p-3 rounded border border-blue-200 mb-4">
                  <p className="text-sm font-medium text-blue-900 mb-2">
                    Ã¢Å¡ Ã¯Â¸Â Requisitos para desembolsar:
                  </p>
                  <ul className="text-xs text-blue-800 list-disc list-inside space-y-1">
                    ...
                    <li>El estado quedarÃ¡ en APROBADO (con fecha de aprobaciÃ³n)</li>
                  </ul>
                </div>
