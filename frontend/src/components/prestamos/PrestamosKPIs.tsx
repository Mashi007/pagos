...
export function PrestamosKPIs({
  ...
  const aÃÂ±oLabel = kpiDataFinal.anio ? anioSel

  if (isLoading) {
    return (
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-bold text-gray-900">KPIs de PrÃÂ©stamos</h2>
        </div>
  ...
  return (
    <div className="space-y-6">
      {/* Encabezado con selector de mes/aÃÂ±o */}
      <div className="flex flex-wrap justify-between items-center gap-4">
        <h2 className="text-2xl font-bold text-gray-900">KPIs de PrÃÂ©stamos (mensuales)</h2>
        <div className="flex items-center gap-2">
          ...
          <Select value={String(anioSel)} onValueChange={(v) => setAnioSel(Number(v))}>
            <SelectTrigger className="w-[100px]">
              <SelectValue placeholder="AÃÂ±o" />
            </SelectTrigger>
            <SelectContent>
          ...
          <span className="text-sm text-gray-500 tabular-nums">{nombreMes} {aÃÂ±oLabel}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">PrÃÂ©stamos (mensual)</CardTitle>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600 mt-1">Por cobrar de prÃÂ©stamos aprobados en {nombreMes}</p>
          </CardContent>
        </Card>
      </div>
    </div>
