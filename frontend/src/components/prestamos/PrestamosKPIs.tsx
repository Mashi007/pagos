...
export function PrestamosKPIs({
  ...
  const a̱oLabel = kpiDataFinal.anio ? anioSel
  ...
  return (
    <div className="space-y-6">
      {/* Encabezado con selector de mes/a̱o */}
      <div className="flex flex-wrap justify-between items-center gap-4">
        <h2 className="text-2xl font-bold text-gray-900">KPIs de Pr̩stamos (mensuales)</h2>
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-500 tabular-nums">{nombreMes} {a̱oLabel}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Pr̩stamos (mensual)</CardTitle>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600 mt-1">Por cobrar de pr̩stamos aprobados en {nombreMes}</p>
          </CardContent>
        </Card>
      </div>
    </div>
