...
export function EvaluacionRiesgoForm({ prestamo, onClose, onSuccess }: EvaluacionRiesgoFormProps) {
  ...
  // [OK] Validación completa: todos los 7 criterios deben estar completos
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const confirmacion = window.confirm(
      ...
      'âœ“ La información de empleo es correcta\n' +
    ...
    referencia3_calificacion: formData.referencia3_calificacion,
      ...
      setTimeout(() => {
        ...
        toast.info('ðŸ”„ Ahora puede usar el nuevo icono en el dashboard para proceder con la Aprobación (Fase 2)')
      }, 2000)
    } catch (error: any) {
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[60vh]">
          ...
          {/* CRITERIO 4: ARRAIGO GEOGRAFICO (7 puntos) */}
          ...
          {/* CRITERIO 5: PERFIL SOCIODEMOGRAFICO (17 puntos) */}
            ...
            <Card className="border-pink-200">
              ...
              <CardContent className="pt-4 space-y-4">
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    La edad se calcula automáticamente desde la fecha de nacimiento del cliente en la base de datos (no editable)
                  </p>
          ...
          {showSection === 'criterio7' && (
            ...
            <CardContent className="pt-4 space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                <h4 className="font-semibold text-blue-900 mb-2">ðŸ“Š ¿Qué es la Capacidad de Maniobra?</h4>
              ...
              {(() => {
                ...
                return (
                  <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                    <h4 className="font-semibold text-green-900 mb-3">ðŸ“Š PREVISUALIZACIÓN - CALCULO EN TIEMPO REAL</h4>
                    ...
                    <div className="bg-white p-3 rounded border text-center">
                      <div className="text-xs text-gray-600 mb-1">PUNTOS QUE OBTENDRIA:</div>
              ...
              <div className="bg-amber-50 p-3 rounded border border-amber-200">
                <p className="text-xs text-amber-800 font-semibold mb-2">[!] ESTE CRITERIO SE CALCULA AUTOMATICAMENTE</p>
                ...
                {resultado.sugerencias && (
                  <div className="bg-blue-50 p-4 rounded border border-blue-200">
                    <div className="flex justify-between items-center mb-3">
                      <h5 className="font-semibold text-blue-900">ðŸ“‹ Condiciones para Aprobación:</h5>
                      <Button
                        type="button"
                        variant="outline"
                        size="sm"
                ...
                {resultado.prediccion_ml && (
                  <Card className="border-purple-200 bg-purple-50/50">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="bg-blue-50 p-3 rounded border border-blue-200">
                        <div className="text-xs font-semibold text-blue-900 mb-2">ðŸ“Š Comparación de Métodos:</div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-2 text-sm text-blue-800">
                      ...
                      <div className="mt-3 pt-3 border-t border-blue-300">
                        <p className="font-semibold text-purple-700 mb-1">ðŸ”„ SIGUIENTE PASO: Fase 2 - Aprobación</p>
                        <p className="text-xs">
