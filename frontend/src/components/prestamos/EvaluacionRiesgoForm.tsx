...
export function EvaluacionRiesgoForm({ prestamo, onClose, onSuccess }: EvaluacionRiesgoFormProps) {
  ...
  const secciones = [
    { id: 'situacion', label: 'SituaciÃÂ³n del Cliente', puntos: '' },
    ...
    { id: 'criterio4', label: 'Criterio 4: Arraigo GeogrÃÂ¡fico', puntos: '7' },
    { id: 'criterio5', label: 'Criterio 5: Perfil SociodemogrÃÂ¡fico', puntos: '17' },
    { id: 'criterio6', label: 'Criterio 6: Edad', puntos: '10' },
    { id: 'criterio7', label: 'Criterio 7: Capacidad de Maniobra', puntos: '5' },
    ...(resultado ? [{ id: 'resultado', label: 'Resultado de EvaluaciÃÂ³n', puntos: '' }] : []),
  ]
        ...
        <div className="bg-gray-50 px-4 py-2 border-b overflow-x-auto">
          ...
          {!todasSeccionesCompletas && (
            <div className="mt-2 text-xs text-amber-700 bg-amber-50 border border-amber-200 px-3 py-2 rounded">
              <strong>Ã¢ÂÂ Ã¯Â¸Â Debe completar todos los 7 criterios antes de evaluar.</strong> Faltan:{' '}
              {[
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[60vh]">
          ...
          {showSection === 'resultado' && resultado && (
            <Card className="border-green-300 bg-green-50">
              <CardHeader>
                <CardTitle className="text-green-700">Resultado de la EvaluaciÃÂ³n</CardTitle>
              </CardHeader>
                ...
                {resultado.sugerencias && (
                  <div className="bg-blue-50 p-4 rounded border border-blue-200">
                    <div className="flex justify-between items-center mb-3">
                      <h5 className="font-semibold text-blue-900">Condiciones para AprobaciÃÂ³n:</h5>
                      <Button
                        type="button"
                        variant="outline"
                        size="sm"
                      ...
                      >
                        {showFormularioAprobacion ? 'Ocultar EdiciÃÂ³n' : 'Editar Condiciones'}
                      </Button>
                    </div>
                    {!showFormularioAprobacion ? (
                      <div className="grid grid-cols-3 gap-4">
                        <div>
                          <label className="text-xs text-blue-700">Tasa de InterÃÂ©s Sugerida:</label>
                          <p className="text-lg font-bold text-blue-900">
                            {resultado.sugerencias.tasa_interes_sugerida || 0}%
                          </p>
                        </div>
                        <div>
                          <label className="text-xs text-blue-700">Plazo MÃÂ¡ximo Sugerido:</label>
                          <p className="text-lg font-bold text-blue-900">
                            {resultado.sugerencias.plazo_maximo_sugerido || 36} meses
                          </p>
                        </div>
                        <div>
                          <label className="text-xs text-blue-700">Enganche MÃÂ­nimo:</label>
                          <p className="text-lg font-bold text-blue-900">
                      ...
                      <div className="bg-white p-4 rounded border border-blue-300 space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <textarea
                            ...
                            rows={3}
                            placeholder="Aprobado despuÃÂ©s de evaluaciÃÂ³n de riesgo..."
                          />
                        </div>
                      </div>
                    )}
                ...
                <div className="bg-white p-3 rounded border">
                  ...
                  <ul className="list-disc list-inside text-sm space-y-1">
                    ...
                    <li>
                      ...
                      {resultado.detalle_criterios?.antiguedad_trabajo?.puntos?.toFixed(1)} pts (AntigÃÂ¼edad) +{' '}
                    ...
                    <li>
                      <strong>4. Arraigo GeogrÃÂ¡fico:</strong>{' '}
                    ...
                    <li>
                      <strong>5. Perfil SociodemogrÃÂ¡fico:</strong>{' '}
                    ...
                    <li>
                      ...
                      {resultado.detalle_criterios?.edad?.cliente} aÃÂ±os)
                    </li>
                    <li>
