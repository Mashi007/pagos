...
export function ErroresDetallados({ errores, tipo, onDescargarErrores }: ErroresDetalladosProps) {
  ...
  const obtenerCorreccionPorTipo = (errorMsg: string): string => {
    const correcciones: Record<string, string> = {
      cedula: 'Verificar formato de cÃÂ©dula venezolana (V12345678)',
      telefono: 'Formato: +5804123456789 o 04123456789',
      email: 'Formato vÃÂ¡lido: usuario@dominio.com',
      monto: 'Solo nÃÂºmeros, usar punto para decimales (ej: 108.50)',
      fecha: 'Formato: DD/MM/YYYY o YYYY-MM-DD',
      'no encontrado': 'Primero cargar el cliente con esta cÃÂ©dula'
    }
  ...
  const obtenerTipoError = (errorMsg: string): string => {
    const tiposError: Record<string, string> = {
      cedula: 'CÃÂ©dula',
      telefono: 'TelÃÂ©fono',
      mÃÂ³vil: 'TelÃÂ©fono',
      email: 'Email',
      monto: 'Monto',
      fecha: 'Fecha',
    ...
    >
      <Card className="border-red-200 bg-gradient-to-r from-red-50 to-red-100">
        <CardHeader>
          <CardTitle className="flex items-center justify-between text-red-800">
            <div className={`flex items-center space-x-${SPACE_BETWEEN}`}>
              ...
              <div>
                <span className="text-lg font-bold">Errores Requieren CorrecciÃÂ³n Manual</span>
                <p className="text-sm font-normal text-red-600 mt-1">
                  {errores.length} registros con problemas de validaciÃÂ³n
                </p>
              </div>
            </div>
        ...
        <CardContent className={`space-y-${GRID_GAP}`}>
          <AlertWithIcon
            variant="destructive"
            title={`${errores.length} registros requieren correcciÃÂ³n manual`}
            description="Estos registros no pudieron procesarse automÃÂ¡ticamente. Descarga la lista para corregirlos y volver a cargar."
          />
            ...
            <Table>
              <TableHeader className="bg-red-50">
                <TableRow>
                  ...
                  <TableHead className="text-red-800 font-semibold">CÃÂ©dula</TableHead>
                  <TableHead className="text-red-800 font-semibold">Tipo de Error</TableHead>
                  <TableHead className="text-red-800 font-semibold">DescripciÃÂ³n</TableHead>
                  <TableHead className="text-red-800 font-semibold">AcciÃÂ³n</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
          ...
          {/* Instrucciones mejoradas */}
            ...
            <h4 className="font-bold text-blue-900 mb-4 flex items-center">
              ...
              ÃÂ°ÃÂ¸Ã¢ÂÂÃ¢ÂÂ¹ Instrucciones para CorrecciÃÂ³n
            </h4>
            <div className={`grid grid-cols-1 md:grid-cols-${GRID_COLS_MD} gap-${CARD_PADDING}`}>
              <div>
                ...
                <ol className="text-sm text-blue-700 space-y-2 list-decimal list-inside">
                  <li>Descarga la lista de errores usando el botÃÂ³n "Lista de Correcciones"</li>
                  <li>Corrige los datos en Excel segÃÂºn las sugerencias mostradas</li>
              ...
              <div>
                ...
                <ul className="text-sm text-blue-700 space-y-1">
                  <li>Ã¢ÂÂ¢ <strong>CÃÂ©dula:</strong> Formato V12345678</li>
                  <li>Ã¢ÂÂ¢ <strong>TelÃÂ©fono:</strong> +5804123456789</li>
                  <li>Ã¢ÂÂ¢ <strong>Email:</strong> usuario@dominio.com</li>
                  <li>Ã¢ÂÂ¢ <strong>Monto:</strong> Solo nÃÂºmeros con punto decimal</li>
                </ul>
              </div>
            </div>
          </div>
