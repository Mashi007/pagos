...
export const TasaCambioModal: React.FC<TasaCambioModalProps> = ({
  ...
  const handleSave = async () => {
    ...
    if (isNaN(tasaNum) || tasaNum <= 0) {
      setError('Ingrese una tasa vÃÂ¡lida (nÃÂºmero mayor a 0)')
      return
    }
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-md p-6">
        ...
        <p className="text-gray-700 text-sm mb-6">
          Ingrese la tasa oficial de cambio para hoy (BS / USD). Esta tasa serÃÂ¡ aplicada a todos los pagos en BolÃÂ­vares del dÃÂ­a.
        </p>
        ...
        {success && (
          <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg flex items-center gap-2">
            ...
            <p className="text-sm text-green-700">ÃÂ¡Tasa guardada exitosamente!</p>
          </div>
        )}
