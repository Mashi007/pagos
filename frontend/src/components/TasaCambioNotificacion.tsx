...
export const TasaCambioNotificacion: React.FC<TasaCambioNotificacionProps> = ({ onTasaCargada }) => {
  ...
  // No mostrar nada si no debe ingresar o estÃ¡ cargando
          ...
          <div className="max-w-7xl mx-auto flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-bold text-amber-900">
                â ï¸ Ingreso obligatorio: Tasa de Cambio Oficial
              </p>
              <p className="text-sm text-amber-800 mt-1">
                Debe ingresar la tasa de cambio oficial del dÃ­a para continuar. Esta tasa serÃ¡ aplicada a todos los pagos en BolÃ­vares.
              </p>
            </div>
            <button
