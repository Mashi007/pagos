...
export const TasaCambioNotificacion: React.FC<TasaCambioNotificacionProps> = ({ onTasaCargada }) => {
  ...
  // No mostrar nada si no debe ingresar o estÃÂ¡ cargando
          ...
          <div className="max-w-7xl mx-auto flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-bold text-amber-900">
                Ã¢ÂÂ Ã¯Â¸Â Ingreso obligatorio: Tasa de Cambio Oficial
              </p>
              <p className="text-sm text-amber-800 mt-1">
                Debe ingresar la tasa de cambio oficial del dÃÂ­a para continuar. Esta tasa serÃÂ¡ aplicada a todos los pagos en BolÃÂ­vares.
              </p>
            </div>
            <button
