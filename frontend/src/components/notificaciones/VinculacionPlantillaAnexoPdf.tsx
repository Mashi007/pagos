...
/**
 * Muestra la plantilla "Plantilla anexo PDF" y a quÃ© pestaÃ±as de notificaciÃ³n estÃ¡ vinculada
 * (tipos con incluir_pdf_anexo === true en la configuraciÃ³n de envÃ­os).
 */
    ...
    <Card className="mb-6 border-blue-100 bg-blue-50/30">
      <CardHeader className="pb-2">
        ...
        <p className="text-sm text-gray-600 mt-1">
          Esta plantilla genera el archivo <strong>Carta_Cobranza.pdf</strong> que se adjunta al correo. Se usa en las pestaÃ±as de notificaciÃ³n que tengan la opciÃ³n &quot;PDF&quot; activa.
        </p>
      </CardHeader>
      <CardContent className="pt-0">
        <div className="flex items-center gap-2 text-sm text-gray-700 mb-2">
          <LinkIcon className="h-4 w-4 text-blue-600 shrink-0" />
          <span className="font-medium">Vinculada a las siguientes pestaÃ±as:</span>
        </div>
        {cargando ? (
          ...
          <p className="text-sm text-amber-700 bg-amber-50 border border-amber-200 rounded-md px-3 py-2">
            Ninguna pestaÃ±a tiene el PDF activo. Activa la opciÃ³n &quot;PDF&quot; en{' '}
            <Link to="/notificaciones?tab=configuracion" className="text-blue-600 hover:underline font-medium">
              Notificaciones â ConfiguraciÃ³n
            </Link>{' '}
