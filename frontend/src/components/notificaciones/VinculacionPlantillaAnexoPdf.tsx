...
/**
 * Muestra la plantilla "Plantilla anexo PDF" y a quÃÂ© pestaÃÂ±as de notificaciÃÂ³n estÃÂ¡ vinculada
 * (tipos con incluir_pdf_anexo === true en la configuraciÃÂ³n de envÃÂ­os).
 */
      ...
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between gap-2 flex-wrap">
          ...
          >
            ...
            Configurar envÃÂ­os
          </Link>
        </div>
        <p className="text-sm text-gray-600 mt-1">
          Esta plantilla genera el archivo <strong>Carta_Cobranza.pdf</strong> que se adjunta al correo. Se usa en las pestaÃÂ±as de notificaciÃÂ³n que tengan la opciÃÂ³n &quot;PDF&quot; activa.
        </p>
      </CardHeader>
      <CardContent className="pt-0">
        <div className="flex items-center gap-2 text-sm text-gray-700 mb-2">
          <LinkIcon className="h-4 w-4 text-blue-600 shrink-0" />
          <span className="font-medium">Vinculada a las siguientes pestaÃÂ±as:</span>
        </div>
        {cargando ? (
          ...
          <p className="text-sm text-amber-700 bg-amber-50 border border-amber-200 rounded-md px-3 py-2">
            Ninguna pestaÃÂ±a tiene el PDF activo. Activa la opciÃÂ³n &quot;PDF&quot; en{' '}
            <Link to="/notificaciones?tab=configuracion" className="text-blue-600 hover:underline font-medium">
              Notificaciones Ã¢ÂÂ ConfiguraciÃÂ³n
            </Link>{' '}
