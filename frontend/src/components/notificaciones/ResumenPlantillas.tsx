...
export function ResumenPlantillas({
  ...
  const handleEliminar = async (plantilla: NotificacionPlantilla) => {
    if (
      !window.confirm(
        `¿Está seguro de eliminar la plantilla "${plantilla.nombre}"?`
      )
    ) {
      return
    }
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Visualización organizada de todas las plantillas almacenadas,
            clasificadas por tipo de notificación y caso.
          </CardDescription>
        </CardHeader>
          ...
          {loading ? (
            ...
            <div className="py-8 text-center text-gray-500">
              ...
              <p className="mt-2 text-sm">
                Vaya a la pestaña "Plantillas" para crear nuevas plantillas.
              </p>
            </div>
          ) : (
            <div className="space-y-6">
              {categoriasOrden.map(categoriaInfo => {
                ...
                return (
                  <Card
                    ...
                    style={{
                      borderLeftColor: `var(--color-${categoriaInfo.color}-500)`,
                    }}
                  >
                        ...
                        <Table>
                          ...
                          <TableBody>
                            {plantillasCategoria.map(plantilla => {
                              const mapeo =
                                mapeoTipos[
                                  plantilla.tipo as keyof typeof mapeoTipos
                                ]
