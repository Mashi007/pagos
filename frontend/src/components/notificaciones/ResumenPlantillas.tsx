...
const categoriasOrden = [
  { key: 'NotificaciÃ³n Previa', color: 'blue', icon: 'Ã°Å¸ââ¦' },
  { key: 'DÃ­a de Pago', color: 'green', icon: 'Ã°Å¸âÂ°' },
  { key: 'NotificaciÃ³n Retrasada', color: 'orange', icon: 'Ã¢Å¡ Ã¯Â¸Â' },
  { key: 'Prejudicial', color: 'red', icon: 'Ã°Å¸Å¡Â¨' },
]
