...
export function ExcelUploaderUI(props: ExcelUploaderProps) {
  ...
  /** Regla: observaciÃÂ³n 100% solo nombre(s) de columna Ã¢ÂÂ sin "duplicado" ni texto extra */
  const columnasDuplicadas = (motivos: string[]) =>
    [...new Set(motivos.map((m) => {
      if (m.includes('cÃÂ©dula')) return 'CÃÂ©dula'
      if (m.includes('email')) return 'Email'
      if (m.includes('nombres')) return 'Nombres'
      if (m.includes('telÃÂ©fono')) return 'TelÃÂ©fono'
      return m
    }))].join(', ')
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto p-6 space-y-6">
              ...
              <CardContent className="pt-6">
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold mb-2">
                    {isDragging ? 'Suelta el archivo aquÃÂ­' : 'Sube tu archivo Excel'}
                  </h3>
                  <p className="text-gray-600 mb-4 text-sm">
                    Columnas: CÃÂ©dula | Nombres | Apellidos | Email | TelÃÂ©fono | Estado (opcional). Duplicado = 100% igual. CÃÂ©dula se compara con tabla clientes: si ya existe no se puede guardar.
                  </p>
                  <Button
          ...
          {/* Tabla y estadÃÂ­sticas cuando hay datos */}
          {excelData.length > 0 && (
                    ...
                    <table className="w-full border-collapse min-w-[1400px]">
                      ...
                      <tbody>
                        {getDisplayData().map((row) => {
                          ...
                          const esCedulaNoAcepta = esDuplicado && motivosDuplicado.some((m) => /c[eÃÂ©]dula/i.test(m))
                          return (
                            <tr
                              key={row._rowIndex}
                              className={
                ...
                <CardContent className="pt-4">
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <Badge variant="outline" className="text-green-700">VÃÂ¡lidos: {getValidClients().length}</Badge>
                      ...
                      {hasDuplicates && (
                        <Badge variant="outline" className="text-red-800 bg-red-100 border-red-400">
                          NO DUPLICADOS (cÃÂ©dula, nombres, email, tel)
                        </Badge>
                      )}
                      {enviadosRevisar.size > 0 && (
                      ...
                      <div className="p-6">
                        <div className="flex items-center justify-between mb-4">
                          <h2 className="text-2xl font-bold text-red-600 flex items-center">
                            ...
                            Errores de ValidaciÃÂ³n Encontrados
                          </h2>
                          <Button
                            variant="ghost"
                            size="sm"
                        ...
                        <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg">
                          ...
                          <p className="text-sm text-red-600 mt-1">
                            <strong>Errores incluyen:</strong> campos de validaciÃÂ³n invÃÂ¡lidos.
                          </p>
                        </div>
                          ...
                          <div className="flex items-start space-x-2">
                            ...
                            <div className="text-sm text-blue-800">
                              ...
                              <ul className="mt-2 ml-4 list-disc space-y-1">
                                <li>
                                  Los campos con fondo rojo en la tabla tienen errores de validaciÃÂ³n
                                </li>
                                <li>Haz clic en cualquier campo para editarlo directamente</li>
                                <li>
Los errores se corrigen automÃÂ¡ticamente al escribir valores
                                    vÃÂ¡lidos
                                </li>
                                <li>
                                  Una vez corregidos todos los errores, podrÃÂ¡s guardar los datos
                                </li>
                              </ul>
                            </div>
                          </div>
                    ...
                    >
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        <h2 className="text-xl font-bold text-gray-800">
                          CÃÂ©dulas ya registradas
                        </h2>
                      </div>
                      <p className="text-sm text-gray-600 mb-3">
                        Las siguientes cÃÂ©dulas ya existen en el sistema. Si continÃÂºa, esas filas se
                        omitirÃÂ¡n y solo se guardarÃÂ¡n el resto.
                      </p>
