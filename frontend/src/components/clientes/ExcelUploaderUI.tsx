...
export function ExcelUploaderUI(props: ExcelUploaderProps) {
  ...
  /** Regla: observaciÃ³n 100% solo nombre(s) de columna â sin "duplicado" ni texto extra */
  const columnasDuplicadas = (motivos: string[]) =>
    [...new Set(motivos.map((m) => {
      if (m.includes('cÃ©dula')) return 'CÃ©dula'
      if (m.includes('email')) return 'Email'
      if (m.includes('nombres')) return 'Nombres'
      if (m.includes('telÃ©fono')) return 'TelÃ©fono'
      return m
    }))].join(', ')
              ...
              <CardContent className="pt-6">
                ...
                >
                  ...
                  <p className="text-gray-600 mb-4 text-sm">
                    Columnas: CÃ©dula | Nombres | Apellidos | Email | TelÃ©fono | Estado (opcional). Duplicado = 100% igual. CÃ©dula se compara con tabla clientes: si ya existe no se puede guardar.
                  </p>
                  <Button
                    ...
                    <table className="w-full border-collapse min-w-[1400px]">
                      ...
                      <tbody>
                        {getDisplayData().map((row) => {
                          ...
                          const esCedulaNoAcepta = esDuplicado && motivosDuplicado.some((m) => /c[eÃ©]dula/i.test(m))
                          return (
                            <tr
                              key={row._rowIndex}
                              className={
                          ...
                          <div className="flex items-start space-x-2">
                            ...
                            <div className="text-sm text-blue-800">
                              ...
                              <ul className="mt-2 ml-4 list-disc space-y-1">
                                <li>
                                  Los campos con fondo rojo en la tabla tienen errores de validaciÃ³n
                                </li>
