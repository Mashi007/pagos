...
export function ClientesList() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <Button
            ...
            className="px-6 py-6 text-base font-semibold"
            title="Ver clientes enviados desde carga mÃ¡siva para revisiÃ³n manual (descargar Excel)"
          >
      ...
      {/* Seccin Revisar clientes (enviados desde carga mÃ¡siva) */}
      {showRevisarClientes && (
        <Card className="border-amber-200 bg-amber-50/50">
          <CardContent className="p-4">
            <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Clientes enviados desde la carga mÃ¡siva para revisiÃ³n manual. Descarga el Excel para corregir y reimportar.
                </p>
              </div>
            ...
            {revisarLoading ? (
              ...
              <p className="text-gray-500 text-center py-6">No hay clientes pendientes de revisiÃ³n.</p>
            ) : (
              <>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="font-semibold">Ãlt. actualizaciÃ³n</TableHead>
                    ...
                    <TableCell>
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          CÃ©dula: {String(cliente.cedula ? '')} | ID: {String(cliente.id ? '')}
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
