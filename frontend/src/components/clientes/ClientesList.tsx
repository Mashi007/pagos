...
export function ClientesList() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2 flex-wrap">
          <Button
            ...
            title="Actualizar datos y estadÃÂ­sticas"
          >
          ...
          <Button
            ...
            className="px-6 py-6 text-base font-semibold"
            title="Ver clientes enviados desde carga mÃÂ¡siva para revisiÃÂ³n manual (descargar Excel)"
          >
      ...
      {/* Seccin Revisar clientes (enviados desde carga mÃÂ¡siva) */}
      {showRevisarClientes && (
        <Card className="border-amber-200 bg-amber-50/50">
          <CardContent className="p-4">
            <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Clientes enviados desde la carga mÃÂ¡siva para revisiÃÂ³n manual. Descarga el Excel para corregir y reimportar.
                </p>
              </div>
            ...
            {revisarLoading ? (
              ...
              <p className="text-gray-500 text-center py-6">No hay clientes pendientes de revisiÃÂ³n.</p>
            ) : (
              <>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  placeholder="Buscar por CÃÂ©dula o Nombres..."
                  value={searchTerm}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      type="text"
                      placeholder="Usuario que registrÃÂ³"
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="font-semibold">ÃÂlt. actualizaciÃÂ³n</TableHead>
                    ...
                    <TableCell>
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          CÃÂ©dula: {String(cliente.cedula ? '')} | ID: {String(cliente.id ? '')}
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
            ...
            >
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  CÃÂ©dula: {clienteSeleccionado.cedula}
                </p>
              </div>
      ...
      {/* ? NOTIFICACIN ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½NICA */}
      {notification && (
        <motion.div
