    ...
    <Card>
      ...
      <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              placeholder="Ejemplo: Juan Carlos PÃÂ©rez GonzÃÂ¡lez"
              autoComplete="name"
            />
          </div>
        ...
        <div className="space-y-2 min-h-[80px]">
          <label className="text-sm font-medium text-gray-700">
            OcupaciÃÂ³n <span className="text-red-500">*</span> <span className="text-gray-500 text-xs">(mÃÂ¡ximo 2 palabras)</span>
          </label>
          <div className="relative">
