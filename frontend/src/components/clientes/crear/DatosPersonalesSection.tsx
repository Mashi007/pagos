      ...
      <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div className="space-y-2">
          ...
          {getFieldValidation('cedula') && (
            <div
              className={`flex items-center gap-1 text-xs ${getFieldValidation('cedula')?.isValid ? 'text-green-600' : 'text-red-600'}`}
            >
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-gray-700">
            ...
            <span className="text-xs text-gray-500">(2-7 palabras)</span>
          </label>
          ...
          {getFieldValidation('nombres') && (
            <div
              className={`flex items-center gap-1 text-xs ${getFieldValidation('nombres')?.isValid ? 'text-green-600' : 'text-red-600'}`}
            >
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 ${getFieldValidation('fechaNacimiento')?.isValid === false ? 'border-2 border-red-500 bg-red-50' : ''}`}
            />
          </div>

          {getFieldValidation('fechaNacimiento') &&
            getFieldValidation('fechaNacimiento')?.isValid === false && (
        ...
        <div className="min-h-[80px] space-y-2">
          <label className="text-sm font-medium text-gray-700">
            ...
            <span className="text-xs text-gray-500">(máximo 2 palabras)</span>
          </label>
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`w-full pl-10 ${getFieldValidation('ocupacion')?.isValid === false ? 'border-2 border-red-500 bg-red-50' : ''}`}
              placeholder="Ejemplo: Ingeniero, Gerente General"
            />
          </div>

          {getFieldValidation('ocupacion') &&
            getFieldValidation('ocupacion')?.isValid === false && (
              <div className="flex items-center gap-1 text-xs font-medium text-red-600">
                <XCircle className="h-3 w-3" />
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value: string) => onInputChange('estado', value)}
          >
            <SelectTrigger>
