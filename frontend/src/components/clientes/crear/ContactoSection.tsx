    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Contacto y DirecciÃÂ³n
        </CardTitle>
      </CardHeader>
      <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          <label className="text-sm font-medium text-gray-700">
            TelÃÂ©fono <span className="text-red-500">*</span>
          </label>
        ...
        <div className="md:col-span-2 space-y-4">
          <div className="flex items-center gap-2 pb-2 border-b">
            ...
            <label className="text-sm font-semibold text-gray-700">
              DirecciÃÂ³n <span className="text-red-500">*</span>
            </label>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2 md:col-span-2">
              <label className="text-sm font-medium text-gray-700">
                DescripciÃÂ³n (Lugar cercano, color de casa) <span className="text-gray-500 text-xs">(mÃÂ­nimo 5 palabras)</span>
              </label>
              <Textarea
                value={formData.descripcion}
                onChange={(e) => onInputChange('descripcion', e.target.value)}
                placeholder="Ej: Cerca del mercado central, casa color azul claro, portÃÂ³n verde"
                rows={3}
