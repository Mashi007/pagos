/**
 * Componente reutilizable para campo de contraseÃÂ±a con funcionalidades avanzadas
 */
...
export const PasswordField = ({
  value,
  onChange,
  placeholder = 'MÃÂ­nimo 8 caracteres',
  required = false,
  minLength = 8,
  ...
  // Usar el valor del prop si estÃÂ¡ disponible, sino usar el del hook
  ...
  return (
    <div className={`space-y-2 ${className}`}>
      <div className="flex gap-2">
        ...
        {showGenerateButton && (
          <Button
            ...
            disabled={disabled}
            className="px-3"
            title="Generar contraseÃÂ±a automÃÂ¡tica"
          >
      ...
      {/* Indicador de fortaleza de contraseÃÂ±a */}
      {currentPassword && (
