...
export function SearchableSelect({
  ...
  // Filtrar opciones basado en el tÃÂ©rmino de bÃÂºsqueda
  useEffect(() => {
    if (searchTerm.trim() === '') {
  ...
  // Manejar selecciÃÂ³n de opciÃÂ³n
    ...
    <div ref={containerRef} className={cn("relative", className)}>
      ...
      <button
        ...
        className={cn(
          ...
          // Aplicar clases de error si estÃÂ¡n presentes, sino usar estilos por defecto
