    ...
    <div ref={containerRef} className={cn('relative', className)}>
      ...
      <button
        ...
        className={cn(
          ...
          className?.includes('border-red-800')
            ? className
      ...
      {isOpen && (
        <div className="absolute z-50 mt-1 w-full rounded-md border border-gray-300 bg-white shadow-xl">
          {/* Search Input */}
          ...
          <div className="border-b border-gray-200 p-3">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-md border border-gray-300 bg-white py-3 pl-10 pr-10 text-base text-black focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
