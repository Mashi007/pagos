...
export const AUDITORIA_CARTERA_CONTROLES_CATALOGO: ReadonlyArray<{
  ...
  },
  {
    ...
    excepcionesReglas:
      ...
      'Excepcion autorizada aqui: Visto admin (dialogo Control 5 en esta pestaña o POST control-5-pagos-duplicados-fecha-monto/{pago_id}/visto). El sistema elige A o P + 4 digitos; bitacora en auditoria_pago_control5_visto; columna pagos.excluir_control_pagos_mismo_dia_monto. Si el comprobante aun no tiene sufijo _A/_P, el admin puede aplicar Visto aunque ya no exista par misma fecha+monto (p. ej. tras correcciones o Visto en el otro pago).\n\n' +
