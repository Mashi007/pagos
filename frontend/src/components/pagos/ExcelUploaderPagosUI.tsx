 ...
 * Formatos de columnas soportados: D) CÃ©dula | Monto | Fecha | Documento (recomendado);
 * A) Documento | CÃ©dula | Fecha | Monto; B) Fecha | CÃ©dula | Monto | Documento;
 * C) CÃ©dula | ID PrÃ©stamo | Fecha | Monto | Documento.
 * Solo crÃ©ditos activos (APROBADO) en el selector.
 */
      ...
      >
        ...
        <div className="flex-shrink-0 bg-gradient-to-r from-green-600 to-green-700 text-white p-6 rounded-t-lg">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-green-100 mt-0.5">Recomendado: CÃ©dula | Fecha | Monto | Documento. MÃ¡x. 10 MB. Hasta 2.500 filas recomendado; mÃ¡x. 10.000.</p>
              </div>
              <div
          ...
          <div className="mt-4 flex flex-wrap items-center gap-4 rounded-lg bg-white/15 px-4 py-2 text-sm">
            ...
            <span className="flex items-center gap-1.5">
              <span className="text-green-100">VÃ¡lidas:</span>
              <strong className="text-white tabular-nums">{validCount}</strong>
            </span>
            <span className="flex items-center gap-1.5">
              <span className="text-green-100">InvÃ¡lidas:</span>
              ...
              <CardContent className="pt-6">
                ...
                >
                  ...
                  <p className="text-gray-600 mb-4 text-sm">
                    Columnas: CÃ©dula | Fecha de pago | Monto | Documento | ID PrÃ©stamo (opcional) | ConciliaciÃ³n (SÃ­/No). Documentos numÃ©ricos largos se normalizan automÃ¡ticamente.
                  </p>
                ...
                <CardContent className="pt-4">
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <Badge variant="outline" className="text-green-700 border-green-400">VÃ¡lidas: {validCount}</Badge>
                      <Badge variant="outline" className={invalidCount > 0 ? 'text-red-700 border-red-400' : ''}>InvÃ¡lidas: {invalidCount}</Badge>
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() => {
                          addToast('warning', 'Se borrarÃ¡ todo y se cargarÃ¡ otro archivo.')
                          clearAndShowFileSelect()
                        }}
                      >
                        <X className="mr-2 h-4 w-4" />
                      ...
                      {getRowsToRevisarPagos().length > 0 && (
                        <Button
                          ...
                          disabled={isSendingAllRevisar || serviceStatus === 'offline'}
                          className="bg-amber-100 border-amber-400 text-amber-800 hover:bg-amber-200"
                          title="Enviar TODAS las pendientes a Revisar Pagos: invÃ¡lidas + duplicados + sin crÃ©dito / varios crÃ©ditos sin elegir"
                        >
                          {isSendingAllRevisar ? (
                            <>
                              <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                            ...
                            <>
                              <Search className="mr-2 h-4 w-4" />
                              Enviar todas â Revisar Pagos ({getRowsToRevisarPagos().length})
                            </>
                          )}
                        </Button>
                      )}
                    ...
                    <table className="w-full border-collapse min-w-[980px]">
                      ...
                      <tbody>
                        {excelData
                          ...
                          // Normalizar prestamo_id: acepta numÃ©rico o formato VE-96179604, VE/96179604, etc.
