      ...
      <Card className="border-orange-300 bg-orange-50 shadow-md">
        ...
        <CardContent className="pt-4">
          ...
          <div className="mt-3 p-3 bg-orange-100 border border-orange-200 rounded text-sm text-orange-800">
            <strong>Nota:</strong> Los pagos con error se guardan en la tabla de errores. Puede revisarlos y moverlos a "Revisar Pagos" para anÃ¡lisis posterior.
          </div>
        </CardContent>
      </Card>
    </motion.div>
