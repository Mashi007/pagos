              ...
              <TableBody>
                {items.map(item => (
                  <TableRow
                    key={String(
                      item.pago_id ??
                        `${item.fecha}-${item.cedula}-${item.documento}`
                    )}
                  >
        ...
        <CardContent className="py-8">
          ...
          <div className="mt-4 flex justify-center">
            <Button
              variant="outline"
              onClick={() => refetch()}
              aria-label="Reintentar cargar reporte de pagos"
            >
    ...
    <Card className="shadow-sm">
      <CardHeader className="flex flex-col gap-4 pb-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <CardDescription>
            Pagos por mes/año. Columnas: Fecha, ID préstamo, Cédula, Nombre,
            Monto pago, Documento. Orden descendente por fecha.
          </CardDescription>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            size="sm"
            onClick={() => refetch()}
            aria-label="Actualizar reporte de pagos"
          >
            <RefreshCw className="mr-2 h-4 w-4" aria-hidden />
            Actualizar
          </Button>
