...
export function DiferenciasAbonosInformativo() {
  ...
  const handleVerPrestamos = () => {
    // Navegar a la pÃÂ¡gina de prÃÂ©stamos con filtro de requiere_revision
    navigate('/prestamos?requiere_revision=true')
  }

  // Si hay error o estÃÂ¡ cargando, mostrar estado correspondiente
  if (isLoading) {
    return (
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Cargando informaciÃÂ³n...</p>
              </div>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className="py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-900">Diferencias de Abonos</p>
                <p className="text-sm text-red-600">Error al cargar informaciÃÂ³n</p>
              </div>
            </div>
          </div>
        </CardContent>
    ...
    return (
      <Card className="border-l-4 border-l-gray-300">
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            PrÃÂ©stamos marcados para revisiÃÂ³n con diferencias entre BD y valores de referencia
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center justify-between">
            <div className="text-center flex-1">
              ...
              <p className="text-sm text-gray-400 mt-1">
                Marca prÃÂ©stamos para revisar en la pÃÂ¡gina de PrÃÂ©stamos para que aparezcan aquÃÂ­.
              </p>
            </div>
          </div>
        </CardContent>
  ...
  // Si hay diferencias, mostrar conteo y botÃÂ³n
  return (
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-lg font-semibold text-gray-900">
              {cantidadPrestamos} {cantidadPrestamos === 1 ? 'prÃÂ©stamo' : 'prÃÂ©stamos'} que validar
            </p>
            <p className="text-sm text-gray-600 mt-1">
              Hay prÃÂ©stamos con diferencias pendientes de revisiÃÂ³n
            </p>
          </div>
          <Button
