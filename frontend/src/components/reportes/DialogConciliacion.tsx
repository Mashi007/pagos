Ã¯Â»Â¿import { useState, useCallback } from 'react'
...
export function DialogConciliacion({ open, onOpenChange, onGuardar }: DialogConciliacionProps) {
  ...
  const validar = useCallback((filasToValidate: FilaConciliacion[]) => {
    ...
    filasToValidate.forEach((f, i) => {
      // CÃÂ©dulas invÃÂ¡lidas se procesarÃÂ¡n como "cedula no encontrada"
              ...
              {resumen && (
                <div className="bg-blue-50 border border-blue-200 rounded p-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div>
                      <span className="text-gray-600">CÃÂ©dulas ÃÂnicas:</span>
