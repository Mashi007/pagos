      ...
      <CardContent>
        {items.length === 0 ? (
          <p className="py-4 text-sm text-gray-500">
            No hay cuentas por cobrar en este mes.
          </p>
        ) : (
      ...
      <Card className="border-red-200 shadow-sm">
        <CardContent className="py-8">
          <p className="text-center text-red-600">
            Error al cargar. Intente nuevamente.
          </p>
          ...
          <div className="mt-4 flex justify-center">
            <Button
              variant="outline"
              onClick={() => refetch()}
              aria-label="Reintentar cargar cuentas por cobrar"
            >
    ...
    <Card className="shadow-sm">
      <CardHeader className="flex flex-col gap-4 pb-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <CardDescription>
            Una pestaña por mes. Por día del mes: cuotas por cobrar ese día. Se
            actualiza al aprobar o eliminar préstamos.
          </CardDescription>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            size="sm"
            onClick={() => refetch()}
            aria-label="Actualizar cuentas por cobrar"
          >
            <RefreshCw className="mr-2 h-4 w-4" aria-hidden />
            Actualizar
          </Button>
