...
import {
  reporteService,
  type ProductosPorMes,
  type ProductoPorMesItem,
        ...
        <CardContent className="py-8">
          ...
          <div className="mt-4 flex justify-center">
            <Button
              variant="outline"
              onClick={() => refetch()}
              aria-label="Reintentar cargar reporte de productos"
            >
    ...
    <Card className="shadow-sm">
      <CardHeader className="flex flex-col gap-4 pb-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <CardDescription>
            Una pestaña por mes. Columnas: Modelo vehículo, Total
            financiamiento, Valor del activo (70%).
          </CardDescription>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            size="sm"
            onClick={() => refetch()}
            aria-label="Actualizar reporte de productos"
          >
            <RefreshCw className="mr-2 h-4 w-4" aria-hidden />
            Actualizar
          </Button>
