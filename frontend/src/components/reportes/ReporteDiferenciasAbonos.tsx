...
export function ReporteDiferenciasAbonos() {
  ...
  // MutaciÃÂ³n para ajustar total_abonos_bd
  ...
  // MutaciÃÂ³n para actualizar valor de imagen
  ...
  const handleGuardar = (prestamoId: number) => {
    ...
    if (isNaN(total) || total < 0) {
      toast.error('El total debe ser un nÃÂºmero vÃÂ¡lido mayor o igual a 0')
      return
    }
  ...
  const handleGuardarImagen = (cedula: string) => {
    ...
    if (isNaN(valor) || valor < 0) {
      toast.error('El valor debe ser un nÃÂºmero vÃÂ¡lido mayor o igual a 0')
      return
    }
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {diferencias.length} prÃÂ©stamo(s) con diferencias pendientes de revisiÃÂ³n. Puedes ajustar el total de abonos
          y el sistema redistribuirÃÂ¡ los pagos uniformemente.
        </CardDescription>
      </CardHeader>
      <CardContent>
