...
export function KpiCardLarge({
  ...
  // ÃÂ¢ÃÂÃ¢ÂÂ¦ TamaÃÂ±os balanceados para evitar desbordes
  const textSize = size === 'large' ? 'text-3xl md:text-4xl' : 'text-2xl md:text-3xl'
  const cardHeight = size === 'large' ? 'min-h-[200px]' : 'min-h-[170px]'
  const titleSize = 'text-sm md:text-base' // TÃÂ­tulo mÃÂ¡s legible
  const variationSize = 'text-sm md:text-base' // VariaciÃÂ³n mÃÂ¡s visible
  ...
  return (
    <motion.div
      ...
      `}
    >
      {/* Borde superior decorativo mÃÂ¡s prominente */}
      ...
      <div className="relative z-10 p-5 md:p-6 h-full flex flex-col">
        {/* Header con icono y tÃÂ­tulo mejorado */}
        ...
        <div className="flex-1 flex flex-col justify-center min-w-0 w-full overflow-hidden">
          ...
          {/* VariaciÃÂ³n mejorada con icono y mejor diseÃÂ±o */}
        ...
        {/* DecoraciÃÂ³n sutil en la esquina inferior */}
