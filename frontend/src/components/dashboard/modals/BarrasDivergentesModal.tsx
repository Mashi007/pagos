...
export function BarrasDivergentesModal({ isOpen, onClose }: BarrasDivergentesModalProps) {
  ...
  // Cargar datos de distribuciÃÂ³n
  ...
  // Preparar datos para grÃÂ¡fico divergente
  // Ordenar por monto total (ascendente para visualizaciÃÂ³n)
      ...
      return (
        <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-lg">
          ...
          <p className="text-sm mb-1">
            <span className="font-semibold">Cantidad:</span> {cantidad} prÃÂ©stamos
          </p>
          <p className="text-sm mb-1">
  ...
  const getTitulo = () => {
    switch (tipoDistribucion) {
      case 'rango_monto':
        return 'DistribuciÃÂ³n por Rango de Monto'
      case 'plazo':
        return 'DistribuciÃÂ³n por Plazo'
      case 'rango_monto_plazo':
        return 'DistribuciÃÂ³n por Rango de Monto y Plazo'
      case 'estado':
        return 'DistribuciÃÂ³n por Estado'
      default:
        return 'DistribuciÃÂ³n de PrÃÂ©stamos'
    }
  }
  ...
  return (
    <BaseModal
      isOpen={isOpen}
      onClose={onClose}
      title="DistribuciÃÂ³n de PrÃÂ©stamos"
      size="xlarge"
    >
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <label className="text-sm font-medium">Tipo de DistribuciÃÂ³n:</label>
        ...
        {/* GrÃÂ¡fico de Barras Divergentes */}
        <Card>
          <CardHeader>
          ...
          <CardContent>
                ...
                >
                  ...
                  >
                    {datosGrafico.map((entry, index) => {
                      // Colores alternados para mejor visualizaciÃÂ³n
            ...
            {distribucionData && (
              <div className="mt-6 grid grid-cols-2 gap-4 pt-6 border-t">
                <div>
                  <div className="text-sm text-gray-500">Total de PrÃÂ©stamos</div>
