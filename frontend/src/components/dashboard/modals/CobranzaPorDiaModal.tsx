...
export function CobranzaPorDiaModal({ isOpen, onClose }: CobranzaPorDiaModalProps) {
  ...
  // Formatear fechas para el grÃÂ¡fico
  ...
  return (
    <BaseModal
      isOpen={isOpen}
      onClose={onClose}
      title="Total a Cobrar, Pagos y Pago vencido por DÃÂ­a"
      size="xlarge"
    >
      <div className="space-y-6">
        ...
        {/* Layout: Tarjetas KPI Izquierda + GrÃÂ¡fico Centro + MÃÂ©tricas Derecha */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7">
            <Card>
              <CardHeader>
                <CardTitle>Total a Cobrar, Pagos y Pago vencido por DÃÂ­a</CardTitle>
              </CardHeader>
              <CardContent>
                {loadingPorDia ? (
          ...
          {/* MÃÂ©tricas Acumuladas - Derecha */}
          <div className="lg:col-span-3 space-y-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-sm text-gray-500">
                  Desde {metricasData?.fecha_inicio_anio ? new Date(metricasData.fecha_inicio_anio).toLocaleDateString('es-ES') : 'inicio del aÃÂ±o'}
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-sm text-gray-500">Clientes ÃÂºnicos</p>
              </CardContent>
            </Card>
