...
export function DonutConcesionariosModal({ isOpen, onClose }: DonutConcesionariosModalProps) {
  ...
  // Cargar datos de prÃÂ©stamos por concesionario
  ...
  // Preparar datos para el grÃÂ¡fico (agrupar segmentos pequeÃÂ±os en "Otros")
    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-lg">
          ...
          <p className="text-sm">
            <span className="font-semibold">Cantidad:</span> {typeof data.payload?.cantidad_prestamos === 'number' ? data.payload.cantidad_prestamos : 0} prÃÂ©stamos
          </p>
        </div>
      )
    }
  ...
  return (
    <BaseModal
      isOpen={isOpen}
      onClose={onClose}
      title="PrÃÂ©stamos por Concesionario"
      size="large"
    >
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>DistribuciÃÂ³n de PrÃÂ©stamos por Concesionario (Porcentaje)</CardTitle>
          </CardHeader>
          <CardContent>
            {loadingPrestamos ? (
              ...
              <div className="h-[500px] flex items-center justify-center text-gray-500">
                No hay datos de prÃÂ©stamos disponibles para el perÃÂ­odo seleccionado
              </div>
            ) : (
