...
export function TreemapMorosidadModal({ isOpen, onClose }: TreemapMorosidadModalProps) {
  ...
  // Preparar datos para Treemap (tamaÃÂ±o por monto vencido)
      ...
      return (
        <div className="bg-white p-4 border border-gray-200 rounded-lg shadow-lg">
          ...
          <p className="text-sm mb-1">
            <span className="font-semibold">DÃÂ³lares vencidos:</span>{' '}
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Pago vencido por Analista (cuotas vencidas y dÃÂ³lares vencidos)</CardTitle>
          </CardHeader>
          <CardContent>
            {loadingMorosidad ? (
              ...
              <div className="h-[500px] flex items-center justify-center text-gray-500">
                No hay datos de pago vencido disponibles para el perÃÂ­odo seleccionado
              </div>
            ) : (
