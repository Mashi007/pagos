...
export function TendenciasModal({ isOpen, onClose }: TendenciasModalProps) {
  ...
  const [granularidad, setGranularidad] =
    useState<GranularidadConfig>('mes_actual')
  ...
  const datosHistoricos =
    tendenciasData?.datos.filter(d => !d.es_proyeccion) || []
  ...
  const fechaDivision =
    datosHistoricos.length > 0
      ? datosHistoricos[datosHistoricos.length - 1].fecha
      : null
              ...
              <p key={index} className="text-sm" style={{ color: entry.color }}>
                ...
                {dataKey.includes('cuotas_en_dias')
                  ...
                  : typeof value === 'number'
                    ...
                    : 'N/A'}
                {isProyectado && (
                  <span className="ml-1 text-xs text-gray-500">(proy.)</span>
                )}
              </p>
            )
          })}
    ...
    >
      <div className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="proximos_n_dias">
                    Próximos N Días
                  </SelectItem>

                  <SelectItem value="hasta_fin_anio">
                    Hasta Fin de Año
                  </SelectItem>
            ...
            {tendenciasData?.ultima_actualizacion && (
              <div className="ml-auto flex items-center gap-2">
                ...
                <span className="text-xs text-gray-500">
                  ...
                  {new Date(tendenciasData.ultima_actualizacion).toLocaleString(
                    'es-ES'
                  )}
                </span>
              </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              Cuentas por Cobrar y Cuotas en Días (con Proyección)
            </CardTitle>
          </CardHeader>
          ...
          <CardContent>
            {loadingTendencias ? (
              ...
              <div className="space-y-6">
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    ...
                    >
                      ...
                      {fechaDivision && (
                        <ReferenceLine
                          x={
                            datosHistoricos[datosHistoricos.length - 1]
                              ?.fecha_formateada
                          }
                          stroke="#ef4444"
                          strokeDasharray="5 5"
                          label={{
                            value: 'Inicio Proyección',
                            position: 'top',
                            fill: '#ef4444',
                          }}
                        />
                ...
                <div>
                  <h3 className="mb-3 text-lg font-semibold">Cuotas en Días</h3>
