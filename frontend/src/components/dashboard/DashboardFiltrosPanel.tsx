...
export function DashboardFiltrosPanel({
  filtros,
  setFiltros,
  periodo = 'aÃÂ±o', // ÃÂ¢ÃÂÃ¢ÂÂ¦ Por defecto: "Este aÃÂ±o"
  setPeriodo,
  onRefresh,
  isRefreshing = false,
  opcionesFiltros,
  ...
  // ÃÂ¢ÃÂÃ¢ÂÂ¦ Estado temporal para filtros antes de aplicar
  ...
  // ÃÂ¢ÃÂÃ¢ÂÂ¦ Sincronizar filtros temporales cuando cambian los filtros reales (desde fuera) y se abre el popover
  useEffect(() => {
    if (showFiltros) {
  ...
  const handleLimpiarFiltros = () => {
    ...
    setShowFiltros(false) // Cerrar popover despuÃÂ©s de limpiar
  }

  const handleAplicarFiltros = () => {
    setFiltros(filtrosTemporales)
    setShowFiltros(false) // Cerrar popover despuÃÂ©s de aplicar
  }
  ...
  return (
    <div className="flex items-center space-x-3">
      ...
      <Popover
        ...
        onOpenChange={(open) => {
          setShowFiltros(open)
          // ÃÂ¢ÃÂÃ¢ÂÂ¦ Cuando se abre el popover, sincronizar filtros temporales con los actuales
          if (open) {
            setFiltrosTemporales(filtros)
          }
        }}
      >
        ...
        <PopoverContent className="w-96" align="end">
          <div className="space-y-4">
            ...
            {/* ÃÂ¢ÃÂÃ¢ÂÂ¦ BotÃÂ³n para Aplicar Filtros */}
