  ...
  const handleProbar = async () => {
    ...
    try {
      ...
      const mensajeErrorChat = {
        id: `error-${Date.now()}`,
        tipo: 'ai' as const,
        texto: `ÃÂ¢ÃÂ Error: ${mensajeError}`,
        timestamp: new Date(),
      }
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {mensajesChat.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-gray-400">
                ...
                <p className="text-sm">No hay mensajes aÃÂºn</p>
          ...
          <div className="border-t bg-white p-4">
            <div className="flex items-end gap-2">
              <div className="flex-1 relative">
                <Textarea
                  ...
                  placeholder="Escribe tu pregunta aquÃÂ­... (Presiona Enter para enviar)"
                  rows={3}
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <p className="text-xs text-gray-500">
                Enter para enviar Ã¢ÂÂ¢ Shift+Enter para nueva lÃÂ­nea
              </p>
            </div>
          </div>
        </div>
