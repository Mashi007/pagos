...
export function PromptConfigTab() {
  ...
  const handleGuardarPrompt = async () => {
    ...
    try {
      ...
      toast.success('Ã¢Åâ¦ Prompt personalizado guardado exitosamente')
      await cargarPrompt()
    } catch (error: any) {
  ...
  const handleRestaurarDefault = async () => {
    ...
    try {
      ...
      toast.success('Ã¢Åâ¦ Prompt restaurado al valor por defecto')
      await cargarPrompt()
    } catch (error: any) {
    ...
    <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            {tienePromptPersonalizado
              ? 'Ã¢Åâ¦ Usando prompt personalizado'
              : 'Ã¢âÂ¹Ã¯Â¸ Usando prompt por defecto'}
          </p>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1">
            ...
            <div className="bg-white rounded p-3 font-mono text-xs space-y-1 mb-3">
              ...
              <div><code className="text-blue-600">{'{info_cliente_buscado}'}</code> - InformaciÃ³n del cliente si se busca</div>
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder="Escribe tu prompt personalizado aquÃ­. AsegÃºrate de incluir los placeholders requeridos."
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-800">
          Ã°Å¸'Â¡ <strong>Tip:</strong> Puedes personalizar el comportamiento del AI ajustando el prompt.
