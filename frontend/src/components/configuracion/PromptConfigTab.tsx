    ...
    <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            {tienePromptPersonalizado
              ...
              : 'ÃÂ¢Ã¢ÂÂÃÂ¹ÃÂ¯ÃÂ¸ Usando prompt por defecto'}
          </p>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1">
            ...
            <div className="bg-white rounded p-3 font-mono text-xs space-y-1 mb-3">
              ...
              <div><code className="text-blue-600">{'{info_cliente_buscado}'}</code> - InformaciÃÂ³n del cliente si se busca</div>
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder="Escribe tu prompt personalizado aquÃÂ­. AsegÃÂºrate de incluir los placeholders requeridos."
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-800">
          ÃÂ°ÃÂ¸'ÃÂ¡ <strong>Tip:</strong> Puedes personalizar el comportamiento del AI ajustando el prompt.
