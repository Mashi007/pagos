...
export default function UsuariosConfig() {
  ...
  const handleDelete = async (usuario: User) => {
    if (
      !confirm(
        `¿Estás seguro de eliminar el usuario ${usuario.nombre} ${usuario.apellido} (${usuario.email})?`
      )
    ) {
      return
    }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Administra usuarios: Administrador (acceso total). Operativo: no
            puede realizar cambios en configuración ni auditoría.
          </p>
        </div>
      ...
      <Card className="p-4">
        <div className="flex flex-col gap-4 sm:flex-row">
          ...
          <Button variant="outline" onClick={loadUsuarios} size="sm">
            ...
            <div className="p-6">
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center">
                    <span
                      className={`mr-3 text-sm ${!formData.is_active ? 'text-gray-900' : 'text-gray-500'}`}
                    >
                      OFF
                    </span>
                    ...
                    <span
                      className={`ml-3 text-sm ${formData.is_active ? 'text-gray-900' : 'text-gray-500'}`}
                    >
                      ON
                    </span>
                  </div>
                ...
                <div className="flex justify-end gap-3 pt-4">
                  ...
                  <Button
                    ...
                    className="bg-blue-600 text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-gray-400"
                  >
