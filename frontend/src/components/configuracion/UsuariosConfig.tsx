...
export default function UsuariosConfig() {
  ...
  const validateEmailWithSystem = async (email: string) => {
    try {
      ...
      // Endpoint no disponible o error de red: usar validaciÃ³n local
    }
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Administra usuarios: Administrador (acceso total). Operativo: no puede realizar cambios en configuraciÃ³n ni auditorÃ­a.
          </p>
        </div>
        <Button
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4" autoComplete="off">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Administrador: acceso total. Operativo: no puede realizar cambios en mÃ³dulos de configuraciÃ³n ni auditorÃ­a.
                  </p>
                </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Ãltimo acceso</p>
                    <p className="text-sm text-gray-900 mt-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-green-700 mt-1">
                        {(viewingUser.rol || 'operativo') === 'administrador'
                          ? 'Acceso total: usuarios, configuraciÃ³n y todas las funcionalidades.'
                          : 'No puede realizar cambios en mÃ³dulos de configuraciÃ³n ni auditorÃ­a.'}
                      </p>
                    </div>
                  </div>
                </div>
