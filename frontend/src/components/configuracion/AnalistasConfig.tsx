  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingAnalista) {
        ...
        toast.success('Ã¢Åâ¦ Analista actualizado exitosamente')
      } else {
        await createAnalistaMutation.mutateAsync(formData)
        toast.success('Ã¢Åâ¦ Analista creado exitosamente')
      }
      ...
      toast.error('Ã¢ÂÅ Error al guardar analista')
    }
  }
  ...
  const handleDelete = async (id: number) => {
    try {
      const confirmar = window.confirm(
        'Ã¢Å¡ Ã¯Â¸Â Â¿EstÃ¡s seguro de que quieres ELIMINAR este analista?\n\n' +
      ...
      toast.success('Ã¢Åâ¦ Analista eliminado exitosamente')
      // Refrescar la lista automÃ¡ticamente
      refetch()
    } catch (err) {
      console.error('Error al eliminar analista:', err)
      toast.error('Ã¢ÂÅ Error al eliminar analista')
    }
  }
