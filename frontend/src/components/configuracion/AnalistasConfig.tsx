...
export function AnalistasConfig() {
  ...
  // FunciÃÂ³n para obtener fecha de hoy
  const getTodayDate = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingAnalista) {
        ...
        toast.success('ÃÂ¢ÃÂÃ¢ÂÂ¦ Analista actualizado exitosamente')
      } else {
        await createAnalistaMutation.mutateAsync(formData)
        toast.success('ÃÂ¢ÃÂÃ¢ÂÂ¦ Analista creado exitosamente')
      }

      resetForm()
      // Refrescar la lista automÃÂ¡ticamente
      refetch()
    } catch (err) {
      console.error('Error al guardar analista:', err)
      toast.error('ÃÂ¢ÃÂÃÂ Error al guardar analista')
    }
  }
  ...
  const handleDelete = async (id: number) => {
    try {
      const confirmar = window.confirm(
        'ÃÂ¢ÃÂ¡ ÃÂ¯ÃÂ¸ÃÂ ÃÂ¿EstÃÂ¡s seguro de que quieres ELIMINAR este analista?\n\n' +
      ...
      toast.success('ÃÂ¢ÃÂÃ¢ÂÂ¦ Analista eliminado exitosamente')
      // Refrescar la lista automÃÂ¡ticamente
      refetch()
    } catch (err) {
      console.error('Error al eliminar analista:', err)
      toast.error('ÃÂ¢ÃÂÃÂ Error al eliminar analista')
    }
  }
  ...
  // Filtrar analistas por tÃÂ©rmino de bÃÂºsqueda
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">ConfiguraciÃÂ³n de Analistas</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  La fecha se establece automÃÂ¡ticamente al dÃÂ­a de hoy
                </p>
              </div>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="hidden"
              id="excel-file-analistas-config"
            />
            <label
              htmlFor="excel-file-analistas-config"
