      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          ...
          <Input
            ...
            onChange={e =>
              handleChange('tasaInteres', parseFloat(e.target.value) || 0)
            }
            placeholder="12.5"
          />
        </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={e =>
              handleChange('tasaMora', parseFloat(e.target.value) || 0)
            }
            placeholder="24.0"
          />
        </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={e =>
              handleChange('diasGracia', parseInt(e.target.value) || 0)
            }
            placeholder="5"
          />
        </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={e =>
              handleChange('montoMinimo', parseInt(e.target.value) || 0)
            }
            placeholder="5000"
          />
        </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={e =>
              handleChange('montoMaximo', parseInt(e.target.value) || 0)
            }
            placeholder="50000"
          />
        </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={e =>
              handleChange('plazoMinimo', parseInt(e.target.value) || 0)
            }
            placeholder="12"
          />
        </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={e =>
              handleChange('plazoMaximo', parseInt(e.target.value) || 0)
            }
            placeholder="60"
          />
        </div>
        ...
        <div>
          ...
          <Input
            type="number"
            value={config.cuotaInicialMinima}
            onChange={e =>
              handleChange('cuotaInicialMinima', parseInt(e.target.value) || 0)
            }
            placeholder="10"
          />
        </div>
