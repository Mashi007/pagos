...
export function ConfigGeneralTab() {
  ...
  const cargarConfiguracionGeneral = async (preserveLogoStateIfMissing = false) => {
    try {
      ...
      console.error('Error cargando configuraciÃ³n general:', err)
  ...
  const handleGuardar = async () => {
    try {
      ...
      toast.error(`Error al guardar configuraciÃ³n: ${getErrorMessage(err)}`)
    } finally {
      setLoading(false)
    }
  }
                ...
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  {uploadingLogo ? (
                    ...
                    <>
                      ...
                      <p className="mb-2 text-sm text-gray-600"><span className="font-semibold">Haga clic para seleccionar</span> o arrastre el archivo aquÃ­</p>
