...
export function EntrenamientoMejorado() {
  ...
  const cargarEstadoRecoleccionAutomatica = async () => {
    try {
      ...
      console.debug(`Estado de recolecciÃÂ³n automÃÂ¡tica cargado: ${activa}`)
    } catch (error: any) {
      console.error('Error cargando estado de recolecciÃÂ³n automÃÂ¡tica:', error)
      // Si no existe la configuraciÃÂ³n, asumir que estÃÂ¡ desactivada
  ...
  const handleActivarRecoleccionAutomatica = async () => {
    ...
    try {
      ...
      if (nuevoEstado) {
        toast.success('ÃÂ¢ÃÂÃ¢ÂÂ¦ RecolecciÃÂ³n automÃÂ¡tica activada. Las conversaciones se guardarÃÂ¡n automÃÂ¡ticamente.', {
          duration: 5000,
        })
      } else {
        toast.info('RecolecciÃÂ³n automÃÂ¡tica desactivada', {
          duration: 3000,
        })
      }
    } catch (error: any) {
      console.error('Error activando recolecciÃÂ³n automÃÂ¡tica:', error)
      const errorMsg = error?.response?.data?.detail || 'Error al cambiar el estado de recolecciÃÂ³n automÃÂ¡tica'
      toast.error(errorMsg, {
        duration: 5000,
      })
      // Recargar estado en caso de error para mantener sincronizaciÃÂ³n
      await cargarEstadoRecoleccionAutomatica()
    } finally {
  ...
  const cargarMetricas = async () => {
    ...
    try {
      ...
      console.error('Error cargando mÃÂ©tricas:', error)
      if (error?.response?.status === 404) {
        setMetricas(metricasPorDefecto)
      } else {
        toast.error('Error al cargar mÃÂ©tricas de entrenamiento')
      }
    } finally {
  ...
  const handleRecoleccionAutomatica = async () => {
    ...
    try {
      ...
      toast.success(`ÃÂ¢ÃÂÃ¢ÂÂ¦ RecolecciÃÂ³n completada: ${resultado.total_recolectadas} conversaciones nuevas`)
      cargarMetricas()
    } catch (error: any) {
      const mensaje = error?.response?.data?.detail || error?.message || 'Error en recolecciÃÂ³n automÃÂ¡tica'
      toast.error(mensaje)
    } finally {
  ...
  const handleAnalizarCalidad = async () => {
    ...
    try {
      ...
      toast.success('AnÃÂ¡lisis de calidad completado')
    } catch (error: any) {
  ...
  const obtenerRecomendaciones = (): Recomendacion[] => {
    ...
    // RecomendaciÃÂ³n 1: RecolecciÃÂ³n automÃÂ¡tica
    if ((conv.total ? 0) < 20) {
      recomendaciones.push({
        tipo: 'recoleccion',
        titulo: recoleccionAutomaticaActiva 
          ? 'RecolecciÃÂ³n AutomÃÂ¡tica Activada' 
          : 'Activar RecolecciÃÂ³n AutomÃÂ¡tica',
        descripcion: recoleccionAutomaticaActiva
          ? 'La recolecciÃÂ³n automÃÂ¡tica estÃÂ¡ activa. Las conversaciones del Chat AI se guardan automÃÂ¡ticamente para construir tu dataset de entrenamiento.'
          : 'Habilita la recolecciÃÂ³n automÃÂ¡tica de conversaciones del Chat AI para construir tu dataset de entrenamiento.',
    ...
    // RecomendaciÃÂ³n 2: Calidad de datos
    if ((conv.con_calificacion ? 0) > 0 && (conv.promedio_calificacion ? 0) < 3.5) {
      recomendaciones.push({
        tipo: 'calidad',
        titulo: 'Mejorar Calidad de Conversaciones',
        descripcion: `El promedio de calificaciones es ${(conv.promedio_calificacion ? 0).toFixed(1)}/5. Revisa y mejora las conversaciones con baja calificaciÃÂ³n.`,
        accion: 'Revisar',
    ...
    // RecomendaciÃÂ³n 3: Entrenamiento listo
    if ((conv.listas_entrenamiento ? 0) >= 10) {
      recomendaciones.push({
        tipo: 'entrenar',
        titulo: 'ÃÂ¡Listo para Entrenar!',
    ...
    // RecomendaciÃÂ³n 4: MÃÂ¡s datos
    if ((conv.listas_entrenamiento ? 0) < 10) {
      recomendaciones.push({
        tipo: 'mas_datos',
        titulo: 'Necesitas MÃÂ¡s Conversaciones',
  ...
  return (
    <div className="space-y-6">
      {/* Header con tÃÂ­tulo y descripciÃÂ³n */}
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Gestiona la recolecciÃÂ³n de datos, calidad y entrenamiento de tu modelo de Chat AI
        </p>
      </div>

      {/* MÃÂ©tricas rÃÂ¡pidas - Mejorado */}
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-sm font-semibold text-green-700 uppercase tracking-wide">CalificaciÃÂ³n</p>
                </div>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  >
                    {metricas?.fine_tuning?.modelo_activo ? 'Ã¢ÂÂ Activo' : 'Sin activar'}
                  </Badge>
                </div>
              </div>
            </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-2 lg:grid-cols-4 bg-white border border-gray-200 p-1.5 rounded-xl shadow-sm">
          ...
          >
            ...
            <span className="font-medium">RecolecciÃÂ³n</span>
          </TabsTrigger>
          <TabsTrigger
            value="calidad"
          ...
          <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-700">
                      Te guiarÃÂ© paso a paso para mejorar el entrenamiento de tu Chat AI. 
            ...
            <div>
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                                ...
                                <Button
                                  ...
                                  onClick={() => {
                                    if (rec.tipo === 'recoleccion') {
                                      ...
                                      toast.info('Consulta la pestaÃÂ±a de RecolecciÃÂ³n para mÃÂ¡s informaciÃÂ³n')
                                    }
                                  }}
                                >
                ...
                {/* GuÃÂ­a rÃÂ¡pida - Mejorado */}
                <Card className="border-gray-200 shadow-sm">
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                        <Info className="h-5 w-5 text-blue-600" />
                        GuÃÂ­a RÃÂ¡pida de Entrenamiento
                      </h3>
                      ...
                      <div className="relative p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 hover:shadow-md transition-shadow">
                        ...
                        <div className="mt-4">
                          ...
                          <p className="text-sm text-gray-700 leading-relaxed">
                            Activa la recolecciÃÂ³n automÃÂ¡tica o crea conversaciones manualmente. 
                            MÃÂ­nimo 10 conversaciones, ideal 50+.
                          </p>
                        </div>
                      </div>
        ...
        <TabsContent value="recoleccion" className="mt-6">
          <div className="space-y-6">
            ...
            <Card className="border-green-200 bg-gradient-to-r from-green-50 to-emerald-50">
              <CardContent className="pt-6 pb-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">RecolecciÃÂ³n de Conversaciones</h2>
                    <p className="text-gray-700">
                      Gestiona la recolecciÃÂ³n automÃÂ¡tica y manual de conversaciones del Chat AI para entrenamiento
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            {/* Estado de activaciÃÂ³n - Mejorado */}
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 mb-1">
                        {recoleccionAutomaticaActiva ? 'RecolecciÃÂ³n AutomÃÂ¡tica Activada' : 'RecolecciÃÂ³n AutomÃÂ¡tica Desactivada'}
                      </h3>
                      <p className="text-gray-700">
                        {recoleccionAutomaticaActiva 
                          ? 'Las conversaciones del Chat AI se guardan automÃÂ¡ticamente en tiempo real'
                          : 'Activa la recolecciÃÂ³n para guardar conversaciones automÃÂ¡ticamente'}
                      </p>
                    </div>
                  </div>
                  <Button
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card className="border-blue-200 bg-blue-50">
                <CardContent className="pt-6">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-blue-900 mb-2 text-lg">ÃÂ¿CÃÂ³mo funciona?</h4>
                      <ul className="text-sm text-blue-800 space-y-2">
                        <li className="flex items-start gap-2">
                          <CheckCircle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                          <span>Se guardan automÃÂ¡ticamente todas las conversaciones del Chat AI</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                          <span>Incluye pregunta, respuesta, contexto usado y mÃÂ©tricas</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                          <span>Puedes calificarlas despuÃÂ©s para filtrar las mejores</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle className="h-4 w-4 mt-0.5 flex-shrink-0" />
              ...
              <Card className="border-gray-200">
                <CardContent className="pt-6">
                  <h4 className="font-bold text-gray-900 mb-4 text-lg">Acciones RÃÂ¡pidas</h4>
                  <div className="space-y-3">
                    <Button
            ...
            {/* EstadÃÂ­sticas de recolecciÃÂ³n - Mejorado */}
            {metricas?.conversaciones && (
              <Card className="border-gray-200 shadow-sm">
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between mb-6">
                    <h4 className="text-xl font-bold text-gray-900">EstadÃÂ­sticas de RecolecciÃÂ³n</h4>
                    <Badge variant="outline" className="bg-gray-50">
                      Actualizado
                    </Badge>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="p-4 bg-purple-50 rounded-xl border border-purple-200">
                      ...
                      <p className="text-xs text-purple-600 mt-1">con calificaciÃÂ³n</p>
                    </div>
        ...
        <TabsContent value="calidad" className="mt-6">
          <div className="space-y-6">
            ...
            <Card className="border-purple-200 bg-gradient-to-r from-purple-50 to-pink-50">
              <CardContent className="pt-6 pb-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">AnÃÂ¡lisis de Calidad de Datos</h2>
                    <p className="text-gray-700">
                      Analiza la calidad de tus conversaciones para identificar ÃÂ¡reas de mejora y optimizar el entrenamiento.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            {/* BotÃÂ³n de anÃÂ¡lisis */}
            <Card className="border-purple-200">
              <CardContent className="pt-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div>
                    <h3 className="text-lg font-bold text-gray-900 mb-2">Iniciar AnÃÂ¡lisis</h3>
                    <p className="text-gray-600">
                      Ejecuta un anÃÂ¡lisis completo de la calidad de tus conversaciones recolectadas
                    </p>
                  </div>
                  <Button
                ...
                <Card className="border-green-200 bg-gradient-to-br from-green-50 to-emerald-50 shadow-md">
                  <CardContent className="pt-6">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <h4 className="text-xl font-bold text-gray-900">MÃÂ©tricas de Calidad</h4>
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-700">
                      ...
                      El prompt personalizado reemplazarÃÂ¡ al prompt por defecto.
                    </p>
                  </div>
                </div>
              </CardContent>
