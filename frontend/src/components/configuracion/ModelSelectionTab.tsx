...
export function ModelSelectionTab({
  ...
  return (
    <div className="space-y-4">
      {/* Estado: ConfiguraciÃ³n correcta */}
        ...
        <div className="bg-white border-2 border-green-500 rounded-xl p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-semibold text-gray-900">ConfiguraciÃ³n correcta</p>
      ...
      {config.configured && !configuracionCorrecta && !verificandoConfig && (
        <div className="bg-white border-2 border-amber-400 rounded-xl p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-semibold text-gray-900 mb-2">API Key no vÃ¡lida o no configurada</p>
              <div className="text-sm text-gray-600 space-y-1">
                <p>1. Ingresa tu API Key de OpenRouter en el campo de abajo (o obtÃ©n una en <a href="https://openrouter.ai/keys" target="_blank" rel="noopener noreferrer" className="underline text-blue-600">openrouter.ai/keys</a>)</p>
      ...
      {!config.configured && (
        <div className="bg-white border-2 border-red-500 rounded-xl p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-semibold text-gray-900">ConfiguraciÃ³n incompleta</p>
              <p className="text-sm text-gray-600">
        ...
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-600">
              {config.activo === 'true'
                ? 'Ã¢Åâ¦ El sistema estÃ¡ usando AI para generar respuestas automÃ¡ticas'
                : 'Ã¢Å¡ Ã¯Â¸ El sistema NO usarÃ¡ AI. Activa el servicio para habilitar respuestas inteligentes.'}
            </p>
          </div>
        ...
        <CardContent className="pt-6 space-y-4">
          <div>
            ...
            <Input
              ...
              placeholder={config.openai_api_key === '***' ? 'â¢â¢â¢â¢â¢â¢â¢â¢ (ya configurada â deja en blanco para no cambiar)' : 'Pega tu API key de OpenRouter'}
              className="font-mono text-sm"
            />
            <p className="text-xs text-gray-500 mt-1">
              ObtÃ©n tu clave en <a href="https://openrouter.ai/keys" target="_blank" rel="noopener noreferrer" className="underline text-blue-600">openrouter.ai/keys</a>
            </p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              {config.modelo_recomendado && (
                <p className="text-xs text-gray-500 mt-1">Recomendado: GPT-4o Mini â buen balance costo y velocidad</p>
              )}
            </div>
              ...
              {guardando ? (
                ...
                <>
                  ...
                  {configuracionCorrecta && config.configured
                    ? 'Ã¢Åâ¦ Guardar ConfiguraciÃ³n (Token VÃ¡lido)'
