...
export function ModelSelectionTab({
  ...
  useEffect(() => {
    ...
    const loadConfig = async () => {
      try {
        ...
        console.error('Error cargando configuraciÃÂ³n de AI:', error)
      }
    }
  ...
  return (
    <div className="space-y-4">
      {/* Estado: ConfiguraciÃÂ³n correcta */}
        ...
        <div className="bg-white border-2 border-green-500 rounded-xl p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-semibold text-gray-900">ConfiguraciÃÂ³n correcta</p>
              <p className="text-sm text-gray-600">
                OpenAI aceptÃÂ³ la conexiÃÂ³n. Puedes usar AI para generar respuestas.
              </p>
            </div>
          </div>
        </div>
      ...
      {config.configured && !configuracionCorrecta && !verificandoConfig && (
        <div className="bg-white border-2 border-amber-400 rounded-xl p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-semibold text-gray-900 mb-2">API Key no vÃÂ¡lida o no configurada</p>
              <div className="text-sm text-gray-600 space-y-1">
                <p>1. Ingresa tu API Key de OpenRouter en el campo de abajo (o obtÃÂ©n una en <a href="https://openrouter.ai/keys" target="_blank" rel="noopener noreferrer" className="underline text-blue-600">openrouter.ai/keys</a>)</p>
      ...
      {!config.configured && (
        <div className="bg-white border-2 border-red-500 rounded-xl p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-semibold text-gray-900">ConfiguraciÃÂ³n incompleta</p>
              <p className="text-sm text-gray-600">
        ...
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-600">
              {config.activo === 'true'
                ? 'ÃÂ¢ÃÂÃ¢ÂÂ¦ El sistema estÃÂ¡ usando AI para generar respuestas automÃÂ¡ticas'
                : 'ÃÂ¢ÃÂ¡ ÃÂ¯ÃÂ¸ El sistema NO usarÃÂ¡ AI. Activa el servicio para habilitar respuestas inteligentes.'}
            </p>
          </div>
        ...
        <CardContent className="pt-6 space-y-4">
          <div>
            ...
            <Input
              ...
              placeholder={config.openai_api_key === '***' ? 'Ã¢ÂÂ¢Ã¢ÂÂ¢Ã¢ÂÂ¢Ã¢ÂÂ¢Ã¢ÂÂ¢Ã¢ÂÂ¢Ã¢ÂÂ¢Ã¢ÂÂ¢ (ya configurada Ã¢ÂÂ deja en blanco para no cambiar)' : 'Pega tu API key de OpenRouter'}
              className="font-mono text-sm"
            />
            <p className="text-xs text-gray-500 mt-1">
              ObtÃÂ©n tu clave en <a href="https://openrouter.ai/keys" target="_blank" rel="noopener noreferrer" className="underline text-blue-600">openrouter.ai/keys</a>
            </p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              {config.modelo_recomendado && (
                <p className="text-xs text-gray-500 mt-1">Recomendado: GPT-4o Mini Ã¢ÂÂ buen balance costo y velocidad</p>
              )}
            </div>
            ...
            <div>
              ...
              <Input
                ...
                placeholder="1000"
              />
              <p className="text-xs text-gray-500 mt-1">MÃÂ¡ximo de tokens en la respuesta.</p>
            </div>
          </div>
              ...
              {guardando ? (
                ...
                <>
                  ...
                  {configuracionCorrecta && config.configured
                    ? 'ÃÂ¢ÃÂÃ¢ÂÂ¦ Guardar ConfiguraciÃÂ³n (Token VÃÂ¡lido)'
