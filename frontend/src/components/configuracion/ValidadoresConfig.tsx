    ...
    return (
      <Card key={tipo} className="mb-6">
        ...
        <CardContent className="space-y-4">
          ...
          {tipo === 'telefono' && config.paises_soportados?.venezuela && (
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="font-medium text-green-700 mb-2">Ã¢Åâ¦ Ejemplos VÃ¡lidos</h5>
                ...
                <div>
                  <h5 className="font-medium text-red-700 mb-2">Ã¢ÂÅ Ejemplos InvÃ¡lidos</h5>
                  <ul className="text-sm space-y-1">
          ...
          {tipo === 'fecha' && (
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-blue-900 mb-2">Ã°Å¸ââ¦ Formato DD/MM/YYYY</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <strong>Requisitos:</strong>
                  <ul className="mt-1 space-y-1">
          ...
          {tipo === 'email' && (
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-blue-900 mb-2">Ã°Å¸âÂ§ ValidaciÃ³n RFC 5322</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <strong>CaracterÃ­sticas:</strong>
                  <ul className="mt-1 space-y-1">
