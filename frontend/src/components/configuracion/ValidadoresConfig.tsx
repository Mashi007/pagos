  ...
  const cargarConfiguracion = async () => {
    try {
      ...
      if (err.response?.status === 503) {
        ...
        setError('Error de conexiÃÂ³n. Verifica que el servidor estÃÂ© funcionando.')
      } else {
        setError('Error al cargar la configuraciÃÂ³n de validadores')
      }
    } finally {
      setCargando(false)
    }
  ...
  if (cargando) {
    return (
      <div className="flex items-center justify-center p-8">
        ...
        <span className="ml-2 text-gray-600">Cargando configuraciÃÂ³n...</span>
      </div>
    )
  }
    ...
    return (
      <Card key={tipo} className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            {tipo === 'telefono' && 'ValidaciÃÂ³n y formateo de nÃÂºmeros telefÃÂ³nicos'}
            {tipo === 'cedula' && 'ValidaciÃÂ³n de cÃÂ©dulas por paÃÂ­s'}
            {tipo === 'fecha' && 'ValidaciÃÂ³n estricta de fechas'}
            {tipo === 'email' && 'ValidaciÃÂ³n y normalizaciÃÂ³n de emails'}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {/* ConfiguraciÃÂ³n especÃÂ­fica por tipo */}
          {tipo === 'telefono' && config.paises_soportados?.venezuela && (
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <ul className="mt-1 space-y-1">
                    <li>Ã¢ÂÂ¢ {config.paises_soportados.venezuela.requisitos.debe_empezar_por}</li>
                    <li>Ã¢ÂÂ¢ {config.paises_soportados.venezuela.requisitos.longitud_total}</li>
                    <li>Ã¢ÂÂ¢ {config.paises_soportados.venezuela.requisitos.primer_digito}</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="font-medium text-green-700 mb-2">ÃÂ¢ÃÂÃ¢ÂÂ¦ Ejemplos VÃÂ¡lidos</h5>
                ...
                <div>
                  <h5 className="font-medium text-red-700 mb-2">ÃÂ¢ÃÂÃÂ Ejemplos InvÃÂ¡lidos</h5>
                  <ul className="text-sm space-y-1">
          ...
          {tipo === 'cedula' && config.paises_soportados?.venezuela && (
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <strong>Prefijos vÃÂ¡lidos:</strong> {config.paises_soportados.venezuela.prefijos_validos.join(', ')}
                </div>
                <div>
              ...
              <div className="mt-4">
                ...
                <ul className="mt-1 space-y-1 text-sm">
                  <li>Ã¢ÂÂ¢ {config.paises_soportados.venezuela.requisitos.prefijos}</li>
                  <li>Ã¢ÂÂ¢ {config.paises_soportados.venezuela.requisitos.dÃÂ­gitos}</li>
                  <li>Ã¢ÂÂ¢ {config.paises_soportados.venezuela.requisitos.longitud}</li>
                </ul>
              </div>
            </div>
          )}
          ...
          {tipo === 'fecha' && (
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-blue-900 mb-2">ÃÂ°ÃÂ¸Ã¢ÂÂÃ¢ÂÂ¦ Formato DD/MM/YYYY</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <strong>Requisitos:</strong>
                  <ul className="mt-1 space-y-1">
                    <li>Ã¢ÂÂ¢ {config.requisitos.dia}</li>
                    <li>Ã¢ÂÂ¢ {config.requisitos.mes}</li>
                    <li>Ã¢ÂÂ¢ {config.requisitos.aÃÂ±o}</li>
                    <li>Ã¢ÂÂ¢ {config.requisitos.separador}</li>
                  </ul>
                </div>
                <div>
                  <strong>CaracterÃÂ­sticas:</strong>
                  <ul className="mt-1 space-y-1">
                    <li>Ã¢ÂÂ¢ ValidaciÃÂ³n estricta</li>
                    <li>Ã¢ÂÂ¢ VerificaciÃÂ³n de fechas vÃÂ¡lidas</li>
                    <li>Ã¢ÂÂ¢ Soporte para aÃÂ±os bisiestos</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          {tipo === 'email' && (
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-blue-900 mb-2">ÃÂ°ÃÂ¸Ã¢ÂÂÃÂ§ ValidaciÃÂ³n RFC 5322</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <strong>CaracterÃÂ­sticas:</strong>
                  <ul className="mt-1 space-y-1">
                    <li>Ã¢ÂÂ¢ {config.caracteristicas.normalizacion}</li>
                    <li>Ã¢ÂÂ¢ {config.caracteristicas.limpieza}</li>
                    <li>Ã¢ÂÂ¢ {config.caracteristicas.validacion}</li>
                  </ul>
                </div>
                <div>
                  ...
                  <div className="mt-1 flex flex-wrap gap-1">
                    ...
                    {config.caracteristicas.dominios_bloqueados.length > 3 && (
                      <Badge variant="outline" className="text-xs">
                        +{config.caracteristicas.dominios_bloqueados.length - 3} mÃÂ¡s
                      </Badge>
                    )}
                  </div>
                </div>
          ...
          {/* ConfiguraciÃÂ³n de comportamiento */}
          <div className="flex items-center space-x-4 text-sm">
            ...
            <Badge variant={config.validacion_tiempo_real ? "default" : "secondary"}>
              {config.validacion_tiempo_real ? "ValidaciÃÂ³n en tiempo real" : "ValidaciÃÂ³n manual"}
            </Badge>
          </div>
        </CardContent>
      </Card>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">ConfiguraciÃÂ³n de Validadores</h2>
          <p className="text-gray-600">ConfiguraciÃÂ³n y pruebas de los validadores del sistema</p>
        </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="text-sm font-medium">PaÃÂ­s (TelÃÂ©fono)</label>
              <Select
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="DOMINICANA">RepÃÂºblica Dominicana</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div>
            ...
            <div>
              <label className="text-sm font-medium">PaÃÂ­s (CÃÂ©dula)</label>
              <Select
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">VÃÂ¡lidos</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-red-600">{resultadosPrueba.resumen.invalidos}</div>
                    <div className="text-sm text-gray-600">InvÃÂ¡lidos</div>
                  </div>
                </div>
                    ...
                    <div key={tipo} className="border rounded-lg p-3">
                      ...
                      <div className="text-sm space-y-1">
                        ...
                        {resultado.cambio_realizado && (
                          <div className="text-blue-600"><strong>Cambio aplicado:</strong> SÃÂ­</div>
                        )}
                      </div>
                    </div>
                  ))}
