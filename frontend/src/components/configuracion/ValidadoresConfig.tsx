...
import {
  ...
  type ValidadoresConfig,
  type PruebaValidadores,
} from '../../services/configuracionService'

export function ValidadoresConfig() {
  const [configuracion, setConfiguracion] = useState<ValidadoresConfig | null>(
    null
  )
  ...
  const ejecutarPruebas = async () => {
    try {
      ...
      const resultados =
        await configuracionService.probarValidadores(datosPrueba)
        ...
        <CardContent className="space-y-4">
          ...
          {tipo === 'telefono' && config.paises_soportados?.venezuela && (
            <div className="rounded-lg bg-blue-50 p-4">
              <h4 className="mb-2 font-semibold text-blue-900">Venezuela</h4>

              <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
                <div>
                  <strong>Formato:</strong>{' '}
                  {config.paises_soportados.venezuela.formato}
                </div>
                ...
                <div>
                  ...
                  <ul className="mt-1 space-y-1">
                    <li>
                      •{' '}
                      {
                        config.paises_soportados.venezuela.requisitos
                          .debe_empezar_por
                      }
                    </li>
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                  ...
                  <ul className="space-y-1 text-sm">
                    {config.paises_soportados.venezuela.ejemplos_validos.map(
                      (ejemplo: string, idx: number) => (
                        <li
                          key={idx}
                          className="rounded bg-green-100 px-2 py-1 font-mono"
                        >
                          {ejemplo}
                        </li>
                      )
                ...
                <div>
                  <h5 className="mb-2 font-medium text-red-700">
                    âŒ Ejemplos Inválidos
                  </h5>

                  <ul className="space-y-1 text-sm">
                    {config.paises_soportados.venezuela.ejemplos_invalidos.map(
                      (ejemplo: string, idx: number) => (
                        <li
                          key={idx}
                          className="rounded bg-red-100 px-2 py-1 font-mono"
                        >
                          {ejemplo}
                        </li>
                      )
          ...
          {tipo === 'cedula' && config.paises_soportados?.venezuela && (
            <div className="rounded-lg bg-blue-50 p-4">
              ...
              <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
                <div>
                  <strong>Prefijos válidos:</strong>{' '}
                  {config.paises_soportados.venezuela.prefijos_validos.join(
                    ', '
                  )}
                </div>
                ...
                <div>
                  ...
                  {config.paises_soportados.venezuela.longitud}
                </div>
              </div>
              ...
              <div className="mt-4">
                ...
                <ul className="mt-1 space-y-1 text-sm">
                  <li>
                    • {config.paises_soportados.venezuela.requisitos.prefijos}
                  </li>

                  <li>
                    • {config.paises_soportados.venezuela.requisitos.dígitos}
                  </li>

                  <li>
                    • {config.paises_soportados.venezuela.requisitos.longitud}
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="mt-1 flex flex-wrap gap-1">
                    {config.caracteristicas.dominios_bloqueados
                      .slice(0, 3)
                      .map((dominio: string, idx: number) => (
                        <Badge
                          key={idx}
                          variant="destructive"
                          className="text-xs"
          ...
          <div className="flex items-center space-x-4 text-sm">
            ...
            <Badge
              variant={config.validacion_tiempo_real ? 'default' : 'secondary'}
            >
              {config.validacion_tiempo_real
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Configuración y pruebas de los validadores del sistema
          </p>
        </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-3">
            ...
            <div>
              ...
              {new Date(configuracion.fecha_consulta).toLocaleString()}
            </div>

            <div>
              <strong>Validadores disponibles:</strong>{' '}
              {Object.keys(configuracion.validadores_disponibles).length}
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <div>
        <h3 className="mb-4 text-lg font-semibold">Validadores Disponibles</h3>

        <div className="space-y-4">
          {Object.entries(configuracion.validadores_disponibles).map(
            ([tipo, config]) => renderValidador(tipo, config)
          )}
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setPruebas(prev => ({ ...prev, telefono: e.target.value }))
                }
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  setPruebas(prev => ({ ...prev, pais_telefono: value }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setPruebas(prev => ({ ...prev, cedula: e.target.value }))
                }
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  setPruebas(prev => ({ ...prev, pais_cedula: value }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div>
              ...
              <Input
                value={pruebas.fecha}
                onChange={e =>
                  setPruebas(prev => ({ ...prev, fecha: e.target.value }))
                }
            ...
            <div>
              ...
              <Input
                value={pruebas.email}
                onChange={e =>
                  setPruebas(prev => ({ ...prev, email: e.target.value }))
                }
          ...
          {resultadosPrueba && (
            <div className="mt-6">
              <h4 className="mb-3 font-semibold">Resultados de las Pruebas</h4>

              <div className="rounded-lg bg-gray-50 p-4">
                <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-3">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600">
                      {resultadosPrueba.resumen.total_validados}
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600">
                      {resultadosPrueba.resumen.validos}
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-red-600">
                      {resultadosPrueba.resumen.invalidos}
                    </div>
                ...
                <div className="space-y-3">
                  {Object.entries(resultadosPrueba.resultados).map(
                    ([tipo, resultado]: [string, any]) => (
                        ...
                        <div className="space-y-1 text-sm">
                          ...
                          {resultado.cambio_realizado && (
                            <div className="text-blue-600">
                              <strong>Cambio aplicado:</strong> Sí
                            </div>
                          )}
                        </div>
                      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
            {Object.entries(configuracion.reglas_negocio).map(
              ([regla, descripcion]) => (
