...
export function ConversationManagement({
  ...
  const handleCalificar = async (conversacionId: number) => {
    if (calificacion === 0) {
      toast.error('Por favor selecciona una calificaciÃÂ³n')
      return
    }
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Comentarios sobre la conversaciÃÂ³n..."
                        rows={2}
                        className="text-sm"
                      />
                    </div>
                      ...
                      <div className="flex gap-2 items-center flex-wrap">
                        {conversacion.calificacion && (
                          <Badge variant="secondary" className="text-xs">
                            Ã¢ÂÂ {conversacion.calificacion}/5
                          </Badge>
                        )}
