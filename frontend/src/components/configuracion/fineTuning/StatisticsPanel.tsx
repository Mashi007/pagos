    ...
    <Card className="bg-gradient-to-r from-purple-50 to-blue-50 border-purple-200">
      <CardContent className="pt-6">
        ...
        {estadisticasFeedback.distribucion_calificaciones && (
          <div className="bg-white rounded-lg p-4 border">
            <h5 className="font-medium text-sm mb-3">DistribuciÃ³n de Calificaciones</h5>
                ...
                ([star, count]: [string, any]) => {
                  ...
                  return (
                    <div key={star} className="flex items-center gap-2">
                      <div className="w-12 text-sm font-medium text-gray-600">{star} â</div>
          ...
          <div className="flex gap-2">
            ...
            <div className="text-sm text-blue-800">
              ...
              <ul className="text-xs space-y-1 list-disc list-inside opacity-90">
                ...
                <li>El sistema filtra automÃ¡ticamente feedback muy negativo durante la preparaciÃ³n</li>
