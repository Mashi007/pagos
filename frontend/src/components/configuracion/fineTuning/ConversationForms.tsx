...
import { Plus, Zap, Download, Loader2 } from 'lucide-react'
...
export function ConversationForms({
  ...
  const [mejorando, setMejorando] = useState<
    'pregunta' | 'respuesta' | 'conversacion' | null
  >(null)
  ...
  const [textareaActivo, setTextareaActivo] = useState<
  ...
  const camposDisponibles = tablaSeleccionada
    ? tablasYCampos[tablaSeleccionada] || []
    : []
  ...
  const insertarEnTextarea = (texto: string) => {
    ...
    if (
      textareaActivo === 'pregunta' ||
      document.activeElement === preguntaTextareaRef.current
    ) {
            ...
            <div className="space-y-4 border-t pt-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Select
                        ...
                        onValueChange={setTablaSeleccionada}
                      >
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  disabled={
                    mejorando !== null || !pregunta.trim() || !respuesta.trim()
                  }
                  className="gap-2"
                >
                  <Zap className="h-4 w-4" />

                  {mejorando === 'conversacion'
                    ? 'Mejorando...'
                    : 'Mejorar Todo'}
                </Button>
              </div>
