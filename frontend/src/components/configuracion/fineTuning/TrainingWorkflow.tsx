              ...
              {conversacionesListasCount > 0 && (
                <Badge variant={puedePreparar ? 'default' : 'secondary'} className="mr-2">
                  ...
                  {!puedePreparar &&
                    ...
                    ` (${MINIMO_CONVERSACIONES_ENTRENAMIENTO - conversacionesListasCount} mÃÂ¡s necesaria${MINIMO_CONVERSACIONES_ENTRENAMIENTO - conversacionesListasCount !== 1 ? 's' : ''})`}
                </Badge>
              )}
            ...
            <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-blue-800">
                  El entrenamiento puede tardar varias horas. Este proceso continuarÃÂ¡ en segundo plano
                  incluso si cierras esta pÃÂ¡gina.
                </p>
              </div>
            </div>
          )}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-600">
                        Modelo base: {job.modelo_base || 'N/A'} Ã¢ÂÂ¢ Creado: {new Date(job.creado_en).toLocaleString('es-ES')}
                      </p>
                    </div>
