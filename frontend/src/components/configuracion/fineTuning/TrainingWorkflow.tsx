  ...
  return (
    <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              {conversacionesListasCount > 0 && (
                <Badge
                  variant={puedePreparar ? 'default' : 'secondary'}
                  className="mr-2"
                >
                  {conversacionesListasCount} lista
                  {conversacionesListasCount !== 1 ? 's' : ''} para
                  entrenamiento
                  {!puedePreparar &&
                    conversacionesListasCount <
                      MINIMO_CONVERSACIONES_ENTRENAMIENTO &&
      ...
      {mostrarFormEntrenamiento && (
        <Card>
          <CardContent className="pt-6">
            <h4 className="mb-4 font-semibold">Iniciar Entrenamiento</h4>
                ...
                <Select value={modeloBase} onValueChange={setModeloBase}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="gpt-4o">
                      gpt-4o (Puede no estar disponible)
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
        ...
        <CardContent className="pt-6">
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button
                onClick={onCargarJobs}
                variant="outline"
                size="sm"
                disabled={cargandoJobs}
              >
                {cargandoJobs ? (
                  <>
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
            ...
            <div className="mb-4 rounded-lg border border-blue-200 bg-blue-50 p-3">
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-blue-800">
                  El entrenamiento puede tardar varias horas. Este proceso
                  continuará en segundo plano incluso si cierras esta página.
                </p>
              </div>
            </div>
          )}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-600">
                        Modelo base: {job.modelo_base || 'N/A'} • Creado:{' '}
                        {new Date(job.creado_en).toLocaleString('es-ES')}
                      </p>
                    </div>
