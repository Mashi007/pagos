...
const mapearEstadoConcesionario = (concesionario: Concesionario, prestamos: Prestamo[]): string => {
  ...
  // Si tiene prÃÂ©stamos aprobados, estÃÂ¡ activo
  ...
  // Si tiene prÃÂ©stamos en revisiÃÂ³n o draft, estÃÂ¡ pendiente
  ...
  // Si estÃÂ¡ activo pero sin prÃÂ©stamos, estÃÂ¡ pendiente
  return 'pendiente'
}

// ConfiguraciÃÂ³n de campos de tarjetas
...
export function EmbudoConcesionarios() {
  ...
  // Obtener concesionarios reales desde configuraciÃÂ³n/concesionarios
  const {
  ...
  // Obtener todos los prÃÂ©stamos para calcular estadÃÂ­sticas
  const {
    data: prestamosData,
    ...
    undefined,
    1,
    1000 // Obtener muchos prÃÂ©stamos para anÃÂ¡lisis
  )

  // Obtener todos los clientes para vincular con prÃÂ©stamos
  const {
    data: clientesData,
    error: errorClientes
  ...
  const todosConcesionarios = useMemo(() => {
    ...
    // Agregar concesionarios que no estÃÂ¡n en la API pero sÃÂ­ en concesionariosEnEmbudo
  ...
  // Calcular estadÃÂ­sticas por concesionario
  const concesionariosConEstadisticas = useMemo(() => {
    return todosConcesionarios.map(concesionario => {
      ...
      // Obtener clientes ÃÂºnicos de los prÃÂ©stamos
      ...
      // Calcular monto total de prÃÂ©stamos aprobados
  ...
  // Filtrar concesionarios (aplicar bÃÂºsqueda si no hay concesionario seleccionado)
  ...
  // BÃÂºsqueda de concesionarios para agregar
  ...
  const handleAgregarConcesionario = (concesionario: Concesionario) => {
    ...
    // Asignar automÃÂ¡ticamente al embudo "inactivo" (agregar otro)
  ...
  // Clientes y prÃÂ©stamos del concesionario seleccionado
  const clientesYprestamosDetalle = useMemo(() => {
    if (!concesionarioDetalle) return []

    // Agrupar por cliente y mostrar sus prÃÂ©stamos
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          ...
          <p className="text-gray-600 mt-1 text-sm">
            Seguimiento de concesionarios que gestionan ventas en base a crÃÂ©ditos
          </p>
        </div>
        <div className="flex gap-2">
          ...
          {/* DiÃÂ¡logo de ConfiguraciÃÂ³n de Tarjetas */}
            ...
            <DialogContent className="max-w-md">
              ...
              <div className="space-y-4 py-4">
                <p className="text-sm text-gray-600">
                  Selecciona quÃÂ© campos deseas mostrar en las tarjetas del embudo:
                </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-7 gap-4">
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-xs text-gray-600 mt-1">PrÃÂ©stamos Activos</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            ...
            <div className="w-full md:w-[300px]">
              <Select
                ...
                onValueChange={(value) => {
                  ...
                  setSearchTerm('') // Limpiar bÃÂºsqueda al seleccionar
                }}
              >
      ...
      {concesionarios.length === 0 ? (
        <Card>
          <CardContent className="py-12">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">
                No se encontraron concesionarios en el sistema. Puedes crear uno nuevo desde la configuraciÃÂ³n.
              </p>
                                    ...
                                    <div className="space-y-2 pt-2 border-t border-gray-100">
                                      <div className="grid grid-cols-2 gap-2 pt-2">
                                        ...
                                        <div className="bg-purple-50 rounded p-2">
                                          <div className="text-xs text-gray-600">PrÃÂ©stamos</div>
        ...
        {/* Panel de Clientes y PrÃÂ©stamos del Concesionario Seleccionado */}
          ...
          <div className="lg:col-span-1">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>
                  {concesionarioDetalle.clientesAsignados} clientes, {concesionarioDetalle.prestamosActivos} prÃÂ©stamos activos
                </CardDescription>
              </CardHeader>
                  ...
                  >
                    ...
                    <div className="space-y-2 mt-2 pt-2 border-t border-gray-200">
                      <div className="flex items-center justify-between text-xs">
                        <span className="text-gray-600">PrÃÂ©stamos:</span>
