            ...
            <CardContent className="space-y-3 px-5 sm:px-6">
              ...
              <div className="flex flex-wrap gap-2 pt-2 sm:flex-nowrap">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex h-[52px] min-w-[120px] flex-1 touch-manipulation items-center justify-center gap-2 rounded-lg border-2 border-emerald-500 bg-emerald-50 px-4 text-center text-base font-bold text-emerald-800 shadow-sm transition-all hover:bg-emerald-100 hover:shadow-md"
                >
                  <svg
                  ...
                  <span className="whitespace-nowrap">Asistencia por WhatsApp</span>
                </a>
              ...
              {loading && (
                <p className="rounded-md border border-amber-300 bg-amber-50 px-3 py-2 text-center text-sm font-bold text-amber-900 shadow-sm">
