...
export function DashboardPagos() {
  ...
  // Cargar estadÃÂ­sticas de pagos
  ...
  // Cargar KPIs de pagos Ã¢ÂÂ queryKey compartida con useSidebarCounts para evitar llamadas duplicadas
  ...
  // Datos para grÃÂ¡fico de pagos por estado
  ...
  // Cargar evoluciÃÂ³n de pagos (ÃÂºltimos 6 meses) - DATOS REALES
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* GrÃÂ¡fico 2: EvoluciÃÂ³n de Pagos */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            <Card className="shadow-lg border-2 border-gray-200">
              <CardHeader className="bg-gradient-to-r from-indigo-50 to-blue-50 border-b-2 border-indigo-200">
                <CardTitle className="flex items-center space-x-2 text-xl font-bold text-gray-800">
                  ...
                  <span>EvoluciÃÂ³n de Pagos</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="p-6">
                {loadingEvolucion ? (
          ...
          <div className="bg-gradient-to-r from-violet-600 to-indigo-600 rounded-xl p-6 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Button
                ...
                className="bg-white hover:bg-gray-50 text-gray-800 border-2 border-transparent hover:border-violet-300 h-auto py-4 flex flex-col items-center space-y-2"
                onClick={() => {
                  // TODO: Navegar a anÃÂ¡lisis de conciliaciones
                  console.log('AnÃÂ¡lisis de Conciliaciones')
                }}
              >
                <Shield className="h-6 w-6" />
                <span className="font-semibold">AnÃÂ¡lisis de Conciliaciones</span>
                <ChevronRight className="h-4 w-4" />
              </Button>
              <Button
                variant="secondary"
