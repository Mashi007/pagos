...
export function Notificaciones({ modulo = 'a1dia' }: NotificacionesProps) {
  ...
  const descripcionModulo = useMemo(() => {
    ...
    if (modulo === 'a2cuotas') {
      return 'Clientes con 2 o más cuotas impagas a 60 o más días de atraso (calendario Caracas). Condiciones innegociables: atraso ≥60 días y ≥2 cuotas impagas. Permanecen todos los días mientras cumplan; salen al ponerse al día. El envío es solo manual (sin cron ni «enviar todas»). To = cliente; CCO = cobranza@ y notificaciones@. Use Actualizar o vuelva a entrar; también se refresca al guardar pagos en el módulo Pagos.'
    }
    if (modulo === 'd2antes') {
              ...
              <CardTitle className="flex items-center gap-2">
                ...
                {modulo === 'fecha'
                  ...
                  : modulo === 'general'
                    ? 'General'
                    : modulo === 'a2cuotas'
                      ? '60 días o más (atraso ≥60; 2+ cuotas impagas)'
                      : modulo === 'd2antes'
