...
export function FiniquitoPanelPage() {
  ...
  return (
    <FiniquitoWorkspaceShell
      description={
        <p>
          Préstamos con financiamiento = suma de abonos. El ojo abre el detalle
          del crédito: préstamo completo, plan de cuotas, préstamos y pagos por
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 sm:text-sm">
                Casos listos para finiquito. Cada fila cumple total
                financiamiento = total abonos. Solo en estado Revisión puede
                aceptar (desk) o rechazar.
              </p>
            </div>
          </div>
        </div>
