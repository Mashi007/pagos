...
export function Auditoria() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(
      ...
      5 * 60 * 1000
    ) // 5 minutos (actualizado desde 30 minutos)
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-blue-600">
                      {stats
                        ? stats.acciones_esta_semana.toLocaleString()
                        : '0'}
                    </p>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div>
                  ...
                  <Input
                    ...
                    onChange={e =>
                      setFiltros({ ...filtros, usuario_email: e.target.value })
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setFiltros({ ...filtros, accion: value })
                    }
                  >
                    <SelectTrigger>
                    ...
                    auditorias.map(auditoria => (
                      <TableRow key={auditoria.id}>
                        ...
                        <TableCell className="w-[120px]">
                          <Badge
                            className={getAccionBadgeColor(auditoria.accion)}
                          >
                            {auditoria.accion}
                          </Badge>
                        </TableCell>
                        ...
                        <TableCell className="w-[120px]">
                          <Badge
                            className={getModuloBadgeColor(auditoria.modulo)}
                          >
                            {auditoria.modulo}
                          </Badge>
                        </TableCell>

                        <TableCell className="w-[140px] text-sm font-medium text-gray-600">
                        ...
                        <TableCell className="min-w-[200px] text-sm text-gray-600">
                          <span className="line-clamp-2">
                            {auditoria.descripcion ||
                              `${auditoria.accion} en ${auditoria.modulo}${auditoria.registro_id ? ` #${auditoria.registro_id}` : ''}`}
                          </span>
                        </TableCell>
