...
export function DashboardAnalisis() {
  ...
  const { data: kpisPrincipales, isLoading: loadingKPIs } = useQuery({
    ...
    staleTime: 2 * 60 * 1000, // ÃÂ¢ÃÂÃ¢ÂÂ¦ ACTUALIZADO: 2 minutos para datos mÃÂ¡s frescos
    refetchOnWindowFocus: true, // ÃÂ¢ÃÂÃ¢ÂÂ¦ ACTUALIZADO: Recargar al enfocar ventana para datos actualizados
  })
  ...
  // Calcular variaciÃÂ³n mes anterior y crecimiento anual desde datos reales
  const variacionMesAnterior = kpisPrincipales?.variacion_mes_anterior || 0

  // Calcular crecimiento anual comparando mes actual con mismo mes del aÃÂ±o anterior
  // Usar evolucion_mensual si estÃÂ¡ disponible, o estimar desde variaciÃÂ³n mensual
  let crecimientoAnual = 0

  if (datosEvolucionMensual.length >= 12) {
    // Si tenemos 12 meses de datos, comparar mes actual (ÃÂºltimo) con mes del aÃÂ±o anterior (hace 12 meses)
    ...
    // Si no hay datos suficientes, estimar crecimiento anual como promedio de variaciÃÂ³n mensual * 12
    // (estimaciÃÂ³n conservadora)
      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            >
              ÃÂ¢Ã¢ÂÂ ÃÂ MenÃÂº
            </Button>
            <div>
              <h1 className="text-4xl font-black text-gray-900 uppercase tracking-tight">AnÃÂ¡lisis</h1>
              <p className="text-lg text-gray-600 font-medium mt-1">
                Monitoreo EstratÃÂ©gico Ã¢ÂÂ¢ {userName}
              </p>
            </div>
          </div>
        </motion.div>
        ...
        {loadingKPIs || loadingDashboard ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <KpiCardLarge
              title="VariaciÃÂ³n Mes Anterior"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* GrÃÂ¡fico 1: Cobros Diarios del Mes */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          {/* GrÃÂ¡fico 2: AnÃÂ¡lisis Comparativo */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            <Card className="shadow-lg border-2 border-gray-200">
              <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b-2 border-blue-200">
                <CardTitle className="flex items-center space-x-2 text-xl font-bold text-gray-800">
                  ...
                  <span>AnÃÂ¡lisis Comparativo</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="p-6">
                {loadingDashboard ? (
        ...
        >
          <div className="bg-gradient-to-r from-amber-600 to-orange-600 rounded-xl p-6 shadow-xl">
            <h2 className="text-2xl font-bold text-white mb-4 flex items-center space-x-2">
              <span>ÃÂ°ÃÂ¸Ã¢ÂÂÃÂ</span>
              <span>Explorar AnÃÂ¡lisis Detallados</span>
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                ...
                <span className="font-semibold">PrÃÂ©stamos por Concesionario</span>
                <ChevronRight className="h-4 w-4" />
              </Button>
              <Button
                variant="secondary"
              ...
              >
                ...
                <span className="font-semibold">DistribuciÃÂ³n de PrÃÂ©stamos</span>
                <ChevronRight className="h-4 w-4" />
              </Button>
              <Button
                variant="secondary"
