/**
 * Editar pago reportado: modificar valores para que cumplan con los validadores (cÃ©dula, fecha, monto, etc.).
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (montoNum !== undefined && (isNaN(montoNum) || montoNum < 0)) {
        toast.error('Monto debe ser un nÃºmero mayor o igual a 0.')
        setSaving(false)
        return
      }
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Modifica los valores para que cumplan con los validadores (cÃ©dula, fecha, monto, etc.).
          </p>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium mb-1">Tipo cÃ©dula</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium mb-1">NÃºmero cÃ©dula</label>
                <Input
            ...
            <div>
              <label className="block text-sm font-medium mb-1">InstituciÃ³n financiera</label>
              <select
            ...
            <div>
              <label className="block text-sm font-medium mb-1">NÃºmero de operaciÃ³n</label>
              <Input
            ...
            <div>
              <label className="block text-sm font-medium mb-1">Correo (para envÃ­o de recibo)</label>
              <Input
                type="email"
            ...
            <div>
              <label className="block text-sm font-medium mb-1">ObservaciÃ³n (opcional)</label>
              <Input
