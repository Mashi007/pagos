          ...
          <CardContent>
            {!items.length ? (
              <p className="text-gray-500">
                No hay registros para esta cédula.
              </p>
            ) : (
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b">
                      ...
                      <th className="py-2 text-left">Fecha pago</th>

                      <th className="py-2 text-left">Fecha reporte</th>

                      <th className="py-2 text-right">Monto</th>

                      <th className="py-2 text-left">Estado</th>

                      <th className="py-2 text-left">Recibo</th>
                    </tr>
                  </thead>
                    ...
                    {items.map(row => (
                      <tr key={row.id} className="border-b">
                        <td className="py-2 font-mono">
                          {row.referencia_interna?.startsWith('#')
                        ...
                        <td className="py-2">
                          {new Date(row.fecha_reporte).toLocaleString()}
                        </td>
