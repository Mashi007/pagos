  ...
  const handleEliminar = async (id: number) => {
    try {
      ...
      const confirmar = window.confirm(
        'Ã¢Å¡ Ã¯Â¸Â Â¿EstÃ¡s seguro de que quieres ELIMINAR PERMANENTEMENTE este modelo?\n\n' +
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Gestiona los modelos de vehÃ­culos. El precio (USD) se usa como Valor Activo al crear un prÃ©stamo.
          </p>
        </div>
        <div className="flex items-center space-x-2">
          <Button onClick={() => {
                ...
                <form onSubmit={handleCreateOrUpdate} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="Opcional; se usa como Valor Activo en Nuevo PrÃ©stamo"
                    />
                  </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex items-center gap-2">
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  if (ax?.response?.status === 501) {
                    toast.error('ImportaciÃ³n desde Excel no disponible por el momento.')
                    return
                  }
            ...
            <div className="text-xs text-gray-500">Precios en USD (Valor Activo en prÃ©stamos)</div>
          </div>
        </CardContent>
      </Card>
    </div>
