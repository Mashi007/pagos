...
export function ModelosVehiculos() {
  ...
  const handleEliminar = async (id: number) => {
    try {
      // Confirmar eliminaciÃÂ³n permanente
      const confirmar = window.confirm(
        'ÃÂ¢ÃÂ¡ ÃÂ¯ÃÂ¸ÃÂ ÃÂ¿EstÃÂ¡s seguro de que quieres ELIMINAR PERMANENTEMENTE este modelo?\n\n' +
        'Esta acciÃÂ³n NO se puede deshacer y el modelo serÃÂ¡ borrado completamente de la base de datos.'
      )
  ...
  const handleCreateOrUpdate = async (e: React.FormEvent) => {
    ...
    // Validar modelo (solo que no estÃÂ© vacÃÂ­o)
  ...
  // Filtrar modelos por tÃÂ©rmino de bÃÂºsqueda
  ...
  // Resetear a pÃÂ¡gina 1 cuando cambia el filtro de bÃÂºsqueda
  useEffect(() => {
    setCurrentPage(1)
  }, [searchTerm])
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="flex items-center space-x-2">
          ...
          <span>Cargando modelos de vehÃÂ­culos...</span>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          <p className="text-red-500 mb-4">Error al cargar modelos de vehÃÂ­culos</p>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Modelos de VehÃÂ­culos</h1>
          <p className="text-muted-foreground">
            Gestiona los modelos de vehÃÂ­culos. El precio (USD) se usa como Valor Activo al crear un prÃÂ©stamo.
          </p>
        </div>
        <div className="flex items-center space-x-2">
          <Button onClick={() => {
      ...
      <Card>
        <CardHeader>
          <CardTitle>Lista de Modelos de VehÃÂ­culos</CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Fecha CreaciÃÂ³n</TableHead>
        ...
        >
          ...
          >
            <Card>
              <CardHeader>
                <CardTitle>
                  {editingModelo ? 'Editar Modelo de VehÃÂ­culo' : 'Nuevo Modelo de VehÃÂ­culo'}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleCreateOrUpdate} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="Opcional; se usa como Valor Activo en Nuevo PrÃÂ©stamo"
                    />
                  </div>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-600">
              {archivoExcel ? archivoExcel.name : 'No se ha seleccionado ningÃÂºn archivo.'}
            </span>
          </div>
          <div className="flex items-center gap-2">
            <Button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  if (ax?.response?.status === 501) {
                    toast.error('ImportaciÃÂ³n desde Excel no disponible por el momento.')
                    return
                  }
            ...
            <div className="text-xs text-gray-500">Precios en USD (Valor Activo en prÃÂ©stamos)</div>
          </div>
        </CardContent>
      </Card>
    </div>
...
export default ModelosVehiculos
