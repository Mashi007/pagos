      ...
      <div className="container mx-auto space-y-8 px-4 py-8">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-6xl font-black uppercase tracking-tight text-gray-900">
                Financiamiento
              </h1>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          ...
          >
            <Card className="sticky top-4 border-2 border-cyan-200 bg-gradient-to-br from-cyan-50 to-blue-50 shadow-lg">
              <CardHeader className="-m-0.5 mb-4 rounded-t-lg bg-gradient-to-r from-cyan-600 to-blue-600">
                <CardTitle className="flex items-center space-x-2 text-2xl font-bold text-white">
                  <span>ðŸ"</span>
              ...
              <CardContent className="space-y-3">
                <Button
                  variant="outline"
                  className="h-auto w-full justify-start border-2 border-cyan-200 bg-white px-4 py-3 text-gray-800 hover:border-cyan-400 hover:bg-cyan-50"
                  onClick={() => {
                ...
                >
                  <BarChart3 className="mr-3 h-6 w-6 text-cyan-600" />
                ...
                >
                  <PieChart className="mr-3 h-6 w-6 text-cyan-600" />

                  <span className="flex-1 text-left text-base font-semibold">
                    Distribución Concesionarios
                  </span>
                ...
                >
                  <TrendingUp className="mr-3 h-6 w-6 text-cyan-600" />
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              >
                <Card className="border-2 border-gray-200 shadow-lg">
                  <CardHeader className="border-b-2 border-cyan-200 bg-gradient-to-r from-cyan-50 to-blue-50">
                          ...
                          >
                            {datosEstado.map((entry, index) => (
                              <Cell
                                ...
                                fill={
                                  COLORS_POR_ESTADO[
                                    entry.estado as keyof typeof COLORS_POR_ESTADO
                                  ] || '#3b82f6'
                                }
                              />
                            ))}
                            ...
                            >
                              {datosConcesionarios.map((entry, index) => (
                                <Cell
                                  key={`cell-${index}`}
                                  fill={
                                    COLORS_CONCESIONARIOS[
                                      index % COLORS_CONCESIONARIOS.length
                                    ]
                                  }
                                />
                              ))}
