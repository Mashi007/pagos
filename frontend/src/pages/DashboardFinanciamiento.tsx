...
export function DashboardFinanciamiento() {
  ...
  // Cargar datos de grÃÂ¡fico por estado
      ...
      const datos: EstadoData[] = [
        {
          estado: 'Activo',
          monto: activo,
          cantidad: 0, // Se calcularÃÂ­a desde BD si es necesario
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        {/* LAYOUT: BOTONES IZQUIERDA + GRÃÂFICOS CENTRO */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <Card className="shadow-lg border-2 border-cyan-200 bg-gradient-to-br from-cyan-50 to-blue-50 sticky top-4">
              ...
              <CardContent className="space-y-3">
                ...
                <Button
                  ...
                  className="w-full justify-start bg-white hover:bg-cyan-50 text-gray-800 border-2 border-cyan-200 hover:border-cyan-400 h-auto py-3 px-4"
                  onClick={() => {
                    // TODO: Navegar a anÃÂ¡lisis por estado
                    console.log('AnÃÂ¡lisis por Estado Completo')
                  }}
                >
                  <BarChart3 className="h-6 w-6 mr-3 text-cyan-600" />
                  <span className="font-semibold text-base flex-1 text-left">AnÃÂ¡lisis por Estado</span>
                  <ChevronRight className="h-5 w-5 text-gray-400" />
                </Button>
                <Button
                  variant="outline"
                ...
                >
                  ...
                  <span className="font-semibold text-base flex-1 text-left">DistribuciÃÂ³n Concesionarios</span>
                  <ChevronRight className="h-5 w-5 text-gray-400" />
                </Button>
                <Button
                  variant="outline"
          ...
          {/* COLUMNA CENTRO/DERECHA: GRÃÂFICOS PRINCIPALES */}
          <div className="lg:col-span-9 space-y-6">
            {/* GrÃÂ¡ficos en Grid 2 Columnas */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* GrÃÂ¡fico 1: Financiamiento por Estado (Bar Chart) */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              {/* GrÃÂ¡fico 2: DistribuciÃÂ³n por Concesionario (Donut) */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                <Card className="shadow-lg border-2 border-gray-200">
                  <CardHeader className="bg-gradient-to-r from-purple-50 to-pink-50 border-b-2 border-purple-200">
                    <CardTitle className="flex items-center space-x-2 text-2xl font-bold text-gray-800">
                      ...
                      <span>DistribuciÃÂ³n por Concesionario</span>
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="p-6">
                      ...
                      <div className="relative">
                          ...
                          <RechartsPieChart>
                            ...
                            <Tooltip
                              formatter={(value: number, name: string, props: { payload?: { cantidad?: number; monto?: number } }) => {
                                ...
                                return [
                                  `${(value * 100).toFixed(1)}% (${cantidad} prÃÂ©stamos, ${formatCurrency(monto)})`,
                                  'Porcentaje',
                                ]
                              }}
                            />
                        ...
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                          <div className="text-center">
                            ...
                            <div className="text-xs text-gray-500">PrÃÂ©stamos</div>
            ...
            {/* GrÃÂ¡fico 3: Tendencia Mensual (Full Width) */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
