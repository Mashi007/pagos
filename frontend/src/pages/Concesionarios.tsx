...
import {
  useConcesionarios,
  useDeleteConcesionario,
  useUpdateConcesionario,
...
export function Concesionarios() {
  ...
  const [editingConcesionario, setEditingConcesionario] =
    useState<Concesionario | null>(null)
  ...
  const handleCreateOrUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingConcesionario) {
        ...
        await createConcesionarioMutation.mutateAsync({
          ...formData,
  ...
  const paginatedConcesionarios = filteredConcesionarios.slice(
    startIndex,
    endIndex
  )
    ...
    return (
      <div className="flex h-64 items-center justify-center">
        <div className="text-center">
          <p className="mb-4 text-red-500">Error al cargar concesionarios</p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-600">
              {
                (concesionarios || []).filter(
                  c => c.activo === false || c.activo === 2 || c.activo === 0
                ).length
              }
            </div>
          </CardContent>
        ...
        <CardContent>
          ...
          {filteredConcesionarios.length === 0 && (
            <div className="py-8 text-center text-muted-foreground">
              {searchTerm
                ? 'No se encontraron concesionarios con ese nombre'
          ...
          {filteredConcesionarios.length > itemsPerPage && (
            <div className="flex items-center justify-between border-t px-2 py-4">
              <div className="text-sm text-gray-500">
                ...
                {Math.min(endIndex, filteredConcesionarios.length)} de{' '}
                {filteredConcesionarios.length} concesionarios
              </div>
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              onClick={async () => {
                ...
                try {
                  const svc = (await import('../services/concesionarioService'))
                  ...
                  <div className="flex items-center space-x-2 pt-4">
                    <Button
                      ...
                      disabled={
                        ...
                        updateConcesionarioMutation.isPending
                      }
