...
// Ã¢Åâ¦ MEJORA: Eliminado cÃ³digo mock no utilizado
    ...
    >
      ...
      {!schedulerActivo && (
        <div className="bg-yellow-50 border border-yellow-200 text-yellow-700 px-4 py-3 rounded">
          Ã¢Å¡ Ã¯Â¸Â El scheduler no estÃ¡ activo. Las tareas programadas no se ejecutarÃ¡n automÃ¡ticamente.
        </div>
      )}
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Tasa de Ãâ°xito</CardTitle>
            <CheckCircle className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">
              {/* Ã¢Åâ¦ MEJORA: Validar divisiÃ³n por cero */}
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Ãltima EjecuciÃ³n</TableHead>
                <TableHead>PrÃ³xima EjecuciÃ³n</TableHead>
                <TableHead>Ãâ°xitos/Fallos</TableHead>
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                      ...
                      <div><strong>Tasa de Ãâ°xito:</strong>
                        {/* Ã¢Åâ¦ MEJORA: Validar divisiÃ³n por cero */}
                        {tarea.exitos + tarea.fallos > 0
                          ? ((tarea.exitos / (tarea.exitos + tarea.fallos)) * 100).toFixed(1)
                          : '0.0'}%
                      </div>
                      <div><strong>Ãltima EjecuciÃ³n:</strong> {formatDate(tarea.ultimaEjecucion)}</div>
