...
// âœ… MEJORA: Eliminado código mock no utilizado
    ...
    >
      ...
      {!schedulerActivo && (
        <div className="rounded border border-yellow-200 bg-yellow-50 px-4 py-3 text-yellow-700">
          âš ï¸ El scheduler no está activo. Las tareas programadas no se
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {/* âœ… MEJORA: Validar división por cero */}
              {exitosTotales + fallosTotales > 0
                ? (
                    (exitosTotales / (exitosTotales + fallosTotales)) *
                    100
                  ).toFixed(1)
                : '0.0'}
              %
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Filtra las tareas programadas por diferentes criterios.
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Lista de todas las tareas automatizadas del sistema.
          </CardDescription>
        </CardHeader>
              ...
              {isLoading ? (
                ...
                filteredTareas.map(tarea => (
                  <TableRow key={tarea.id}>
                    ...
                    <TableCell>
                      <div className="text-sm">
                        {tarea.proximaEjecucion === 'CONTINUO'
                          ? 'Continuo'
                          : formatDate(tarea.proximaEjecucion)}
                      </div>
                    </TableCell>
      ...
      {selectedTarea && (
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center">
              <Clock className="mr-2 h-5 w-5" /> Detalle de Tarea -{' '}
              {selectedTarea}
            </CardTitle>

            <CardDescription>
              Configuración y historial de la tarea seleccionada.
            </CardDescription>
          </CardHeader>
              ...
              return (
                <div className="grid gap-6 md:grid-cols-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2 rounded-lg bg-gray-50 p-4">
                      <div>
                        <strong>Ejecuciones Exitosas:</strong> {tarea.exitos}
                      </div>

                      <div>
                        <strong>Ejecuciones Fallidas:</strong> {tarea.fallos}
                      </div>
                      ...
                      <div>
                        ...
                        {tarea.exitos + tarea.fallos > 0
                          ? (
                              (tarea.exitos / (tarea.exitos + tarea.fallos)) *
                              100
                            ).toFixed(1)
                          : '0.0'}
                        %
                  ...
                  <div className="flex justify-end space-x-2 md:col-span-2">
                    ...
                    <Button onClick={() => handleEjecutarTarea(tarea.id)}>
