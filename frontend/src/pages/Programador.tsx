...
// ÃÂ¢ÃÂÃ¢ÂÂ¦ MEJORA: Eliminado cÃÂ³digo mock no utilizado

const tiposTarea = [
  { value: 'NOTIFICACION', label: 'NotificaciÃÂ³n', icon: Bell },
  { value: 'REPORTE', label: 'Reporte', icon: FileText },
  { value: 'PROCESO', label: 'Proceso', icon: RefreshCw },
  { value: 'BACKUP', label: 'Backup', icon: Shield },
  { value: 'INTEGRACION', label: 'IntegraciÃÂ³n', icon: Link },
...
export function Programador() {
  ...
  const handleToggleTarea = (id: string) => {
    ...
    // LÃÂ³gica para pausar/reanudar tarea (futuro)
    toast('Funcionalidad de pausar/reanudar prÃÂ³ximamente')
  }
    ...
    >
      ...
      {!schedulerActivo && (
        <div className="bg-yellow-50 border border-yellow-200 text-yellow-700 px-4 py-3 rounded">
          ÃÂ¢ÃÂ¡ ÃÂ¯ÃÂ¸ÃÂ El scheduler no estÃÂ¡ activo. Las tareas programadas no se ejecutarÃÂ¡n automÃÂ¡ticamente.
        </div>
      )}
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">En ejecuciÃÂ³n</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Tasa de ÃÂÃ¢ÂÂ°xito</CardTitle>
            <CheckCircle className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">
              {/* ÃÂ¢ÃÂÃ¢ÂÂ¦ MEJORA: Validar divisiÃÂ³n por cero */}
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center">
            <Settings className="mr-2 h-5 w-5" /> Filtros y BÃÂºsqueda
          </CardTitle>
        ...
        <CardContent>
          <div className="flex items-center gap-4">
            <Input
              placeholder="Buscar por nombre, descripciÃÂ³n o ID..."
              value={searchTerm}
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>ÃÂltima EjecuciÃÂ³n</TableHead>
                <TableHead>PrÃÂ³xima EjecuciÃÂ³n</TableHead>
                <TableHead>ÃÂÃ¢ÂÂ°xitos/Fallos</TableHead>
      ...
      {selectedTarea && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>ConfiguraciÃÂ³n y historial de la tarea seleccionada.</CardDescription>
          </CardHeader>
          <CardContent>
            {(() => {
              ...
              return (
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-4">
                    <h3 className="font-semibold">InformaciÃÂ³n General</h3>
                    <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                      <div><strong>ID:</strong> {tarea.id}</div>
                      <div><strong>Nombre:</strong> {tarea.nombre}</div>
                      <div><strong>DescripciÃÂ³n:</strong> {tarea.descripcion}</div>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-semibold">EstadÃÂ­sticas</h3>
                    <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                      <div><strong>Ejecuciones Exitosas:</strong> {tarea.exitos}</div>
                      <div><strong>Ejecuciones Fallidas:</strong> {tarea.fallos}</div>
                      <div><strong>Tasa de ÃÂÃ¢ÂÂ°xito:</strong>
                        {/* ÃÂ¢ÃÂÃ¢ÂÂ¦ MEJORA: Validar divisiÃÂ³n por cero */}
                        {tarea.exitos + tarea.fallos > 0
                          ? ((tarea.exitos / (tarea.exitos + tarea.fallos)) * 100).toFixed(1)
                          : '0.0'}%
                      </div>
                      <div><strong>ÃÂltima EjecuciÃÂ³n:</strong> {formatDate(tarea.ultimaEjecucion)}</div>
                      <div><strong>PrÃÂ³xima EjecuciÃÂ³n:</strong>
                        {tarea.proximaEjecucion === 'CONTINUO' ? 'Continuo' : formatDate(tarea.proximaEjecucion)}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-semibold">Canales de ComunicaciÃÂ³n</h3>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-semibold">ConfiguraciÃÂ³n</h3>
                    <div className="bg-gray-50 p-4 rounded-lg">
