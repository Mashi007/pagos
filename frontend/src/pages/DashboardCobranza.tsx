...
export function DashboardCobranza() {
  ...
  // Cargar recaudaciÃÂ³n por dÃÂ­a del mes
  const { data: datosRecaudacionDia, isLoading: loadingRecaudacionDia } = useQuery({
    ...
    queryFn: async () => {
      ...
      queryParams.append('dias', '31') // ÃÂÃÂ¡ltimos 31 dÃÂ­as
      ...
      // Filtrar solo dÃÂ­as del mes actual
      const hoy = new Date()
  ...
  // Cargar distribuciÃÂ³n por analista
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 font-medium mt-1">Monitoreo EstratÃÂ©gico Ã¢ÂÂ¢ {userName}</p>
            </div>
          </div>
        </motion.div>
        ...
        {loadingDashboard ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
            ...
            <KpiCardLarge
              ...
              format="number"
              // ÃÂ¢ÃÂ¡ ÃÂ¯ÃÂ¸ÃÂ TODO: Conectar con endpoint de pagos conciliados del mes actual
              // Debe consultar: COUNT(*) FROM pagos WHERE conciliado = TRUE AND fecha_pago >= primer_dia_mes
            />
            <KpiCardLarge
              title="DÃÂ­as Promedio Cobro"
              value="12"
              subtitle="dÃÂ­as"
              icon={Clock}
              ...
              format="text"
              // ÃÂ¢ÃÂ¡ ÃÂ¯ÃÂ¸ÃÂ TODO: Calcular desde base de datos
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* GrÃÂ¡fico 1: Progreso hacia Meta Mensual */}
          ...
          <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-xl p-6 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                ...
                <span className="font-semibold">Cobranza por DÃÂ­a</span>
                <ChevronRight className="h-4 w-4" />
              </Button>
              <Button
                variant="secondary"
              ...
              <Button
                ...
                className="bg-white hover:bg-gray-50 text-gray-800 border-2 border-transparent hover:border-emerald-300 h-auto py-4 flex flex-col items-center space-y-2"
                onClick={() => {
                  // TODO: Navegar a anÃÂ¡lisis de metas
                  console.log('AnÃÂ¡lisis de Metas por PerÃÂ­odo')
                }}
              >
                <Target className="h-6 w-6" />
                <span className="font-semibold">AnÃÂ¡lisis de Metas</span>
                <ChevronRight className="h-4 w-4" />
              </Button>
            </div>
          </div>
