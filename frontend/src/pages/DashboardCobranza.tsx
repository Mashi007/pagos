...
export function DashboardCobranza() {
  ...
  const { data: dashboardData, isLoading: loadingDashboard, refetch } = useQuery({
    ...
    staleTime: 2 * 60 * 1000, // Ã¢Åâ¦ ACTUALIZADO: 2 minutos para datos mÃ¡s frescos
    refetchOnWindowFocus: true, // Ã¢Åâ¦ ACTUALIZADO: Recargar al enfocar ventana para datos actualizados
  })
  ...
  const { data: datosRecaudacionDia, isLoading: loadingRecaudacionDia } = useQuery({
    ...
    queryFn: async () => {
      ...
      queryParams.append('dias', '31') // ÃÅ¡ltimos 31 dÃ­as
        ...
        {loadingDashboard ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
            ...
            <KpiCardLarge
              ...
              format="number"
              // Ã¢Å¡ Ã¯Â¸Â TODO: Conectar con endpoint de pagos conciliados del mes actual
            ...
            <KpiCardLarge
              ...
              format="text"
              // Ã¢Å¡ Ã¯Â¸Â TODO: Calcular desde base de datos
