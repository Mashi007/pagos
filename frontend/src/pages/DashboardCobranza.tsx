...
export function DashboardCobranza() {
  ...
  const [isCobranzasMensualesOpen, setIsCobranzasMensualesOpen] =
    useState(false)

  const [isCobranzaPorDiaOpen, setIsCobranzaPorDiaOpen] = useState(false)

  const [isCobranzaPlanificadaRealOpen, setIsCobranzaPlanificadaRealOpen] =
    useState(false)
  ...
  const { data: datosRecaudacionDia, isLoading: loadingRecaudacionDia } =
    useQuery({
  ...
  const porcentajeAvance =
    data.meta_mensual > 0 ? (data.avance_meta / data.meta_mensual) * 100 : 0
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto space-y-8 px-4 py-8">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="h-8 w-full rounded-full bg-gray-200">
                    <div
                      className="flex h-8 items-center justify-end rounded-full bg-gradient-to-r from-purple-600 to-pink-600 pr-2 transition-all"
                  ...
                  <div className="flex justify-between text-sm text-gray-500">
                    ...
                    <span>
                      ...
                      {formatCurrency(
                        Math.max(
                          0,
                          (data.meta_mensual || 0) - (data.avance_meta || 0)
                        )
                      )}
                    </span>
                  </div>
          ...
          >
            <Card className="border-2 border-gray-200 shadow-lg">
              <CardHeader className="border-b-2 border-teal-200 bg-gradient-to-r from-teal-50 to-cyan-50">
                <CardTitle className="flex items-center space-x-2 text-xl font-bold text-gray-800">
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <div className="rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 p-6 shadow-xl">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
              <Button
                variant="secondary"
                className="flex h-auto flex-col items-center space-y-2 border-2 border-transparent bg-white py-4 text-gray-800 hover:border-emerald-300 hover:bg-gray-50"
      ...
      <CobranzaPlanificadaRealModal
        isOpen={isCobranzaPlanificadaRealOpen}
        onClose={() => setIsCobranzaPlanificadaRealOpen(false)}
      />
    </div>
  )
}
