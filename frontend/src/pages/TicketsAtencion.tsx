...
export function TicketsAtencion() {
  ...
  // Query: placeholderData para que la pÃ¡gina se vea desde el inicio (no pantalla en blanco)
  const {
    data: ticketsData,
  ...
  // KPIs desde la API (estadÃ­sticas globales en BD). Si el backend no envÃ­a estadisticas, fallback a contar solo la pÃ¡gina actual.
  ...
  // Ã¢Åâ¦ Calcular tickets vencidos y prÃ³ximos a vencer
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Ã¢Åâ¦ Alertas de Tickets Vencidos */}
              ...
              <div className="space-y-6">
                {ticketsFiltrados
                  ...
                  .map((ticket, index) => {
                    ...
                    // Verificar si el ticket estÃ¡ vencido o prÃ³ximo a vencer
                    const ahora = new Date()
                    const enUnaHora = new Date(ahora.getTime() + 60 * 60 * 1000)
                                  ...
                                  {ticket.clienteData ? (
                                    <div>
                                      ...
                                      <div className="mt-1 space-y-0.5">
                                        <p className="text-xs text-gray-600">CÃ©dula: <span className="font-medium">{String(ticket.clienteData.cedula ? '')}</span></p>
      ...
      <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4 mt-4">
            {/* TÃ­tulo y descripciÃ³n no se pueden editar despuÃ©s de guardar (solo estado, prioridad, fecha lÃ­mite) */}
            <div className="space-y-2">
              <Label htmlFor="titulo-edit">TÃ­tulo (no editable)</Label>
              <Input
                id="titulo-edit"
                value={nuevoTicket.titulo || ''}
                disabled
            ...
            <div className="space-y-2">
              <Label htmlFor="descripcion-edit">DescripciÃ³n (no editable)</Label>
              <Textarea
                id="descripcion-edit"
                value={nuevoTicket.descripcion || ''}
                disabled
