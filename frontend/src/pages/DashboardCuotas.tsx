...
export function DashboardCuotas() {
  ...
  // Cargar datos para grÃÂ¡fico de estado de cuotas
  ...
  // Cargar datos para grÃÂ¡fico de conciliaciÃÂ³n
  ...
  // Cargar evoluciÃÂ³n de morosidad (ÃÂºltimos 6 meses) - DATOS REALES
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <Card className="shadow-lg border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50 sticky top-4">
              ...
              <CardContent className="space-y-3">
                ...
                <Button
                  ...
                  className="w-full justify-start bg-white hover:bg-purple-50 text-gray-800 border-2 border-purple-200 hover:border-purple-400 h-auto py-3 px-4"
                  onClick={() => {
                    // TODO: Navegar a anÃÂ¡lisis de morosidad
                    console.log('AnÃÂ¡lisis de Morosidad Avanzada')
                  }}
                >
                  <AlertTriangle className="h-5 w-5 mr-3 text-purple-600" />
                  <span className="font-semibold flex-1 text-left">AnÃÂ¡lisis de Pago vencido</span>
                  <ChevronRight className="h-4 w-4 text-gray-400" />
                </Button>
                <Button
                  variant="outline"
          ...
          <div className="lg:col-span-9 space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* GrÃÂ¡fico 1: Estado de Cuotas del Mes */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              {/* GrÃÂ¡fico 2: Cuotas por Estado de ConciliaciÃÂ³n */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                <Card className="shadow-lg border-2 border-gray-200">
                  <CardHeader className="bg-gradient-to-r from-blue-50 to-cyan-50 border-b-2 border-blue-200">
                    <CardTitle className="flex items-center space-x-2 text-xl font-bold text-gray-800">
                      ...
                      <span>Cuotas por Estado de ConciliaciÃÂ³n</span>
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="p-6">
                    {loadingKpis ? (
            ...
            {/* GrÃÂ¡fico 3: EvoluciÃÂ³n de Morosidad */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              <Card className="shadow-lg border-2 border-gray-200">
                <CardHeader className="bg-gradient-to-r from-red-50 to-orange-50 border-b-2 border-red-200">
                  <CardTitle className="flex items-center space-x-2 text-xl font-bold text-gray-800">
                    ...
                    <span>EvoluciÃÂ³n de Pago vencido (ÃÂltimos 6 Meses)</span>
                  </CardTitle>
                </CardHeader>
                <CardContent className="p-6">
                  {loadingEvolucion ? (
