...
export function DashboardCuotas() {
  ...
  const datosEstadoCuotas = kpisData
    ? [
...

        {
          ...
          porcentaje:
            kpisData.total_cuotas_mes > 0
              ? (kpisData.cuotas_atrasadas_mes / kpisData.total_cuotas_mes) *
                100
              : 0,
...

        {
          ...
          cantidad:
            kpisData.total_cuotas_mes -
            kpisData.cuotas_pagadas -
            kpisData.cuotas_atrasadas_mes,
    ...
    ? [
        {
          ...
          porcentaje:
            kpisData.total_cuotas_mes > 0
              ? (kpisData.total_cuotas_conciliadas /
                  kpisData.total_cuotas_mes) *
                100
              : 0,
...

        {
          ...
          porcentaje:
            kpisData.cuotas_pagadas > 0
              ? ((kpisData.cuotas_pagadas - kpisData.total_cuotas_conciliadas) /
                  kpisData.cuotas_pagadas) *
                100
              : 0,
...

        {
          ...
          porcentaje:
            kpisData.total_cuotas_mes > 0
              ? ((kpisData.total_cuotas_mes - kpisData.cuotas_pagadas) /
                  kpisData.total_cuotas_mes) *
                100
              : 0,
  ...
  const { data: datosEvolucionMorosidad, isLoading: loadingEvolucion } =
    useQuery({
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto space-y-8 px-4 py-8">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          ...
          >
            <Card className="sticky top-4 border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50 shadow-lg">
              <CardHeader className="-m-0.5 mb-4 rounded-t-lg bg-gradient-to-r from-purple-600 to-pink-600">
              ...
              <CardContent className="space-y-3">
                <Button
                  variant="outline"
                  className="h-auto w-full justify-start border-2 border-purple-200 bg-white px-4 py-3 text-gray-800 hover:border-purple-400 hover:bg-purple-50"
                  onClick={() => {
                ...
                >
                  <AlertTriangle className="mr-3 h-5 w-5 text-purple-600" />

                  <span className="flex-1 text-left font-semibold">
                    Análisis de Pago vencido
                  </span>
          ...
          <div className="space-y-6 lg:col-span-9">
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              >
                <Card className="border-2 border-gray-200 shadow-lg">
                  <CardHeader className="border-b-2 border-purple-200 bg-gradient-to-r from-purple-50 to-pink-50">
              ...
              >
                <Card className="border-2 border-gray-200 shadow-lg">
                  <CardHeader className="border-b-2 border-blue-200 bg-gradient-to-r from-blue-50 to-cyan-50">
                    <CardTitle className="flex items-center space-x-2 text-xl font-bold text-gray-800">
                            ...
                            >
                              {datosConciliacion.map((entry, index) => (
                                <Cell
                                  ...
                                  fill={
                                    COLORS_CONCILIACION[
                                      index % COLORS_CONCILIACION.length
                                    ]
                                  }
                                />
                              ))}
            ...
            >
              <Card className="border-2 border-gray-200 shadow-lg">
                <CardHeader className="border-b-2 border-red-200 bg-gradient-to-r from-red-50 to-orange-50">
                  <CardTitle className="flex items-center space-x-2 text-xl font-bold text-gray-800">
                ...
                <CardContent className="p-6">
                  ...
                  ) : datosEvolucionMorosidad &&
                    datosEvolucionMorosidad.length > 0 ? (
                    <ResponsiveContainer width="100%" height={300}>
