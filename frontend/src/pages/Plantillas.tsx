    ...
    <div className="p-4 space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-500">Plantilla de email, plantilla PDF anexo y documentos PDF fijos asignables a cualquier pestaÃÂ±a de notificaciÃÂ³n.</p>
            ...
            {resumenAbierto && (
              <div className="px-3 pb-3 pt-0 border-t border-blue-100">
                ...
                <ol className="list-decimal list-inside space-y-0.5 text-gray-600 mt-2 hidden md:block">
                  <li><strong>Plantilla cuerpo email</strong> - Asunto y cuerpo del correo con variables (nombre, cÃÂ©dula, fecha_vencimiento, etc.).</li>
                  ...
                  <li><strong>Documentos PDF anexos</strong> - PDFs fijos que se cargan aquÃÂ­ y se asignan a la pestaÃÂ±a que elijas (Faltan 5, Hoy vence, Retrasadas, Prejudicial, 90+ mora, etc.). Se envÃÂ­an con la notificaciÃÂ³n de esa pestaÃÂ±a.</li>
                </ol>
              </div>
            )}
          </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            Otras secciones de ConfiguraciÃÂ³n
          </Button>
        </div>
      </div>
        ...
        <TabsContent value={SUBTAB_ANEXO_PDF} className="mt-6 min-h-[400px]">
          ...
          <div className="mt-6">
            <DocumentosAlmacenadosPorPestana
              ...
              titulo="Documentos almacenados por pestaÃÂ±a (confirmar vinculaciÃÂ³n)"
