/**
 * Listado de pagos reportados (mÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³dulo Cobros). Filtros, tabla, acciones Ver detalle / Aprobar / Rechazar.
 */
...
AngÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ©lica Fuentes`
...
const ESTADO_CONFIG: Record<string, { label: string; short: string; variant: 'default' | 'secondary' | 'destructive' | 'outline'; Icon: typeof Clock }> = {
  ...
  en_revision: { label: 'En revisiÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³n (manual)', short: 'RevisiÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³n', variant: 'outline', Icon: Search },
...
export default function CobrosPagosReportadosPage() {
  ...
  const handleEliminar = async (id: number, ref: string) => {
    if (!window.confirm(`ÃÆÃâÃÂ¢Ã¢âÂ¬ÃÂ¡ÃÆÃ¢â¬Å¡ÃâÃÂ¿Eliminar el pago reportado ${ref}? Esta acciÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³n no se puede deshacer.`)) return
    setDeletingId(id)
    try {
  ...
  const handleDescargarPagosTablaTemporalExcel = async () => {
    ...
    try {
      ...
      // Recargar la lista despuÃÂ©s de descargar
      await load({ page: 1 })
    } catch (e: any) {
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        >
          Link formulario pÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂºblico ÃÆÃâÃâÃÂ¢ÃÆÃÂ¢ÃÂ¢Ã¢â¬Å¡ÃÂ¬ÃâÃÂ ÃÆÃÂ¢ÃÂ¢Ã¢â¬Å¡ÃÂ¬ÃÂ¢Ã¢â¬Å¾ÃÂ¢
        </a>
      </div>
      ...
      <Card>
        ...
        <CardContent className="flex flex-wrap gap-4">
          ...
          >
            ...
            <option value="en_revision">En revisiÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³n</option>
          ...
          />
          <Input
            placeholder="CÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ©dula"
            value={cedula}
            onChange={(e) => setCedula(e.target.value)}
            className="w-40"
          />
          <Input
            placeholder="InstituciÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³n"
            value={institucion}
              ...
              <table className="w-full min-w-[1000px] text-sm table-fixed">
                ...
                <thead>
                  <tr className="border-b bg-muted/50">
                    ...
                    <th className="text-left py-3 px-3 font-semibold">CÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ©dula</th>
                    ...
                    <th className="text-left py-3 px-3 font-semibold">NÃÆÃâÃÂ¢Ã¢âÂ¬ÃÂ¡ÃÆÃ¢â¬Å¡ÃâÃÂº operaciÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³n</th>
                    <th className="text-left py-3 px-3 font-semibold">Fecha reporte</th>
                    <th className="text-left py-3 px-3 font-semibold">ObservaciÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³n</th>
                ...
                <tbody>
                  {data.items.map((row: PagoReportadoItem) => (
                    <tr key={row.id} className="border-b hover:bg-muted/20 transition-colors">
                      ...
                      <td className={`py-3 px-3 align-top whitespace-nowrap ${/c[eÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ©]dula/i.test(row.observacion || '') ? 'bg-destructive/10 text-destructive font-medium' : ''}`} title={/c[eÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ©]dula/i.test(row.observacion || '') ? 'ObservaciÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³n: ' + (row.observacion || '') : undefined}>
                        {/c[eÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ©]dula/i.test(row.observacion || '') && <AlertCircle className="inline-block h-4 w-4 mr-1 align-middle" aria-hidden />}
                        {row.cedula_display}
                      </td>
                      <td className="py-3 px-3 align-top min-w-0">
                      ...
                      <td
                        ...
                        title={
                          /NO CLIENTES/i.test(row.observacion || '')
                            ? `NO CLIENTES: la cÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ©dula del reporte (${row.cedula_display}) no figura en la tabla clientes. Se compara normalizada (sin guiÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³n, sin ceros a la izquierda). Verifique en PrÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ©stamos > Clientes o registre al cliente.`
                            : /solo Bs|BolÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ­vares/i.test(row.observacion || '')
                              ? 'Monto en Bs: solo estÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ¡ permitido si la cÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ©dula estÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ¡ en la lista de autorizadas para BolÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ­vares (tabla cedulas_reportar_bs). Si no estÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ¡, use USD o agregue la cÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ©dula a la lista en ConfiguraciÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³n.'
                              : (row.observacion ? '')
                        }
                      >
                        {row.observacion ? (
                        ...
                        ) : 'ÃÆÃâÃâÃÂ¢ÃÆÃÂ¢ÃÂ¢Ã¢âÂ¬ÃÂ¡ÃâÃÂ¬ÃÆÃÂ¢ÃÂ¢Ã¢â¬Å¡ÃÂ¬ÃâÃÂ'}
                      </td>
                      ...
                      <td className="py-3 px-3 align-top">
                        <div className="flex flex-wrap gap-1 items-center justify-start">
                          {/* Estado envÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ­o recibo: X = no enviado, visto = entregado, triÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ¡ngulo = en revisiÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³n */}
                          <span className="flex h-8 w-8 shrink-0 items-center justify-center text-muted-foreground" title={
                            row.estado === 'aprobado'
                              ? (row.tiene_recibo_pdf && row.correo_enviado_a ? 'Recibo enviado por correo' : 'No se enviÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³ recibo por correo')
                              : 'En revisiÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³n'
                          }>
                            {row.estado === 'aprobado' ? (
                          ...
                          <div className="relative inline-block h-8 w-8">
                            ...
                            >
                              <option value="">ÃÆÃâÃâÃÂ¢ÃÆÃÂ¢ÃÂ¢Ã¢âÂ¬ÃÂ¡ÃâÃÂ¬ÃÆÃÂ¢ÃÂ¢Ã¢â¬Å¡ÃÂ¬ÃâÃÂ</option>
                              <option value="en_revision">En revisiÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ³n</option>
      ...
      {/* Modal: interfaz rÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ¡pida para escribir mensaje de rechazo y enviar correo al cliente */}
      <Dialog
        ...
        <DialogContent className="max-w-md">
                ...
                <>
                  ...
                  {rechazarModal.row.correo_enviado_a && (
                    <span className="block mt-1">
                      Se enviarÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ¡ un correo automÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ¡ticamente a <strong>{rechazarModal.row.correo_enviado_a}</strong> desde <strong>notificaciones@rapicreditca.com</strong> con el mensaje y el comprobante adjunto.
                    </span>
                  )}
                </>
              )}
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="Indique el motivo del rechazo. Este texto se enviarÃÆÃâÃâ Ã¢â¬â¢ÃÆÃ¢â¬Å¡ÃâÃÂ¡ por correo al cliente."
              value={motivoRechazo}
