...
// Mock data para amortizaciÃÂ³n
const mockAmortizaciones = [
  {
    id: 1,
    cliente: 'Juan Carlos PÃÂ©rez GonzÃÂ¡lez',
    cedula: '12345678',
  ...
  {
    id: 2,
    cliente: 'MarÃÂ­a Elena RodrÃÂ­guez LÃÂ³pez',
    cedula: '87654321',
  ...
  {
    id: 3,
    cliente: 'Carlos Alberto MartÃÂ­nez Silva',
    cedula: '11223344',
...
export function Amortizacion() {
  ...
  const getEstadoBadge = (estado: string) => {
    switch (estado) {
      case 'al_dia':
        return <Badge className="bg-green-100 text-green-800">Al DÃÂ­a</Badge>
      case 'en_mora':
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Tablas de AmortizaciÃÂ³n</h1>
            <p className="text-gray-600 mt-1">Monitorea el progreso de los prÃÂ©stamos y su estado de pago</p>
          </div>
      ...
      >
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Total PrÃÂ©stamos</CardTitle>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="relative">
                ...
                <Input
                  placeholder="Buscar por cliente, cÃÂ©dula o vehÃÂ­culo..."
                  value={searchTerm}
              ...
              >
                ...
                <option value="al_dia">Al DÃÂ­a</option>
      ...
      >
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Progreso de pago de todos los prÃÂ©stamos activos
            </CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  <div key={amortizacion.id} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">CÃÂ©dula: {amortizacion.cedula}</p>
                          </div>
                        </div>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                          <div>
                            <span className="text-gray-500">VehÃÂ­culo:</span>
                          ...
                          <div>
                            <span className="text-gray-500">PrÃÂ³xima Cuota:</span>
                    ...
                    <div className="mt-4">
                      <div className="flex justify-between text-sm text-gray-600 mb-2">
                        <span>Progreso del prÃÂ©stamo</span>
