...
export function VisualizacionBD() {
  ...
  const cargarDatos = async () => {
    setIsLoading(true)
    try {
      // Simular carga de estadÃÂ­sticas
      setStats({
        totalClientes: 150,
        totalPrestamos: 120,
        totalPagos: 450,
  ...
  const exportarDatos = () => {
    const csvContent = [
      ['CÃÂ©dula', 'Nombre', 'Apellido', 'TelÃÂ©fono', 'Email', 'Monto PrÃÂ©stamo', 'Estado', 'Fecha Registro'],
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-gray-900 flex items-center space-x-2">
            ...
            <span>VisualizaciÃÂ³n de Base de Datos</span>
          </h1>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-sm text-gray-600">PrÃÂ©stamos</p>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>Filtros y BÃÂºsqueda</span>
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="text-sm font-medium text-gray-700 mb-2 block">
                  Buscar por cÃÂ©dula, nombre, apellido o email:
                </label>
                <Input
                  placeholder="Buscar..."
                  value={searchTerm}
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Monto PrÃÂ©stamo</TableHead>
      ...
      >
        <AlertWithIcon
          variant="info"
          title="InformaciÃÂ³n de la Base de Datos"
          description={`Ã¢ÂÂ¢ Total de registros: ${clientes.length} clientes\nÃ¢ÂÂ¢ ÃÂltima actualizaciÃÂ³n: ${new Date().toLocaleString()}\nÃ¢ÂÂ¢ Formato de exportaciÃÂ³n: CSV compatible con Excel\nÃ¢ÂÂ¢ Filtros aplicados: ${searchTerm ? `BÃÂºsqueda: "${searchTerm}"` : 'Sin bÃÂºsqueda'} ${filterEstado ? `| Estado: ${filterEstado}` : ''}`}
        />
      </motion.div>
    </div>
  )
