...
/**
 * Si el usuario llegÃÂ³ a login desde un flujo pÃÂºblico (reporte de pago o estado de cuenta),
 * se muestra "Acceso limitado" y "Continuar" para volver al flujo pÃÂºblico (evita que personas
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-900 text-white p-6">
        <div className="max-w-md w-full text-center space-y-8">
          ...
          <p className="text-lg text-slate-300">
            Esta pantalla es para el personal del sistema. Si desea reportar un pago o consultar su estado de cuenta, use el botÃÂ³n Continuar para volver.
          </p>
          <Button
            size="lg"
