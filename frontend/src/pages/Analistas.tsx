  ...
  const handleEliminar = async (id: number) => {
    try {
      ...
      const confirmar = window.confirm(
        'ÃÂ¢ÃÂ¡ ÃÂ¯ÃÂ¸ÃÂ ÃÂ¿EstÃÂ¡s seguro de que quieres ELIMINAR PERMANENTEMENTE este analista?\n\n' +
        'Esta acciÃÂ³n NO se puede deshacer y el analista serÃÂ¡ borrado completamente de la base de datos.'
      )
