/**
 * Query keys compartidos para notificaciones/configuraciÃ³n.
 * Usar los mismos keys en todos los componentes que consumen estos datos
 * para que React Query deduplique peticiones y comparta cachÃ©.
 *
 * adjuntosFijos: usado en pestaÃ±a 2 (Anexo PDF) por DocumentosAlmacenadosPorPestana
 * y en pestaÃ±a 3 (Documentos PDF anexos) por DocumentosPdfAnexos â una sola GET
