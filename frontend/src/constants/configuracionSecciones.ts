...
export const SECCIONES_CONFIGURACION: SeccionConfig[] = [
  { id: 'general', nombre: 'General', icono: Globe },
  {
    ...
    items: [
      ...
      // sin href: se muestra como secciÃ³n dentro de ConfiguraciÃ³n (tab=plantillas)
  ...
  { id: 'modelosVehiculos', nombre: 'Modelos de VehÃ­culos', icono: Car },
...
export const NOMBRES_SECCION_ESPECIAL: Record<string, { nombre: string; icono: IconComponent }> = {
  emailConfig: { nombre: 'ConfiguraciÃ³n Email', icono: Mail },
  whatsappConfig: { nombre: 'ConfiguraciÃ³n WhatsApp', icono: MessageSquare },
  aiConfig: { nombre: 'ConfiguraciÃ³n AI', icono: Brain },
