...
export const SECCIONES_CONFIGURACION: SeccionConfig[] = [
  { id: 'general', nombre: 'General', icono: Globe },
  {
    ...
    items: [
      ...
      { id: 'emailConfig', nombre: 'ConfiguraciÃÂ³n Email', icono: Mail },
      { id: 'whatsappConfig', nombre: 'ConfiguraciÃÂ³n WhatsApp', icono: MessageSquare },
      { id: 'informePagosConfig', nombre: 'Google (Drive, Sheets, Gmail, OCR)', icono: FileText },
      { id: 'plantillas', nombre: 'Plantillas', icono: FileText },
      // sin href: se muestra como secciÃÂ³n dentro de ConfiguraciÃÂ³n (tab=plantillas)
      { id: 'scheduler', nombre: 'Programador', icono: Calendar, href: '/scheduler' },
      { id: 'programador', nombre: 'Programador (Config)', icono: Calendar },
      { id: 'auditoria', nombre: 'AuditorÃÂ­a', icono: FileText },
    ],
  },
  { id: 'baseDatos', nombre: 'Base de Datos', icono: Database },
  { id: 'facturacion', nombre: 'FacturaciÃÂ³n', icono: DollarSign },
  ...
  { id: 'modelosVehiculos', nombre: 'Modelos de VehÃÂ­culos', icono: Car },
...
export const NOMBRES_SECCION_ESPECIAL: Record<string, { nombre: string; icono: IconComponent }> = {
  emailConfig: { nombre: 'ConfiguraciÃÂ³n Email', icono: Mail },
  whatsappConfig: { nombre: 'ConfiguraciÃÂ³n WhatsApp', icono: MessageSquare },
  aiConfig: { nombre: 'ConfiguraciÃÂ³n AI', icono: Brain },
