...
export const mockTickets: Ticket[] = [
...

  {
    ...
    descripcion:
      'El cliente solicita información sobre el estado actual de su préstamo #12345. Necesita saber cuántas cuotas le faltan por pagar y el monto pendiente.',
...

  {
    ...
    descripcion:
      'El cliente reporta que realizó un pago pero no aparece registrado en el sistema. Fecha del pago: 15/11/2025. Monto: $500 USD. Número de referencia: REF-123456.',
...

  {
    ...
    descripcion:
      'Cliente interesado en obtener un préstamo personal. Solicita información sobre tasas de interés, requisitos y montos disponibles.',
...

  {
    ...
    descripcion:
      'El cliente expresa su descontento con la atención recibida en la sucursal. Menciona que el personal no fue amable y no le proporcionó la información solicitada.',
...

  {
    ...
    descripcion:
      'Cliente nuevo se contactó para obtener información general sobre los servicios. Se le proporcionó información completa y se agendó una cita.',
...

  {
    ...
    descripcion:
      'El cliente solicita información sobre la posibilidad de reprogramar sus cuotas pendientes debido a dificultades económicas temporales.',
...

  {
    ...
    descripcion:
      'El cliente reporta que al intentar realizar un pago a través de la plataforma en línea, recibe un error. El sistema no procesa su tarjeta de crédito.',
...

  {
    ...
    descripcion:
      'El cliente solicita una copia de los documentos de su préstamo para fines de declaración de impuestos. Necesita facturas y estados de cuenta.',
...
export const getMockTicketsResponse = (
  page: number = 1,
  per_page: number = 20,
  estado?: string,
  prioridad?: string
