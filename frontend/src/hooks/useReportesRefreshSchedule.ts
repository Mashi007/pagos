...
/** Horas de actualizaciÃ³n automÃ¡tica (1 AM y 1 PM, hora local del usuario). */
 ...
 * para que los datos se actualicen automÃ¡ticamente desde la BD.
 */
  ...
  useEffect(() => {
    const checkAndRefresh = () => {
      ...
      if (REFRESH_HOURS.includes(hour)) {
        // Evitar mÃºltiples invalidaciones en la misma hora
