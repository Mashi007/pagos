...
// Hook para obtener concesionarios activos (solo cuando hay sesiÃÂ³n vÃÂ¡lida; evita "SesiÃÂ³n expirada" en login)
...
// Hook para obtener un concesionario especÃÂ­fico
