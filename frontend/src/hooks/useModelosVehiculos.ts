...
export function useCreateModeloVehiculo() {
  ...
  return useMutation({
    mutationFn: (data: ModeloVehiculoCreate) =>
      modeloVehiculoService.crearModelo(data),
    ...
    onError: (error: any) => {
      toast.error(
        error.response?.data?.message || 'Error al crear modelo de vehículo'
      )
    },
  })
}
    ...
    onError: (error: any) => {
      toast.error(
        error.response?.data?.message ||
          'Error al actualizar modelo de vehículo'
      )
    },
  })
}
...
export function useDeleteModeloVehiculo() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(
        error.response?.data?.message || 'Error al eliminar modelo de vehículo'
      )
    },
  })
}
