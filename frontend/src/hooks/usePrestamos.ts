...
// Tipo para filtros de prÃÂ©stamos
...
// Hook para obtener lista de prÃÂ©stamos
export function usePrestamos(
  ...
  return useQuery({
    ...
    staleTime: 0, // Siempre refetch cuando se invalida (mejor para actualizaciiÃÂ³n inmediata de estado)
...
// Hook para obtener un prÃÂ©stamo especÃÂ­fico
...
// Hook para bÃÂºsqueda de prÃÂ©stamos
...
// Hook para obtener prÃÂ©stamos por cÃÂ©dula
...
// Hook para obtener auditorÃÂ­a de un prÃÂ©stamo
...
// Hook para crear un prÃÂ©stamo
export function useCreatePrestamo() {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success('PrÃÂ©stamo creado exitosamente')
    },
    onError: (error: any) => {
      const errorMessage = error.response?.data?.detail || 'Error al crear prÃÂ©stamo'
      toast.error(errorMessage)
    },
  })
}

// Hook para actualizar un prÃÂ©stamo
export function useUpdatePrestamo() {
  ...
  return useMutation({
    ...
    onSuccess: async (data, variables) => {
      ...
      // Si el estado cambiÃÂ³ a APROBADO, actualizar todas las listas
      ...
      toast.success('PrÃÂ©stamo actualizado exitosamente. El dashboard se ha actualizado.')
    },
    onError: (error: any) => {
      const errorMessage = error.response?.data?.detail || 'Error al actualizar prÃÂ©stamo'
      toast.error(errorMessage)
    },
  })
}

// Hook para eliminar un prÃÂ©stamo
export function useDeletePrestamo() {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['kpis-principales-menu'], exact: false })
      queryClient.invalidateQueries({ queryKey: ['dashboard-menu'], exact: false })
      toast.success('PrÃÂ©stamo eliminado exitosamente')
    },
    onError: (error: any) => {
      const errorMessage = error.response?.data?.detail || 'Error al eliminar prÃÂ©stamo'
      toast.error(errorMessage)
    },
  })
}

// Hook para obtener cuotas de un prÃÂ©stamo (tabla de amortizaciiÃÂ³n)
...
// Hook para generar tabla de amortizaciiÃÂ³n
export function useGenerarAmortizacion() {
  ...
  return useMutation({
    ...
    onSuccess: (data, prestamoId) => {
      ...
      queryClient.invalidateQueries({ queryKey: ['kpis-principales-menu'], exact: false })
      queryClient.invalidateQueries({ queryKey: ['dashboard-menu'], exact: false })
      toast.success('Tabla de amortizaciiÃÂ³n generada exitosamente')
    },
    onError: (error: any) => {
      const errorMessage = error.response?.data?.detail || 'Error al generar tabla de amortizaciiÃÂ³n'
      toast.error(errorMessage)
    },
  })
}

// Hook para aplicar condiciones de aprobaciiÃÂ³n
export function useAplicarCondicionesAprobacion() {
  ...
  return useMutation({
    ...
    onSuccess: async (data, variables) => {
      ...
      toast.success('PrÃÂ©stamo aprobado exitosamente. La tabla de amortizaciiÃÂ³n ha sido generada. El dashboard se ha actualizado.')
    },
    onError: (error: any) => {
...
// Tipo para los KPIs de prÃÂ©stamos
...
// Hook para obtener KPIs de prÃÂ©stamos
