...
// Interfaces para la configuraciÃÂ³n de validadores
...
class ConfiguracionService {
  ...
  // Obtener configuraciÃÂ³n de validadores
  async obtenerValidadores(): Promise<ValidadoresConfig> {
    const response = await apiClient.get('/api/v1/validadores/configuracion-validadores')
  ...
  // Obtener configuraciÃÂ³n completa del sistema
  ...
  // Obtener configuraciÃÂ³n por categorÃÂ­a
