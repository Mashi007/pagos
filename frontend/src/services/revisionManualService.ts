...
class RevisionManualService {
  ...
  /**
   * Obtiene lista de prÃÂ©stamos para revisiÃÂ³n manual (paginada, 20 por defecto)
   * @param cedula - BÃÂºsqueda por cÃÂ©dula para acceder a un caso especÃÂ­fico
   */
  ...
  /**
   * Confirma un prÃÂ©stamo como revisado (ÃÂ¿SÃÂ­?)
   */
  ...
  /**
   * Inicia revisiÃÂ³n de un prÃÂ©stamo (ÃÂ¿No? - cambia a 'revisando')
   */
  ...
  /**
   * Finaliza revisiÃÂ³n (Guardar y Cerrar - cambia a 'revisado')
   */
  ...
  /**
   * Elimina un prÃÂ©stamo (y sus cuotas)
   */
  ...
  /**
   * Obtiene pagos por cÃÂ©dula para ediciÃÂ³n
   */
  ...
  /**
   * Obtiene datos completos de un prÃÂ©stamo para ediciÃÂ³n
   */
  ...
  /**
   * Obtiene resumen rÃÂ¡pido de revisiÃÂ³n
   */
