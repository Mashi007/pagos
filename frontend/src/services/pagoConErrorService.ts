...
class PagoConErrorService {
  ...
  /** Elimina de pagos_con_errores tras descargar Excel. La lista se vacÃ­a y se rellena al enviar desde Carga Masiva. */
  ...
  /** Mueve un pago con error a la tabla revisar_pago para anÃ¡lisis manual */
