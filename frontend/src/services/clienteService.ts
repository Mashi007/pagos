...
class ClienteService {
  ...
  // Obtener lista de clientes con filtros y paginaciÃÂ³n
  async getClientes(
    ...
    // Ã¢ÂÂ CORRECCIÃÂN: Asegurar que data siempre sea un array
  ...
  // Comprobar quÃÂ© cÃÂ©dulas ya existen (para carga masiva: advertir antes de guardar)
  ...
  // Comprobar quÃÂ© emails ya existen en la tabla clientes (carga masiva: nunca repetido)
  ...
  /** Lista de clientes enviados a revisiÃÂ³n (paginado) */
  ...
  // Obtener cliente por cÃÂ©dula exacta (para carga masiva de prÃÂ©stamos)
  ...
  // Buscar clientes por tÃÂ©rmino (usando filtros en endpoint principal)
  // IMPORTANTE: Por defecto filtra solo clientes ACTIVOS para formularios de prÃÂ©stamos
  ...
  async searchClientes(query: string, incluirTodosEstados: boolean = false): Promise<Cliente[]> {
    ...
    // Por defecto filtrar solo ACTIVOS (para formularios de prÃÂ©stamos)
    // Solo incluir todos los estados si se especifica explÃÂ­citamente
  ...
  // Obtener tabla de amortizaciÃÂ³n de un cliente
  ...
  // Obtener estadÃÂ­sticas de cliente
  ...
  // Obtener estadÃÂ­sticas generales de todos los clientes
  ...
  // Obtener estadÃÂ­sticas del embudo de clientes
  ...
  // Buscar cliente por nÃÂºmero de telÃÂ©fono
  async buscarClientePorTelefono(telefono: string): Promise<Cliente | null> {
    try {
      ...
      logger.error('Error buscando cliente por telÃÂ©fono', { error, telefono })
      return null
    }
  }

  // Obtener clientes con problemas de validaciÃÂ³n (usa /casos-a-revisar del backend)
  ...
  // Actualizar mÃÂºltiples clientes en lote
