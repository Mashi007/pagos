...
export interface ComunicacionUnificada {
  ...
  /** CÃÂ©dula capturada en el flujo de cobranza (cuando ya la enviÃÂ³ el usuario). */
  cedula?: string | null
  /** Estado del flujo: esperando_cedula, esperando_confirmacion, esperando_foto, etc. */
  estado_cobranza?: string | null
  /** True si ya se ha enviado al menos un mensaje (OUTBOUND) en esta conversaciÃÂ³n; si no, se muestra etiqueta NUEVO. */
  operado?: boolean
}
...
/** Mensaje del historial WhatsApp (copia de la conversaciÃÂ³n). */
...
class ComunicacionesService {
  ...
  /**
   * Listar todas las comunicaciones unificadas con filtros y paginaciÃÂ³n
   */
  ...
  /**
   * Historial de mensajes WhatsApp de una conversaciÃÂ³n (copia de lo hablado con el cliente).
   */
   ...
   * Usa ConfiguraciÃÂ³n > WhatsApp. Respeta modo_pruebas.
   */
  ...
  /**
   * Crear cliente automÃÂ¡ticamente desde una comunicaciÃÂ³n
   */
