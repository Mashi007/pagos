...
class ConversacionesWhatsAppService {
  ...
  /**
   * Listar todas las conversaciones con filtros y paginaciÃÂ³n
   */
  ...
  /**
   * Obtener una conversaciÃÂ³n especÃÂ­fica por ID
   */
  ...
  /**
   * Obtener todas las conversaciones de un cliente especÃÂ­fico
   */
  ...
  /**
   * Obtener todas las conversaciones de un nÃÂºmero de telÃÂ©fono
   */
  ...
  /**
   * Obtener estadÃÂ­sticas de conversaciones
   */
