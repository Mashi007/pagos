...
class ConversacionesWhatsAppService {
  ...
  /**
   * Listar todas las conversaciones con filtros y paginaciÃ³n
   */
  ...
  /**
   * Obtener una conversaciÃ³n especÃ­fica por ID
   */
  ...
  /**
   * Obtener todas las conversaciones de un cliente especÃ­fico
   */
  ...
  /**
   * Obtener todas las conversaciones de un nÃºmero de telÃ©fono
   */
