/**
 * API para configuraciÃ³n de 4 cuentas de correo.
...
export const SERVICIO_POR_CUENTA: Record<number, string> = {
  1: 'Cobros (formulario pÃºblico de reporte de pago)',
  2: 'Estado de cuenta (consulta por cÃ©dula + envÃ­o PDF)',
  3: 'Notificaciones (pestaÃ±as asignadas a esta cuenta)',
  4: 'Notificaciones (pestaÃ±as asignadas a esta cuenta)',
}

/** PestaÃ±as de notificaciones que pueden usar cuenta 3 o 4. */
export const NOTIF_TABS = [
  { id: 'dias_5', label: 'Faltan 5 dÃ­as' },
  { id: 'dias_3', label: 'Faltan 3 dÃ­as' },
  { id: 'dias_1', label: 'Faltan 1 dÃ­a' },
  { id: 'hoy', label: 'Vence hoy' },
  { id: 'dias_1_retraso', label: '1 dÃ­a retraso' },
  { id: 'dias_3_retraso', label: '3 dÃ­as retraso' },
  { id: 'dias_5_retraso', label: '5 dÃ­as retraso' },
