/**
 * Tipos principales del sistema de prÃÂ©stamos y cobranza
...
export interface Cliente {
  id: number
  cedula: string
  nombres: string  // Ã¢ÂÂ Unificado: contiene nombres + apellidos (2-7 palabras)
  telefono?: string
  email?: string
  direccion?: string
...
export interface ClienteForm {
  ...
  cedula: string
  nombres: string  // Ã¢ÂÂ Unifica nombres + apellidos
  telefono?: string
  email?: string
  direccion?: string
  fecha_nacimiento?: string
...
export interface PrestamoForm {
  ...
  analista: string
  modelo_vehiculo?: string
  numero_cuotas?: number  // NÃÂºmero de cuotas manual del formulario
  cuota_periodo?: number  // Cuota calculada
  tasa_interes?: number
  fecha_base_calculo?: string
  observaciones?: string
  usuario_autoriza?: string  // Email del usuario que autoriza crear nuevo prÃÂ©stamo
...
// Tipos para filtros y bÃÂºsquedas
