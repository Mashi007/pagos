/**
 * Pruebas de IntegraciÃ³n - Servicios
...
describe('useAuth', () => {
  ...
  it('deberÃ­a inicializar sin usuario autenticado', () => {
  ...
  it('deberÃ­a manejar error de login', async () => {
    vi.mocked(fetch).mockResolvedValueOnce({
      ok: false,
      status: 401,
  ...
  it('deberÃ­a hacer logout correctamente', async () => {
...
describe('useClientes', () => {
  ...
  it('deberÃ­a crear cliente exitosamente', async () => {
    const mockCliente = {
      id: 1,
      cedula: 'V12345678',
      nombres: 'Juan',
  ...
  it('deberÃ­a actualizar cliente exitosamente', async () => {
    const mockCliente = {
      id: 1,
      cedula: 'V12345678',
      nombres: 'Juan Carlos',
  ...
  it('deberÃ­a eliminar cliente exitosamente', async () => {
    vi.mocked(fetch).mockResolvedValueOnce({
      ok: true,
...
describe('clienteService', () => {
  ...
  it('deberÃ­a hacer peticiÃ³n GET para obtener clientes', async () => {
    const mockResponse = {
      data: [],
      total: 0,
      page: 1,
  ...
  it('deberÃ­a hacer peticiÃ³n POST para crear cliente', async () => {
    const mockCliente = {
      cedula: 'V12345678',
      nombres: 'Juan',
      apellidos: 'PÃ©rez',
  ...
  it('deberÃ­a manejar errores de API', async () => {
    vi.mocked(fetch).mockResolvedValueOnce({
      ok: false,
      status: 400,
      json: () => Promise.resolve({ detail: 'Error de validaciÃ³n' }),
    } as Response)
...
describe('authService', () => {
  ...
  it('deberÃ­a obtener usuario actual', async () => {
    const mockUser = {
      id: 1,
      email: 'test@example.com',
      nombre: 'Test',
